                ...
                <div className="mx-auto max-w-sm">
                  ...
                  <div className="mt-5 space-y-3">
                    <input
                      ...
                      className="w-full rounded border border-gray-300 px-3 py-2 text-base text-gray-800 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
