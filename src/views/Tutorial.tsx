...
const L2_FOUNDATION_LESSON_IDS = new Set(['l2-1', 'l2-2', 'l2-3', 'l2-4', 'l2-5']);
    ...
    >
      ...
      <div className="w-full lg:w-1/2 lg:border-r border-gray-800 flex flex-col bg-canva-ivory min-w-0 md:min-h-auto lg:h-full lg:overflow-hidden">
        ...
        <div ref={leftScrollRef} className="flex-1 overflow-y-auto min-w-0 bg-canva-ivory relative">
          ...
          >
          <div
            className={`relative px-4 sm:px-7 lg:px-[70px] pt-10 pb-8 mb-2 overflow-hidden bg-gradient-to-br ${theme.gradient}`}
          >
            <div
          ...
          <div className="w-full px-4 sm:px-7 lg:px-[70px] pb-20">
        ...
        <div className="flex-1 flex flex-col min-h-0 relative overflow-hidden">
              ...
              {lesson.interactive ? (
                <>
                  {lesson.moduleId !== 'm4' && lesson.moduleId !== 'm0' && (
                    <div className={usesL26PanelHeight ? 'mb-4' : 'mb-6'}>
                      <span className="text-canva-teal font-bold text-sm mb-3 block">{lesson.interactive.prompt}</span>
                      <div className={`bg-[#1c232b] rounded-xl border border-gray-800 text-gray-300 font-mono text-sm ${usesL26PanelHeight ? 'p-4' : 'p-5'}`}>
                        {lesson.id === 'l1-3' ? (
          ...
          {lesson.moduleId !== 'm4' && lesson.moduleId !== 'm0' && (
            <div className={`${hasBalancedInputResponse ? 'lg:flex-[0.75]' : isL55 ? 'lg:flex-[3.75]' : usesL26PanelHeight ? 'lg:flex-[3.75]' : hasCompactM5InputPanel ? 'lg:flex-[1.75] max-h-[220px]' : 'lg:flex-[2]'} flex flex-col min-h-0 md:hidden lg:flex border-t border-gray-800`}>
              ...
              <div className={`${lesson.moduleId === 'm0' ? 'p-3' : isL55 ? 'px-8 py-4' : usesL26PanelHeight ? 'px-8 py-5' : hasCompactM5InputPanel ? 'px-8 py-4' : 'p-8'} flex-1 overflow-visible lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar min-w-0`}>
                <div
                  className={`${lesson.moduleId === 'm0' ? 'min-h-[125px]' : isL55 ? 'min-h-[180px]' : usesL26PanelHeight ? 'min-h-[260px]' : hasCompactM5InputPanel ? 'min-h-[110px]' : 'min-h-[160px]'} rounded-xl p-[1px] relative`}
                  style={{ background: `linear-gradient(135deg, ${theme.accent}55, transparent 45%, ${theme.accent}25)` }}
                >
                <div
                  ref={isL11 ? l11ResponseRef : undefined}
                  className={`${lesson.moduleId === 'm0' ? 'p-3' : isL55 ? 'p-4' : usesL26PanelHeight ? 'p-5' : hasCompactM5InputPanel ? 'p-4' : 'p-8'} bg-[#1c232b] rounded-[11px] relative ${l11TourClass('response')}`}
                >
                  <div className={`flex items-center justify-between ${lesson.moduleId === 'm0' ? 'mb-1' : usesL26PanelHeight || hasCompactM5InputPanel ? 'mb-3' : 'mb-5'}`}>
