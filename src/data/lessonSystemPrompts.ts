...
export const LESSON_SYSTEM_PROMPTS: Record<string, string> = {
  ...
  'm1-l8': '발달장애 및 초등학생의 눈높이에 맞춰 쉬운 단어를 사용하여 사실 확인, AI의 1차 판단, 사람의 최종 판단을 구분해 주세요. 사실은 근거로 확인하고, AI의 분류·요약·추천은 사람이 검토하며, 건강·안전·마음과 책임이 걸린 최종 결정은 사람이 한다는 내용을 2~3문장으로 설명해 주세요.',
