    ...
    subCategories: [
      {
        ...
        items: [
          ...
          { id: 'ai-1-8', title: 'Microsoft Copilot', url: 'https://copilot.microsoft.com', description: '웹·Windows·Microsoft 365와 연동되는 생성 AI 보조 도구 (해외)' },
          { id: 'ai-1-9', title: 'Mistral Le Chat', url: 'https://chat.mistral.ai', description: 'Mistral AI의 오픈 LLM 챗 서비스와 모델 생태계 (해외)' },
          { id: 'ai-1-10', title: 'DeepSeek', url: 'https://chat.deepseek.com', description: 'DeepSeek 모델 기반 챗 인터페이스와 API 생태계 (해외)' },
          { id: 'ai-1-11', title: 'Qwen', url: 'https://chat.qwen.ai', description: '알리바바 Qwen 모델 기반 대화형 AI 서비스 (해외)' },
          { id: 'ai-1-12', title: 'Meta AI', url: 'https://www.meta.ai', description: 'Meta의 Llama 기반 AI 비서와 이미지 생성 기능 (해외)' },
          { id: 'ai-1-13', title: 'Poe', url: 'https://poe.com', description: '다양한 AI 챗봇과 사용자 제작 봇을 한곳에서 사용하는 멀티봇 플랫폼 (해외)' },
          { id: 'ai-1-14', title: 'You.com', url: 'https://you.com', description: '검색·채팅·글쓰기·코딩 기능을 결합한 AI 검색 플랫폼 (해외)' },
          { id: 'ai-1-15', title: 'Character.AI', url: 'https://character.ai', description: '캐릭터 기반 대화형 AI와 커뮤니티 봇 서비스 (해외)' },
          { id: 'ai-1-16', title: 'LINER', url: 'https://getliner.com', description: '웹 검색과 문서 요약에 AI를 결합한 한국 리서치·하이라이트 도구' },
        ],
      },
      {
        id: 'ai-google',
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'ai-5-5', title: 'Typecast', url: 'https://typecast.ai', description: '한국어를 포함한 AI 성우 음성과 가상 캐릭터 음성 제작 (네오사피엔스)' },
          { id: 'ai-5-6', title: 'Supertone', url: 'https://supertone.ai', description: '음성 합성·보이스 디자인·가창 음성 기술을 개발하는 한국 AI 오디오 기업' },
          { id: 'ai-5-7', title: 'WellSaid Labs', url: 'https://wellsaidlabs.com', description: '기업 교육·마케팅용 AI 보이스오버 제작 플랫폼 (해외)' },
          { id: 'ai-5-8', title: 'Murf AI', url: 'https://murf.ai', description: '프레젠테이션·영상·광고용 AI 보이스오버 제작 도구 (해외)' },
          { id: 'ai-5-9', title: 'PlayHT', url: 'https://play.ht', description: 'API와 웹 도구로 AI 음성 생성·복제를 제공하는 플랫폼 (해외)' },
          { id: 'ai-5-10', title: 'LOVO AI', url: 'https://lovo.ai', description: '영상·광고·교육 콘텐츠용 AI 음성 생성 도구 (해외)' },
          { id: 'ai-5-11', title: 'Descript', url: 'https://www.descript.com', description: '텍스트 기반 오디오·영상 편집과 AI 음성 기능 (해외)' },
        ],
      },
      {
        id: 'ai-nocode',
        ...
        items: [
          ...
          { id: 'ai-7-6', title: 'Lovable', url: 'https://lovable.dev', description: '자연어로 웹앱과 UI를 생성하는 AI 앱 빌더 (해외)' },
          { id: 'ai-7-7', title: 'Bolt', url: 'https://bolt.new', description: '브라우저에서 자연어 기반으로 웹앱을 생성·배포하는 AI 개발 도구 (해외)' },
          { id: 'ai-7-8', title: 'v0 by Vercel', url: 'https://v0.dev', description: '프롬프트로 React UI와 웹 프런트엔드 코드를 생성하는 도구 (해외)' },
        ],
      },
      {
        id: 'ai-design',
        ...
        items: [
          ...
          { id: 'ai-3-7', title: 'Midjourney', url: 'https://www.midjourney.com', description: '고품질 예술·상업 이미지 생성에 특화된 생성 AI 도구 (해외)' },
          { id: 'ai-3-8', title: 'Runway', url: 'https://runwayml.com', description: 'AI 영상 생성·편집·모션 그래픽 제작을 지원하는 크리에이티브 플랫폼 (해외)' },
          { id: 'ai-3-9', title: 'Stability AI', url: 'https://stability.ai', description: 'Stable Diffusion 계열 이미지 생성 모델과 생성 AI 도구 (해외)' },
          { id: 'ai-3-10', title: 'Leonardo AI', url: 'https://leonardo.ai', description: '게임·디자인·마케팅용 이미지·에셋 생성을 지원하는 AI 플랫폼 (해외)' },
          { id: 'ai-3-11', title: 'Ideogram', url: 'https://ideogram.ai', description: '이미지 속 텍스트 표현과 그래픽 디자인 생성에 강점이 있는 이미지 AI (해외)' },
          { id: 'ai-3-12', title: 'Adobe Firefly', url: 'https://www.adobe.com/products/firefly.html', description: 'Adobe 제품군과 연동되는 상업용 이미지·디자인 생성 AI (해외)' },
          { id: 'ai-3-13', title: 'Krea', url: 'https://www.krea.ai', description: '실시간 이미지 생성·스타일링·업스케일 기능 제공 (해외)' },
          { id: 'ai-3-14', title: 'Recraft', url: 'https://www.recraft.ai', description: '브랜드 그래픽·벡터·일러스트 생성에 특화된 AI 디자인 도구 (해외)' },
          { id: 'dev-7-1', title: 'Pika', url: 'https://pika.art', description: '텍스트·이미지 기반 짧은 영상 생성을 제공하는 AI 비디오 도구 (해외)' },
          { id: 'dev-7-2', title: 'Luma Dream Machine', url: 'https://lumalabs.ai/dream-machine', description: '텍스트와 이미지에서 사실적인 영상을 생성하는 AI 비디오 모델 (해외)' },
          { id: 'dev-7-3', title: 'Kling AI', url: 'https://klingai.com', description: '텍스트·이미지 기반 고품질 AI 영상 생성을 제공하는 비디오 도구 (해외)' },
          { id: 'dev-7-4', title: 'HeyGen', url: 'https://www.heygen.com', description: 'AI 아바타 영상·번역 더빙·마케팅 영상을 제작하는 플랫폼 (해외)' },
          { id: 'dev-7-5', title: 'Synthesia', url: 'https://www.synthesia.io', description: 'AI 아바타와 다국어 영상 생성을 제공하는 기업용 영상 플랫폼 (해외)' },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'ind-2-5', title: 'Scatter Lab', url: 'https://scatterlab.co.kr', description: '대화형 AI 캐릭터(이루다 등)와 감성 대화 기술을 개발하는 한국 AI 기업' },
          { id: 'ind-2-6', title: 'TUNiB', url: 'https://www.tunib.ai', description: '대화형 AI와 자연어처리 기술 기반 챗봇·캐릭터 AI를 개발하는 한국 기업' },
          { id: 'ind-2-1', title: 'maum.ai', url: 'https://maum.ai', description: '음성인식·챗봇·AI 컨택센터 등 기업용 AI 서비스를 제공하는 한국 플랫폼' },
          { id: 'ind-2-7', title: '42Maru', url: 'https://www.42maru.ai', description: '기계독해와 질의응답 기반 검색 AI 솔루션을 제공하는 한국 기업' },
        ],
      },
    ],
  },
    ...
    subCategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'l-4-2', title: 'Mathpresso QANDA', url: 'https://www.qanda.ai', description: '수학 문제 풀이와 개인화 학습을 지원하는 AI 학습 앱' },
          { id: 'l-4-3', title: 'Classting', url: 'https://www.classting.com', description: '학교 커뮤니케이션과 AI 기반 학습 관리 기능을 제공하는 교육 플랫폼' },
          { id: 'l-4-4', title: 'Elice', url: 'https://elice.io', description: 'AI·SW 교육·코딩 실습·기업 교육을 제공하는 온라인 교육 플랫폼' },
          { id: 'l-4-5', title: 'Codeit', url: 'https://www.codeit.kr', description: 'AI·데이터·프로그래밍 온라인 강의를 제공하는 한국 코딩 교육 플랫폼' },
          { id: 'l-4-6', title: 'Codle', url: 'https://codle.io', description: '학교 코딩 수업과 피지컬 컴퓨팅 학습을 지원하는 교육 플랫폼' },
          { id: 'l-4-7', title: 'EBS 소프트웨어', url: 'https://www.ebssw.kr', description: '학생과 교사를 위한 SW·AI 교육 영상과 학습 콘텐츠' },
          { id: 'l-4-8', title: 'EBS AI PengTalk', url: 'https://pengtalk-student.ebse.co.kr', description: '초등 영어 말하기 연습을 지원하는 EBS의 AI 기반 학습 서비스' },
          { id: 'l-4-9', title: 'Code.org AI', url: 'https://code.org/ai', description: '학생과 교사를 위한 AI 리터러시·컴퓨터과학 교육 자료 (해외)' },
          { id: 'l-4-10', title: 'Machine Learning for Kids', url: 'https://machinelearningforkids.co.uk', description: '어린이와 교사를 위한 머신러닝 실습 프로젝트 플랫폼 (해외)' },
          { id: 'l-4-11', title: 'Elements of AI', url: 'https://www.elementsofai.com', description: '일반인을 위한 AI 기초 온라인 강좌·학습 자료 (해외)' },
          { id: 'l-4-12', title: 'AI4K12', url: 'https://ai4k12.org', description: 'K-12 AI 교육을 위한 핵심 개념과 가이드라인 (해외)' },
          ...
          { id: 'clipo', title: 'Clipo', url: 'https://clipo.ai/', description: '교사용 AI 평가·채점·피드백 플랫폼' },
        ],
      },
      {
        id: 'claude-skill-mcp',
    ...
    subCategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'news-1-2', title: 'ZDNet Korea AI', url: 'https://zdnet.co.kr', description: 'AI·IT 기업 뉴스와 기술 동향을 빠르게 확인할 수 있는 전문 매체' },
          ...
          { id: 'news-1-7', title: 'TECH42', url: 'https://www.tech42.co.kr', description: 'AI·스타트업·디지털 전환 동향을 정리하는 국내 테크 미디어' },
          { id: 'news-1-8', title: 'CIO Korea', url: 'https://www.ciokorea.com', description: '기업 IT·AI 도입·보안·클라우드 관련 실무형 기사를 제공' },
        ],
      },
      {
        id: 'news-global',
        ...
        iconEmoji: '🌐',
        items: [
          { id: 'news-2-1', title: 'Stanford AI Index', url: 'https://aiindex.stanford.edu', description: 'AI 연구·산업·정책 지표를 연례 보고서로 제공하는 글로벌 AI 지표 허브 (해외)' },
          { id: 'news-2-2', title: 'OECD AI Policy Observatory', url: 'https://oecd.ai', description: '각국 AI 정책·원칙·지표를 비교할 수 있는 국제 정책 관찰 사이트 (해외)' },
          { id: 'news-2-3', title: 'MIT Technology Review AI', url: 'https://www.technologyreview.com/topic/artificial-intelligence/', description: 'AI 기술과 사회적 영향을 분석하는 MIT Technology Review의 AI 섹션 (해외)' },
          { id: 'news-2-4', title: 'VentureBeat AI', url: 'https://venturebeat.com/category/ai/', description: '생성 AI·엔터프라이즈 AI·스타트업 동향을 다루는 글로벌 테크 매체 (해외)' },
          { id: 'news-2-5', title: 'The Decoder', url: 'https://the-decoder.com', description: '생성 AI·LLM·연구 동향을 집중적으로 다루는 글로벌 AI 뉴스 사이트 (해외)' },
          { id: 'news-2-6', title: 'The Batch', url: 'https://www.deeplearning.ai/the-batch/', description: 'DeepLearning.AI가 발행하는 AI 연구·산업 동향 뉴스레터 (해외)' },
        ],
      },
    ],
  },
    ...
    subCategories: [
      {
        ...
        iconEmoji: '🇰🇷',
        items: [
          { id: 'ind-1-1', title: 'NAVER CLOVA', url: 'https://clova.ai', description: '네이버의 음성·언어·생성 AI 기술과 HyperCLOVA X 생태계를 소개하는 AI 플랫폼' },
          { id: 'ind-1-2', title: 'Kakao Brain', url: 'https://kakaobrain.com', description: '카카오의 AI 연구 조직. 언어·이미지·멀티모달 AI 연구와 서비스 소개' },
          { id: 'ind-1-3', title: 'Upstage', url: 'https://upstage.ai', description: 'Solar LLM과 Document AI 솔루션을 제공하는 한국 AI 기업' },
          { id: 'ind-1-4', title: 'LG AI Research', url: 'https://www.lgresearch.ai', description: 'LG의 초거대 AI와 산업 AI 연구 성과를 소개하는 AI 연구 조직' },
          { id: 'ind-2-2', title: 'Saltlux', url: 'https://www.saltlux.com', description: '검색·지식그래프·언어 AI 기반 엔터프라이즈 솔루션을 제공하는 기업' },
          { id: 'ind-2-3', title: 'Konan Technology', url: 'https://www.konantech.com', description: 'AI 검색·자연어처리·분석 솔루션을 제공하는 한국 AI 소프트웨어 기업' },
          { id: 'ind-3-1', title: 'Allganize', url: 'https://www.allganize.ai', description: '기업 내부 문서 검색·업무 자동화·LLM 애플리케이션 구축을 지원' },
          { id: 'ind-3-2', title: 'MakinaRocks', url: 'https://www.makinarocks.ai', description: '제조·산업 현장의 예측·최적화 AI 솔루션을 제공하는 산업 AI 기업' },
          { id: 'ind-3-3', title: 'Samsung Research', url: 'https://research.samsung.com', description: '삼성의 AI·로봇·통신·온디바이스 지능 연구를 소개하는 연구 사이트' },
          { id: 'ind-3-4', title: 'SK Telecom AI', url: 'https://www.sktelecom.com', description: '통신 기반 AI 서비스와 AI 컴퍼니 전략, 에이닷 등 서비스를 확인할 수 있는 사이트' },
          { id: 'ind-3-5', title: 'KT GenieLabs', url: 'https://genielabs.ai', description: 'KT의 초거대 AI와 음성·언어 AI API를 소개하는 AI 개발 플랫폼' },
        ],
      },
      {
        id: 'ind-infra-chip',
        ...
        iconEmoji: '⚙️',
        items: [
          { id: 'ind-4-1', title: 'Rebellions', url: 'https://www.rebellions.ai', description: 'AI 반도체와 추론 가속 하드웨어를 개발하는 한국 팹리스 기업' },
          { id: 'ind-4-2', title: 'FuriosaAI', url: 'https://furiosa.ai', description: '데이터센터와 엣지용 AI 반도체를 개발하는 한국 AI 칩 스타트업' },
          { id: 'ind-4-3', title: 'SAPEON', url: 'https://www.sapeon.com', description: 'AI 반도체와 데이터센터 추론 가속 솔루션을 제공하는 기업' },
          { id: 'ind-4-4', title: 'Moreh', url: 'https://www.moreh.io', description: '대규모 AI 모델 학습·추론을 위한 소프트웨어 인프라를 제공' },
        ],
      },
      {
        id: 'ind-data-content',
        ...
        iconEmoji: '🎬',
        items: [
          { id: 'ind-5-1', title: 'DeepBrain AI', url: 'https://www.deepbrain.io', description: 'AI 휴먼·영상 합성·가상 아나운서 솔루션을 제공하는 생성 AI 기업' },
          { id: 'ind-5-2', title: 'AIMMO', url: 'https://www.aimmo.ai', description: '자율주행·AI 모델 학습용 데이터 구축과 라벨링 플랫폼' },
          { id: 'ind-5-3', title: 'Selectstar', url: 'https://www.selectstar.ai', description: 'AI 학습데이터 수집·라벨링·검증 서비스를 제공하는 데이터 플랫폼' },
          { id: 'ind-5-4', title: 'Superb AI', url: 'https://www.superb-ai.com', description: '컴퓨터비전 데이터 관리·라벨링·모델 개발을 지원하는 MLOps 플랫폼' },
          { id: 'ind-5-5', title: 'Crowdworks', url: 'https://www.crowdworks.kr', description: 'AI 학습데이터 구축과 크라우드 라벨링 서비스 플랫폼' },
          { id: 'ind-5-6', title: 'VCAT.AI', url: 'https://www.vcat.ai', description: '상품 이미지와 광고 소재를 자동 생성하는 AI 마케팅 크리에이티브 플랫폼' },
          { id: 'ind-5-7', title: 'Voithru', url: 'https://www.voithru.com', description: '영상 자막·번역·콘텐츠 현지화를 지원하는 AI 기반 언어 서비스' },
        ],
      },
      {
        id: 'dev-models-repos',
        ...
        iconEmoji: '🧪',
        items: [
          { id: 'dev-1-1', title: 'Hugging Face', url: 'https://huggingface.co', description: '오픈 모델·데이터셋·데모 Spaces를 공유하는 글로벌 AI 커뮤니티 플랫폼 (해외)' },
          { id: 'dev-1-2', title: 'PyTorch', url: 'https://pytorch.org', description: '딥러닝 연구와 서비스 개발에 널리 쓰이는 오픈소스 머신러닝 프레임워크 (해외)' },
          { id: 'dev-1-3', title: 'TensorFlow', url: 'https://www.tensorflow.org', description: '모델 학습·배포·온디바이스 AI까지 지원하는 오픈소스 ML 플랫폼 (해외)' },
          { id: 'dev-1-4', title: 'scikit-learn', url: 'https://scikit-learn.org', description: '분류·회귀·군집 등 전통적 머신러닝 알고리즘을 제공하는 Python 라이브러리 (해외)' },
          { id: 'dev-2-1', title: 'Kaggle', url: 'https://www.kaggle.com', description: '데이터셋·노트북·AI 경진대회를 제공하는 글로벌 데이터 사이언스 플랫폼 (해외)' },
          { id: 'dev-2-2', title: 'Papers with Code', url: 'https://paperswithcode.com', description: 'AI 논문과 구현 코드·벤치마크를 연결해 제공하는 연구 탐색 사이트 (해외)' },
          { id: 'dev-2-3', title: 'arXiv', url: 'https://arxiv.org', description: 'AI·컴퓨터과학 사전공개 논문을 탐색할 수 있는 대표 학술 저장소 (해외)' },
          { id: 'dev-2-4', title: 'GitHub', url: 'https://github.com', description: 'AI 오픈소스 코드·모델 구현·개발 프로젝트를 공유하는 코드 호스팅 플랫폼 (해외)' },
          { id: 'dev-2-5', title: 'GitLab', url: 'https://gitlab.com', description: 'AI 소프트웨어 개발과 CI/CD를 지원하는 코드 저장·협업 플랫폼 (해외)' },
        ],
      },
      {
        id: 'dev-llm-coding',
        ...
        items: [
          ...
          { id: 'dev-5-4', title: 'Replit AI', url: 'https://replit.com', description: '브라우저 기반 개발환경과 AI 코딩 보조 기능을 제공하는 플랫폼 (해외)' },
        ],
      },
      {
        id: 'dev-cloud',
        ...
        iconEmoji: '☁️',
        items: [
          { id: 'dev-6-1', title: 'Google DeepMind', url: 'https://deepmind.google', description: '구글의 AI 연구 조직. 모델·과학 AI·안전 연구를 소개 (해외)' },
          { id: 'dev-6-2', title: 'AWS Bedrock', url: 'https://aws.amazon.com/bedrock/', description: '다양한 파운데이션 모델을 기업 애플리케이션에 연결하는 AWS 생성 AI 플랫폼 (해외)' },
          { id: 'dev-6-3', title: 'Azure AI Foundry', url: 'https://ai.azure.com', description: '기업용 AI 앱과 에이전트 개발을 지원하는 Microsoft Azure AI 플랫폼 (해외)' },
          { id: 'dev-6-4', title: 'IBM watsonx', url: 'https://www.ibm.com/watsonx', description: '기업용 AI 모델·데이터·거버넌스를 제공하는 IBM AI 플랫폼 (해외)' },
          { id: 'dev-6-5', title: 'Cohere', url: 'https://cohere.com', description: '기업 검색·RAG·언어 모델 API를 제공하는 엔터프라이즈 AI 기업 (해외)' },
        ],
      },
      {
        id: 'med-all',
        ...
        iconEmoji: '🩺',
        items: [
          { id: 'med-1-1', title: 'VUNO', url: 'https://vuno.co', description: '의료영상·생체신호·진단 보조 AI 솔루션을 개발하는 한국 의료 AI 기업' },
          { id: 'med-1-2', title: 'Lunit', url: 'https://www.lunit.io', description: '암 진단과 치료 반응 분석을 위한 의료영상 AI 솔루션' },
          { id: 'med-1-3', title: 'JLK', url: 'https://www.jlkgroup.com', description: '뇌졸중 등 질환 분석을 위한 의료영상 AI 솔루션' },
          { id: 'med-1-4', title: 'Coreline Soft', url: 'https://www.corelinesoft.com', description: '흉부 CT와 폐질환 분석 중심의 의료영상 AI 솔루션' },
          { id: 'med-1-5', title: 'Medical IP', url: 'https://www.medicalip.com', description: '의료영상 3D 분석과 디지털 트윈 기반 의료 AI 솔루션' },
          { id: 'med-2-1', title: 'Deep Bio', url: 'https://www.deepbio.co.kr', description: '병리 이미지 분석과 암 진단 보조 AI를 개발하는 의료 AI 기업' },
          { id: 'med-2-2', title: 'AITRICS', url: 'https://www.aitrics.com', description: '중환자 상태 예측과 임상 의사결정 지원 AI 솔루션' },
          { id: 'med-2-3', title: 'Mediwhale', url: 'https://www.mediwhale.com', description: '망막 이미지 기반 심혈관 위험 예측 AI 솔루션' },
          { id: 'med-3-1', title: 'Neurophet', url: 'https://www.neurophet.com', description: '뇌영상 분석과 신경질환 진단 보조 AI 솔루션' },
          { id: 'med-3-2', title: 'Heuron', url: 'https://heuron.co.kr', description: '뇌질환 의료영상 분석 AI 솔루션을 개발하는 기업' },
          { id: 'med-4-1', title: 'Standigm', url: 'https://www.standigm.com', description: 'AI 기반 신약 후보 발굴과 생물학적 분석 플랫폼' },
          { id: 'med-4-2', title: 'Syntekabio', url: 'https://www.syntekabio.com', description: '유전체와 AI 기반 신약개발·정밀의료 플랫폼' },
          { id: 'med-5-1', title: 'Waycen', url: 'https://www.waycen.com', description: '영상과 생체신호 기반 의료 AI 솔루션을 개발하는 헬스케어 AI 기업' },
          { id: 'med-5-2', title: 'Kakao Healthcare', url: 'https://www.kakaohealthcare.com', description: '디지털 헬스케어 데이터와 AI 기반 건강관리 서비스를 개발하는 카카오 계열사' },
          { id: 'med-5-3', title: 'Aidoc', url: 'https://www.aidoc.com', description: '응급·영상 판독 워크플로에 의료 AI를 적용하는 글로벌 헬스케어 AI 기업 (해외)' },
          { id: 'med-5-4', title: 'PathAI', url: 'https://www.pathai.com', description: '병리 이미지 분석과 임상시험 지원을 위한 AI 솔루션 (해외)' },
        ],
      },
      {
        id: 'gov-all',
        ...
        items: [
          ...
          { id: 'gov-1-6', title: 'KOCW', url: 'https://www.kocw.net', description: '국내 대학 강의 공개 플랫폼으로 AI·컴퓨터공학 강좌 탐색에 유용' },
