...
export const M1_CANONICAL_LESSONS: CanonicalLessonDesign[] = [
  ...
  // ============================================================
  {
    ...
    coreConcepts: ['AI(인공지능)는 사람이 만든 똑똑한 도구이며, 입력을 받아 다양한 결과와 도움을 줄 수 있다.'],
    canonicalScenario: {
    ...
    stages: [
      {
        ...
        activity: {
          ...
          choices: [
            { id: 'human-tool', label: '사람이 만든 똑똑한 지능 도구라는 뜻이에요', emoji: '🤖' },
            { id: 'magic-robot', label: '스스로 태어난 마법 로봇이라는 뜻이에요', emoji: '🪄' },
          ],
        },
        assetIds: ['m1-l1-story-01'],
        support: {
          full: { hint: '인공지능은 사람이 목적을 위해 만든 도구를 의미해요.' },
        },
      },
      {
        id: 's2-first-attempt',
      ...
      },
      {
        ...
        activity: {
          ...
          modes: ['choice', 'text'],
          choiceCards: [
            { id: 'def1', label: '사람이 만든 똑똑한 도구로, 번역과 추천을 도와줘요', emoji: '💡' },
            { id: 'def2', label: '정보를 살펴보고 필요한 답을 찾아주는 편리한 도우미예요', emoji: '🔍' },
          ],
        },
    ...
    wrapUp: 'AI(인공지능)는 사람이 만든 똑똑한 도구이며, 입력된 정보로 번역·추천·분류 같은 일을 해냅니다.',
  },
