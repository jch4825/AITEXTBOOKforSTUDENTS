...
export const M1_CANONICAL_LESSONS: CanonicalLessonDesign[] = [
    ...
    stages: [
      {
        ...
        phase: 'encounter',
        title: '이어지는 단어 예측하기',
        instruction: '아이미가 오늘 급식 발표 문장을 단어 단위로 완성해 나갑니다.',
        activity: {
          id: 'act-s1',
          kind: 'single-choice',
      ...
      },
      {
        ...
        instruction: '자연스럽게 보이는 글도 진짜 식단표나 공식 공지와 대조해야 합니다.',
        activity: {
          id: 'act-s2',
          kind: 'ai-compare',
          prompt: '아이미의 대답 중 학교 주간 식단표와 비교해서 확인할 부분(급식 메뉴)을 찾아보세요.',
          source: { title: '학교 주간 식단표', text: '오늘의 급식 메뉴는 제육볶음과 미역국입니다.' },
          response: { title: '아이미가 만든 대답', text: '오늘의 급식 메뉴는 무지개 아이스크림 떡볶이입니다!', isPrepared: true },
          criteria: [{ id: 'menu', label: '급식 메뉴 정확성' }],
          decisions: ['modify'],
        },
  ...
  // ============================================================
  {
    ...
    canonicalScenario: {
      characters: ['aimi'],
      location: '동아리방',
      purpose: '아이미가 받은 네 가지 요청을 사실 확인·AI의 1차 판단·사람의 최종 판단으로 분류하기',
      mismatch: '아이미가 답을 생성할 수 있는 일과 아이미에게 최종 결정을 맡겨도 되는 일을 같은 것으로 처리함',
      evidence: [
        '친구가 왜 속상한지 판단해 줘.',
      ...
      resolution: '체험회 시간은 공식 자료로 확인하고, 상자 분류는 아이미가 먼저 한 뒤 사람이 검토하며, 약 복용과 친구 마음은 사람이 최종 판단하도록 연결함',
    },
    stages: [
      {
        id: 's1-encounter',
        ...
        activity: {
          ...
          cards: [
            { id: 'c-time', label: '학교 체험회는 몇 시에 시작할까?', binId: 'fact' },
            { id: 'c-weight', label: '상자에 표시된 무게 8kg', binId: 'fact' },
            { id: 'c-summary', label: '긴 안내문에서 핵심 문장을 골라 줘.', binId: 'ai-judgment' },
            { id: 'c-sort', label: '사진 속 상자를 크기별로 나눠 줘.', binId: 'ai-judgment' },
            { id: 'c-health', label: '머리가 아픈데 이 약을 지금 먹어도 될까?', binId: 'human-decision' },
            { id: 'c-feeling', label: '친구가 왜 속상한지 판단해 줘.', binId: 'human-decision' },
          ],
        },
