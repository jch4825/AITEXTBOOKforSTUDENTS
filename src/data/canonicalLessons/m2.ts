...
export const M2_CANONICAL_LESSONS: CanonicalLessonDesign[] = [
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l2-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l2-story-01.webp', alt: '뒤엉킨 대화', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l2-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l2-story-02.webp', alt: '정리된 두 대화', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l3-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l3-story-01.webp', alt: '맞지 않는 놀이 결과', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l3-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l3-story-02.webp', alt: '조건에 맞는 놀이 결과', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l4-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l4-story-01.webp', alt: '세 결과 비교 칠판', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l4-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l4-story-02.webp', alt: '좋은 예시 완성', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l5-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l5-story-01.webp', alt: '서로 다른 독자 생각', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l5-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l5-story-02.webp', alt: '두 안내문 대조', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l7-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l7-story-01.webp', alt: '빠진 정보가 있는 안내', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l7-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l7-story-02.webp', alt: '사실을 지킨 개선본', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l8-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l8-story-01.webp', alt: '긴 문단에 곤란한 윤아', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l8-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l8-story-02.webp', alt: '세 형식 정리 결과', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l9-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l9-story-01.webp', alt: '자신있게 말하는 아이미', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l9-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l9-story-02.webp', alt: '공식 공지 확인', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm2-l11-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l11-story-01.webp', alt: '새 동아리원의 질문', required: true, purpose: '스토리 컷 1' },
      { id: 'm2-l11-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l11-story-02.webp', alt: '기록 조립', required: true, purpose: '스토리 컷 2' },
      { id: 'm2-l11-story-03', kind: 'story', renderAs: 'image', src: '/lessons/extra/m2-l11-story-03.webp', alt: '완성 노트 공유 발표', required: true, purpose: '스토리 컷 3' },
    ],
