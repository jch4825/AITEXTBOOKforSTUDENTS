...
export const M4_CANONICAL_LESSONS: CanonicalLessonDesign[] = [
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm4-l2-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l2-story-01.webp', alt: '소문을 본 윤아', required: true, purpose: '스토리 컷 1' },
      { id: 'm4-l2-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l2-story-02.webp', alt: '공식 공지 확인', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm4-l3-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l3-story-01.webp', alt: '초안 속 단서 발견', required: true, purpose: '스토리 컷 1' },
      { id: 'm4-l3-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l3-story-02.webp', alt: '단서를 가린 안전한 요청', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm4-l4-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l4-story-01.webp', alt: '요구 메시지 앞 멈춤', required: true, purpose: '스토리 컷 1' },
      { id: 'm4-l4-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l4-story-02.webp', alt: '공식 복구 화면 확인', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm4-l6-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l6-story-01.webp', alt: '가려진 메시지 앞 멈춤', required: true, purpose: '스토리 컷 1' },
      { id: 'm4-l6-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l6-story-02.webp', alt: '선생님께 도움 요청', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm4-l7-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l7-story-01.webp', alt: '급하게 입력하는 진우', required: true, purpose: '스토리 컷 1' },
      { id: 'm4-l7-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l7-story-02.webp', alt: '차분히 수정하는 모습', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm4-l8-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l8-story-01.webp', alt: '영상 추천에 머문 진우', required: true, purpose: '스토리 컷 1' },
      { id: 'm4-l8-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l8-story-02.webp', alt: '알람 후 휴식 이동', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      { id: 'm4-l9-story-01', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l9-story-01.webp', alt: '위험 요청 앞 멈춤', required: true, purpose: '스토리 컷 1' },
      { id: 'm4-l9-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l9-story-02.webp', alt: '선생님께 알린 해결 장면', required: true, purpose: '스토리 컷 2' },
    ],
  ...
  // ============================================================
  {
    ...
    assets: [
      ...
      { id: 'm4-l11-story-02', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l11-story-02.webp', alt: '여권 도장 조립', required: true, purpose: '스토리 컷 2' },
      { id: 'm4-l11-story-03', kind: 'story', renderAs: 'image', src: '/lessons/extra/m4-l11-story-03.webp', alt: '안전 여권 서명 발표', required: true, purpose: '스토리 컷 3' },
    ],
