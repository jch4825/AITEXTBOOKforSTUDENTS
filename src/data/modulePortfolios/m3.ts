  ...
  closingStory: [
    {
      ...
      copy: '[공부 짝꿍 · 최종화] 새 친구: "AI가 질문에도 답하고 글도 줄여 주는데, 숙제를 전부 맡겨도 돼?" 윤아: "아이미와 함께 공부하되, 베끼지는 않아. 그게 우리 약속이야."',
    },
    {
      id: 'm3-close-tools',
      label: '공부 도구 고르기',
      ...
      copy: '진우: "펭귄 과제 기억나? 햇빛 먹는 식물 사건도, 5,600원 미스터리도!" 윤아: "정답이 먼저 보이는 퀴즈도 있었지. 그때마다 확인하는 법을 배웠어."',
    },
    {
      ...
      copy: '윤아: "아이미에게 맡길 일과 내가 직접 할 일 — 너의 도구함엔 무엇을 담겠어?"',
    },
  ],
  studioLessonIds: [
    'm3-l1',
