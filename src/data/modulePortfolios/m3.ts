  ...
  closingStory: [
    {
      ...
      label: '새 친구의 질문',
      imageSrc: '',
      alt: '새 친구가 숙제를 AI가 모두 해도 되는지 묻는 장면을 위한 빈 이미지 자리',
    ...
    },
    {
      ...
      label: '공부 도구 고르기',
      imageSrc: '',
      alt: '질문 계단 낱말 카드 계산 기록 요약과 같은 공부 도구를 서랍에 나누어 넣는 장면을 위한 빈 이미지 자리',
    ...
    },
    {
      ...
      label: '도구함 발표',
      imageSrc: '',
      alt: '학생이 완성한 공부 도우미 도구함을 배움 전시회에서 발표하는 장면을 위한 빈 이미지 자리',
