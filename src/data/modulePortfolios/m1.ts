  ...
  closingStory: [
    {
      ...
      copy: '[아이미가 왔다 · 최종화] 새로 온 하린: "아이미의 답은 언제 믿어도 되고, 언제 다시 확인해야 해?" — 진우와 윤아는 서로를 마주 보았습니다.',
    },
    {
      ...
      copy: '진우: "급식 발표 사건 기억나? 여우 사진이랑 채소회 오이 사건도!" 윤아: "그때마다 우리가 뭘 확인했는지, 기록이 다 있어."',
    },
    {
      id: 'deliver-ai-guide',
      label: '장면 3 · 설명서 전달',
      ...
      copy: '윤아: "이제 우리가 배운 걸 한 장에 모을 차례야. 하린이에게 줄 설명서, 너라면 어떤 내용부터 적겠어?"',
    },
  ],
  studioLessonIds: [
    'm1-l1',
