  ...
  closingStory: [
    {
      ...
      copy: '[부탁의 달인 · 최종화] 새 동아리원: "머릿속에는 하고 싶은 일이 있는데, 어떻게 말해야 할지 모르겠어." 진우: "그거, 우리도 딱 그랬어."',
    },
    {
      ...
      copy: '윤아: "지난달 음악회 소동 기억나? \'아무거나\'의 함정도, 구멍 난 준비표도, 5시 종료 미스터리도." 진우: "그때마다 요청을 고치는 법을 하나씩 배웠지."',
    },
    {
      id: 'm2-close-share',
      label: '완성 노트 공유',
      ...
      copy: '윤아: "우리가 찾은 부탁의 기술을 카드로 모으자. 너의 첫 카드는 무엇이야?"',
    },
  ],
  studioLessonIds: [
    'm2-l1',
