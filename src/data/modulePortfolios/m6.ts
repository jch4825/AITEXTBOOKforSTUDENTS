...
export const M6_PORTFOLIO: ModulePortfolioDefinition = {
  ...
  closingStory: [
    ...
    },
    {
      ...
      label: '여섯 시즌을 돌아보며',
      imageSrc: '/lessons/story/module-close/m6/m6-close-scene-02.webp',
      alt: '교통 운행 변경과 비 예보가 나타나 학생들이 공식 정보와 사람 도움으로 계획을 고치는 장면',
      copy: '윤아: "아이미가 왔다, 부탁의 달인, 공부 짝꿍, 안전 지킴이, 체험회 D-7, 나 혼자 일주일…" 아이미: "처음 만난 날, 저는 어려운 말만 했지요. 여러분 덕분에 저도 좋은 짝이 되는 법을 배웠어요."',
    },
    {
