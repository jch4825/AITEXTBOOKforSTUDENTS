  ...
  closingStory: [
    {
      ...
      label: '최종 안전 점검',
      imageSrc: '',
      alt: '진우와 윤아가 체험회 공개 전 열 가지 안전 기록을 펼쳐 최종 점검하는 장면을 위한 빈 이미지 자리',
    ...
    },
    {
      ...
      label: '새 동아리원 안내',
      imageSrc: '',
      alt: '새 동아리원이 세 가지 안전 상황을 묻고 학생이 기록을 근거로 안내하는 장면을 위한 빈 이미지 자리',
    ...
    },
    {
      ...
      label: '안전 여권 전달',
      imageSrc: '',
      alt: '학생이 안전 도장과 개인 도움망이 담긴 AI 안전 여권에 서명해 발표하는 장면을 위한 빈 이미지 자리',
