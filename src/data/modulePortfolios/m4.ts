  ...
  closingStory: [
    {
      ...
      copy: '[안전 지킴이 · 최종화] 민준 선생님: "이번 시즌, 정말 많은 걸 해결했구나." 진우: "우리 이제 지킴이 임명장 받는 거예요?"',
    },
    {
      ...
      copy: '윤아: "두 개의 시간표, 인증 코드를 보내 줘?, 가려진 메시지, 선물과 비밀 만남 — 우리가 해결한 이름들이야." 진우: "구호만 외운 게 아니라 진짜로 확인하고, 가리고, 알렸지."',
    },
    {
      ...
      copy: '민준 선생님: "지킴이 임명장에는 너의 약속이 들어가야 해. 너의 안전 약속 첫 번째는 무엇이니?"',
    },
  ],
  studioLessonIds: [
    'm4-l1',
