      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 준비 사진을 올리려던 참이에요. 윤아: "책상 예쁘게 나왔다!" 진우: "가장자리도 봤어?"',
            '체험회 준비 사진을 올리려던 참이었습니다. 윤아: "책상 예쁘게 나왔다! 단체 채팅에 올려야지." 진우: "잠깐, 가장자리도 봤어?"',
            '체험회 준비 사진을 단체 채팅에 올리려던 참이었습니다. 윤아: "책상 예쁘게 나왔다!" 진우: "잠깐, 사진 가장자리도 봤어?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '진우: "이름표 보이고… 친구 얼굴도 있네." 위치 표지와 일정표까지 네 개였어요.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '진우: "누구에게? 왜?" 공개 채팅에는 장식 색만 보여 주면 충분했어요.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "단서 네 개, 선택지는 세 개 — 보내기, 가리기, 보내지 않기. 어떻게 하겠어?"',
