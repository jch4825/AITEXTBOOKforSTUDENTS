      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '포스터 도움을 구하는 채팅을 썼어요. 진우: "이름, 학교, 나오는 시간까지 다 적었어!"',
            '체험회 포스터 도움을 구하는 채팅이었습니다. 진우: "자세할수록 좋겠지? 이름, 학교, 매일 혼자 나오는 시간까지 다 적었어!"',
            '체험회 포스터 도움을 구하는 채팅이었습니다. 진우: "자세할수록 좋겠지? 이름, 학교, 혼자 나오는 시간까지 다 적었어!" 무엇이 꼭 필요한지는 보지 않았습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "포스터 도움에 네 이름이 필요해? 학교는? 그 시간은?" 하나씩 짚어 봤어요.',
            '윤아: "잠깐. 포스터 도움에 네 이름이 필요해? 학교는? 그 시간은?" 하나씩 짚어 보니 직접 단서와 간접 단서가 갈렸습니다.',
            '윤아: "포스터 도움에 네 이름이 필요해? 학교는? 그 시간은?" 이름처럼 바로 알아보는 단서와 시간처럼 겹쳐 알아보는 단서가 갈렸습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "A3 크기와 내일 오전이라는 조건만 있으면 도울 수 있어요. 나머지는 몰라도 돼요!"',
