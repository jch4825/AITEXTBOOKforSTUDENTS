      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '쉬는 시간에 추천 영상을 보던 중이에요. 진우: "하나만 보려 했는데 일곱 개째야."',
            '쉬는 시간에 추천 영상을 보던 중이었습니다. 진우: "하나만 보려고 했는데… 어느새 일곱 개째야. 포스터 정리 시간이 지났어!"',
            '쉬는 시간에 추천 영상을 보던 중이었습니다. 진우: "하나만 보려 했는데 일곱 개째야. 포스터 정리 시간이 지났어!" 의지가 아니라 구조의 문제였습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '민준 선생님: "알람이 울렸을 때 무슨 일이 있었니?" 진우: "그다음에 뭘 할지 몰랐어요."',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "매일 30분으로 정하면 어때요?" 진우: "주말엔 가족 일정이 다른데…"',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "숫자 하나로는 부족하군요. 당신의 멈춤 신호는 무엇인가요?"',
