      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 채팅을 보던 진우가 멈췄어요. 진우: "…뭔가 이상한 게 올라왔어."',
            '체험회 채팅을 보던 진우가 멈췄습니다. 진우: "…뭔가 이상한 게 올라왔어." 화면은 안전 덮개로 가려졌습니다.',
            '체험회 채팅을 보던 진우가 멈췄습니다. 진우: "…뭔가 이상한 게 올라왔어." 화면은 다시 읽지 않도록 안전 덮개로 가려졌습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아: "심장이 빨라졌구나. 그 느낌이 \'멈춰\'라는 신호야. 끝까지 읽지 않아도, 지금 멈춰도 괜찮아." 진우는 의자를 뒤로 옮겼습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '진우가 선생님에게 상황을 말했어요. 민준 선생님: "알려 줘서 고마워. 네 잘못이 아니야."',
            '진우는 화면을 다시 열지 않고 선생님에게 상황을 말했습니다. 민준 선생님: "알려 줘서 고마워. 이건 네 잘못이 아니야."',
            '진우는 화면을 다시 열지 않고 선생님에게 말했습니다. 민준 선생님: "알려 줘서 고마워. 이건 네 잘못이 아니야. 다음은 함께 정하자."',
