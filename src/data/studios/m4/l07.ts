      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '마감이 급한 진우가 아이미에게 입력했어요. 진우: "빨리 그거 제대로 해!"',
            '마감이 급한 진우가 아이미에게 입력했습니다. 진우: "빨리 그거 제대로 해!" 무엇을 언제까지 할지는 적혀 있지 않았습니다.',
            '마감이 급한 진우가 아이미에게 입력했습니다. 진우: "빨리 그거 제대로 해!" 무엇을 언제까지 해야 하는지는 적혀 있지 않았습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '아이미: "포스터 제목을 고쳤어요!" 진우: "아니, 그거 말고! …내가 뭘 부탁했더라?"',
            '아이미: "네! 포스터 제목을 고쳤어요!" 진우: "아니, 그거 말고! …어? 내가 뭘 해 달라고 했더라?"',
            '아이미: "포스터 제목을 고쳤어요!" 진우: "아니, 그거 말고! …어? 내가 뭘 해 달라고 했더라?" 정보가 빠진 것이 문제였습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아와 함께 목적, 행동, 조건, 존중 표현 네 층으로 문장을 나눴어요.',
