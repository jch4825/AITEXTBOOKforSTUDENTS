...
const PREPARED_AI_NOTE = '화면의 답은 실제 AI가 바로 만든 답이 아니라 수업용 AI 예시입니다. 이름, 주소, 연락처 같은 개인정보 없이 요청을 고치고 결과를 살펴봅니다.';
...
export const M2_STUDIOS: StudioDefinition[] = [
  ...
  },
  {
      ...
      scenes: [
        {
          ...
          copy: sceneCopy(
            ...
            '진우는 읽는 경험과 필요한 표현이 다른 어린 동생과 학부모에게 같은 안내 글을 보내려 했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '한 안내 글은 두 사람에게 모두 잘 맞지 않았어요.',
            '동생에게는 말이 너무 어려웠고 학부모에게는 필요한 준비 정보가 부족했습니다.',
            '같은 첫 안내 글은 동생에게도, 학부모에게도 잘 맞지 않았습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '학생들은 꼭 지킬 사실과 읽을 사람별 낱말·문장 길이·말투를 나누어 요청 조건을 만들었습니다.',
            '표현이 자연스러워도 사실은 원래 안내와 확인해요.',
          ),
        },
        {
          id: 'two-audience-notices',
          label: '장면 4 · 읽을 사람별 안내 완성',
          imageSrc: '/lessons/story/m2/m2-l5-scene-04.webp',
          alt: '어린 동생용과 학부모용 안내문 두 종류를 나란히 확인하는 장면',
          knowledgeStep: 2,
          copy: sceneCopy(
            '두 사람에게 맞는 안내문이 완성됐어요.',
            '두 안내 글은 말투가 다르지만 시간, 장소, 준비물은 같았습니다.',
            '진우는 읽을 사람별 안내 글의 표현을 비교하고 변하지 않을 사실이 공식 안내와 같은지 살펴보았습니다.',
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'same-notice-both', emoji: '👥', label: '한 안내 글을 두 사람에게 똑같이 보냅니다.' },
        { id: 'two-tones-one-fact', emoji: '🗣️', label: '사실은 지키고 읽을 사람별 말투를 바꿉니다.' },
        { id: 'expert-role-trust', emoji: '🎓', label: '그럴듯한 말투면 내용도 맞다고 믿습니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
      ...
      scenes: [
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '진우는 두 안내 글을 비교해 시간과 장소가 유지되고 어려운 표현만 바뀐 것을 확인했습니다.',
      ...
      scenes: [
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아는 읽는 목적, 정보 수, 순서 필요성을 기준으로 세 답의 모양을 연결했습니다.',
    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          alt: '최신 학교 공지 오래된 공지 누가 쓴지 모르는 글의 출처와 날짜를 비교하는 장면',
          knowledgeStep: 1,
          copy: sceneCopy(
    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          alt: '학생이 첫 요청과 수업용 AI 결과를 나란히 살펴보는 장면',
          knowledgeStep: 0,
          copy: sceneCopy(
            '첫 결과에는 고칠 점이 있었어요.',
