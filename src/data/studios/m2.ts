      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우와 윤아가 "내일 안내 알려 줘"라고 말했습니다.',
            '윤아가 "내일 안내 알려 줘"라고 부탁하자 진우가 갸우뚱했습니다.',
            '윤아가 프롬프트 입력창에 "내일 안내 알려 줘"라고 모호하게 전송했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미가 지난 음악회 안내를 가져왔습니다.',
            '아이미는 지난달 음악회 안내를 짠 가져왔습니다. 진우가 눈을 동그랗게 떴습니다.',
            '아이미가 지난달 음악회 안내 데이터를 가져오자 진우가 턱을 괴고 황당해했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아가 말했습니다. "구체적인 정보를 말해 주자!"',
            '윤아가 웃으며 말했습니다. "아이미야, \'내일 오후 2시 AI 동아리 체험회 안내\'라고 알려 줘야지!"',
            '윤아가 배를 잡고 웃으며 프롬프트를 고쳤습니다. "아이미야, \'내일 오후 2시 AI 동아리 체험회 안내\'라고 구체적으로 말해 줘야지!"',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '수정한 요청에 알맞은 안내가 나왔습니다.',
            '목적과 날짜를 구체적으로 적자 체험회 안내가 정확하게 나왔습니다.',
            '목적과 시간 조건을 구체적으로 작성하자 아이미가 체험회 안내문을 완벽하게 출력했습니다.',
