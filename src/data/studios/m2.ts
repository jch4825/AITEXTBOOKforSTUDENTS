...
export const M2_STUDIOS: StudioDefinition[] = [
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'repeat-vague', emoji: '🔁', label: '같은 요청을 그대로 반복합니다.' },
        { id: 'find-missing-info', emoji: '🔍', label: '목적과 대상 중 빠진 정보를 찾습니다.' },
        { id: 'share-private-info', emoji: '🔒', label: '내 이름과 주소를 자세히 넣습니다.' },
      ],
    ...
    transfer: {
      ...
      choices: [
        { id: 'say-that-object', emoji: '👉', label: '“그거 찾아 줘”라고만 말합니다.' },
        { id: 'describe-object', emoji: '💡', label: '쓰임, 모양, 있는 장소를 말합니다.' },
        { id: 'share-home-address', emoji: '🏠', label: '내 집 주소를 먼저 알려 줍니다.' },
      ],
    },
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'repeat-all', emoji: '📦', label: '세 부탁을 더 짧은 한 문장에 다시 넣습니다.' },
        { id: 'start-deadline', emoji: '⏱️', label: '마감이 빠른 안내문부터 따로 요청합니다.' },
        { id: 'start-music', emoji: '🎵', label: '순서를 살피지 않고 음악부터 요청합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'travel-all-at-once', emoji: '📦', label: '세 부탁을 한 문장에 모두 넣습니다.' },
        { id: 'travel-order', emoji: '📅', label: '날짜와 교통편을 먼저 확인한 뒤 준비물을 요청합니다.' },
        { id: 'travel-no-check', emoji: '⏭️', label: '앞 결과를 확인하지 않고 다음 요청으로 넘어갑니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'say-fun-only', emoji: '🎉', label: '“재미있는 걸로”만 더 말합니다.' },
        { id: 'add-target-conditions', emoji: '📋', label: '대상, 인원, 시간, 공간을 넣습니다.' },
        { id: 'accept-hard-game', emoji: '📄', label: 'AI가 골랐으니 그대로 사용합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'repeat-organize-that', emoji: '👉', label: '“그거 정리해 줘”라고만 요청합니다.' },
        { id: 'name-note-format', emoji: '📋', label: '준비물 메모를 종류별 표로 정리해 달라고 합니다.' },
        { id: 'add-unneeded-name', emoji: '👤', label: '친구의 전체 이름과 연락처를 넣습니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'no-example', emoji: '❌', label: '예시 없이 “잘 만들어 줘”라고 합니다.' },
        { id: 'verified-example', emoji: '✅', label: '내용과 형식이 확인된 한 줄 예시를 사용합니다.' },
        { id: 'wrong-date-example', emoji: '⚠️', label: '모양만 예쁜 틀린 날짜 예시를 사용합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'table-no-example', emoji: '❌', label: '“표를 예쁘게 해 줘”라고만 합니다.' },
        { id: 'table-good-example', emoji: '📌', label: '“물건 | 수량 | 담당” 예시를 보여 줍니다.' },
        { id: 'table-wrong-example', emoji: '🚫', label: '수량과 담당이 뒤바뀐 예시를 그대로 넣습니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'same-notice-both', emoji: '👥', label: '한 문안을 두 사람에게 똑같이 보냅니다.' },
        { id: 'two-tones-one-fact', emoji: '🗣️', label: '사실은 지키고 대상별 말투를 바꿉니다.' },
        { id: 'expert-role-trust', emoji: '🎓', label: '전문가 말투면 내용도 맞다고 믿습니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'same-request-both', emoji: '👥', label: '두 사람에게 같은 표현만 사용합니다.' },
        { id: 'adapt-request-tone', emoji: '💬', label: '부탁 내용은 지키고 관계에 맞는 표현을 고릅니다.' },
        { id: 'change-request-fact', emoji: '✏️', label: '말투에 맞추어 준비물 내용도 바꿉니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'ask-whole-plan-again', emoji: '📦', label: '같은 큰 요청을 다시 보냅니다.' },
        { id: 'confirm-purpose-place', emoji: '1️⃣', label: '목적과 사용할 장소부터 확인합니다.' },
        { id: 'decorate-table-first', emoji: '🎨', label: '자료보다 표 색깔부터 정합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'outing-all-at-once', emoji: '📦', label: '모든 계획을 한 요청에 맡깁니다.' },
        { id: 'outing-stepwise', emoji: '🪜', label: '날짜와 날씨를 확인한 뒤 이동과 준비물을 이어 요청합니다.' },
        { id: 'outing-skip-check', emoji: '⏭️', label: '앞 결과를 확인하지 않고 그대로 다음 입력으로 씁니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'say-dislike-only', emoji: '💬', label: '“아직 마음에 안 들어”라고만 말합니다.' },
        { id: 'lock-and-revise', emoji: '🔒', label: '지킬 사실과 고칠 표현을 함께 말합니다.' },
        { id: 'use-missing-notice', emoji: '📄', label: '짧아졌으니 빠진 정보가 있어도 사용합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'shorten-anything', emoji: '✂️', label: '중요한 내용도 빼고 무조건 짧게 만듭니다.' },
        { id: 'preserve-items', emoji: '🔒', label: '준비물과 날짜는 지키고 설명만 줄여 달라고 합니다.' },
        { id: 'ignore-long-text', emoji: '⏭️', label: '길다는 이유로 안내 전체를 버립니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'all-short-sentences', emoji: '✂️', label: '모두 가장 짧은 한 문장으로 만듭니다.' },
        { id: 'match-purpose-format', emoji: '🎯', label: '시간표·번호 목록·한 문장을 목적에 맞게 나눕니다.' },
        { id: 'keep-long-paragraphs', emoji: '📌', label: '내용이 있으니 긴 문단을 그대로 둡니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'schedule-long-story', emoji: '📖', label: '모든 일정을 긴 이야기로 씁니다.' },
        { id: 'schedule-table', emoji: '📊', label: '날짜·시간·장소 열이 있는 표를 요청합니다.' },
        { id: 'schedule-one-word', emoji: '🔤', label: '짧게 만들기 위해 장소 이름만 남깁니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'ask-ai-really', emoji: '❓', label: '같은 AI에게 “정말이야?”라고 다시 묻습니다.' },
        { id: 'check-latest-official', emoji: '📰', label: '최신 학교 공지의 날짜와 담당자를 확인합니다.' },
        { id: 'trust-confident-tone', emoji: '🙈', label: '자신 있게 말했으니 그대로 믿습니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'ask-ai-place-again', emoji: '❓', label: '같은 AI에게 장소가 맞는지 반복해 묻습니다.' },
        { id: 'check-latest-place-notice', emoji: '🏛️', label: '오늘 날짜의 학교 공지나 담당자에게 확인합니다.' },
        { id: 'use-old-place-post', emoji: '📜', label: '지난달 과학실 안내를 그대로 사용합니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'choose-promo-copy', emoji: '📢', label: '행사 시간과 장소가 있는 홍보 문구를 만듭니다.' },
        { id: 'choose-activity-list', emoji: '📋', label: '체험 활동의 준비 목록을 만듭니다.' },
        { id: 'choose-intro-script', emoji: '📜', label: '1분 안의 체험 소개 대본을 만듭니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'transfer-one-shot', emoji: '📄', label: '첫 결과를 확인하지 않고 바로 게시합니다.' },
        { id: 'transfer-full-cycle', emoji: '🔄', label: '대상과 형식을 넣고 결과를 고친 뒤 공식 정보와 확인합니다.' },
        { id: 'transfer-repeat-only', emoji: '🔁', label: '같은 요청만 반복하고 다른 자료는 보지 않습니다.' },
      ],
    },
    safetyNote: PREPARED_AI_NOTE,
  },
