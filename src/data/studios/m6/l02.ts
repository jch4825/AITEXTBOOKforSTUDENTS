      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '모의 계산대에 물 두 병과 과일 한 팩이 있어요. 윤아: "어림부터. 5천 원대쯤?"',
            '모의 계산대에 1,200원짜리 물 두 병과 3,200원짜리 과일 한 팩이 놓였습니다. 윤아: "계산 전에 어림부터. 5천 원대쯤?"',
            '모의 계산대에 1,200원짜리 물 두 병과 3,200원짜리 과일 한 팩이 놓였습니다. 윤아: "계산 전에 어림부터. 물 둘에 과일 하나면… 5천 원대쯤?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '계산기에 `1,200×2+3,200`을 넣어 5,600원을 확인했어요. 거스름돈은 아직이에요.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "합계는 5,600원. 1만 원을 내면 거스름돈은 얼마를 받아야 하지?"',
