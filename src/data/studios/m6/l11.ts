      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '윤아: "우리가 먼저 쓰자. 내 목소리가 먼저야."',
            '윤아: "아이미를 열기 전에 우리가 먼저 쓰자. 멋진 문장보다 내 목소리가 먼저야." 진우도 좋아하는 것과 잘하는 것을 자기 말로 적기 시작했습니다.',
            '윤아: "아이미를 열기 전에 우리가 먼저 쓰자. 멋진 문장보다 내 목소리가 먼저야." 졸업 발표를 앞둔 두 사람은 좋아하는 것, 잘하는 것, 도움받고 싶은 것을 자기 말로 적기 시작했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "문장을 다듬었어요! 학교 이름도 넣을까요?"',
            '아이미: "문장을 짧게 다듬어 봤어요! 그리고… 학교 이름과 연락처를 넣으면 더 친근해 보여요!" 진우: "잠깐, 그건 좀 이상한데?"',
            '아이미: "문장을 짧게 다듬어 봤어요! 그리고… 학교 이름과 연락처를 넣으면 더 친근해 보여요!" 진우: "잠깐, 그건 좀 이상한데?" 좋은 제안과 위험한 제안이 한 화면에 섞여 있었습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            '윤아: "교실용이랑 온라인용은… 달라."',
            '윤아: "교실에서 듣는 친구들과, 누구인지 모르는 온라인 사람들은… 달라." 두 사람은 교실용 청중 카드와 온라인용 청중 카드를 나란히 놓았습니다.',
            '윤아: "교실에서 듣는 친구들과, 누구인지 모르는 온라인 사람들은… 달라." 두 사람은 교실용 청중 카드와 온라인용 청중 카드를 나란히 놓고, 저장될 가능성과 목적까지 함께 살펴보았습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '아이미: "제 제안들 중 무엇을 쓰고, 무엇을 고치고, 무엇을 거절하시겠어요? 교실용과 온라인용, 두 버전 모두 마지막 결정은 당신 몫이에요."',
            '내가 정한 만큼만 남겨도 괜찮아요.',
          ),
        },
      ],
