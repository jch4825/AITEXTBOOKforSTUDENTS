      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '교실에서 길 찾기를 연습해요. 윤아: "고정된 연습 지도야. 출발점은 학교."',
            '교실에서 길 찾기를 연습했습니다. 윤아: "고정된 연습 지도로 도서관 가는 길 연습이야. 출발점은 학교."',
            '교실에서 길 찾기를 연습했습니다. 실제 위치가 아닌 교실용 지도였습니다. 윤아: "고정된 연습 지도야. 출발점은 학교, 목적지는 마을 도서관."',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '아이미: "공원 뒤 골목이 더 빨라요!" 진우: "오, 지름길!" 윤아: "그런데 그 길, 지도에 없는데?" 표지도 없었습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '지도 기호와 표지 카드를 연결했어요. 횡단보도, 공원 입구, 파란 표지가 차례로 같았어요.',
