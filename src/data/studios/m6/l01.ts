      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "자립 챌린지 첫 과제, 장보기! 목록은 제가 3초 만에 만들었어요!"',
        ...
        },
        {
          ...
          copy: sceneCopy(
            '진우: "아이미가 만들었으니 다 담자!"',
            '진우: "아이미가 만들었으니 다 담자!" 윤아는 잠깐 멈칫했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "잠깐 — 바나나는 집에 있어. 그리고… 견과류 못 먹는 친구가 있잖아."',
            '윤아: "잠깐 — 바나나는 집에 있어. 그리고… 견과류 못 먹는 친구가 있잖아." 아이미: "아, 그 정보는 저한테 없었어요!"',
            '윤아: "잠깐 — 바나나는 집에 있어. 그리고… 견과류 못 먹는 친구가 있잖아." 아이미: "아, 그 정보는 저한테 없었어요!" 예산과 가격표도 다시 봐야 했습니다.',
