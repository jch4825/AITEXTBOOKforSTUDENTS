      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              [
                '자립 챌린지가 시작되었습니다. 일주일 동안 생활을 스스로 해 봅니다.',
                '자립 챌린지가 시작되었습니다. 일주일 동안 생활에 필요한 일을 스스로 해 보는 주간입니다.',
                '자립 챌린지가 시작되었습니다. 일주일 동안 생활에 필요한 일을 스스로 해 보는 도전 주간입니다.',
              ],
              [
                '첫 과제는 장보기입니다. 친구 여섯 명이 먹을 간식을 삽니다.',
                '첫 과제는 장보기입니다. 친구 여섯 명이 함께 먹을 간식을 사야 합니다.',
                '첫 번째 과제는 장보기입니다. 친구 여섯 명이 함께 먹을 간식을 사 와야 합니다.',
              ],
              [
                '아이미: "목록은 3초 만에 만들었어요! 요거트, 사과, 바나나, 견과류!"',
                '아이미: "목록은 제가 3초 만에 만들었어요! 요거트, 사과, 바나나, 견과류!" 인원만 보고 만든 목록입니다.',
                '아이미: "목록은 제가 3초 만에 만들었어요! 요거트, 사과, 바나나, 견과류!" 인원 수만 보고 만든 목록이었습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '진우가 장바구니를 들었습니다. 진우: "아이미가 만들었으니 다 담자!"',
                '진우가 장바구니를 들고 앞장섰습니다. 진우: "아이미가 만들었으니까 그냥 다 담자!"',
                '진우가 장바구니를 들고 앞장서 걸었습니다. 진우: "아이미가 만들었으니까 그냥 다 담자!"',
              ],
              [
                '윤아는 잠깐 멈칫했습니다. 무엇이 집에 있는지 보지 않았습니다.',
                '그런데 윤아가 잠깐 멈칫했습니다. 무엇이 이미 집에 있는지 아직 확인하지 않았습니다.',
                '그런데 윤아가 잠깐 멈칫했습니다. 무엇이 이미 집에 있는지 아직 아무도 확인하지 않았습니다.',
              ],
              [
                '누구에게 안전하지 않은지도 몰랐습니다. 예산도 보지 않았습니다.',
                '누구에게 안전하지 않은 음식인지도 아직 몰랐습니다. 쓸 수 있는 예산도 보지 않았습니다.',
                '누구에게 안전하지 않은 음식인지도 아직 몰랐습니다. 쓸 수 있는 예산도 아직 보지 않았습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '윤아: "잠깐 — 바나나는 집에 있어." 또 살 뻔했습니다.',
                '윤아가 손을 들었습니다. 윤아: "잠깐 — 바나나는 집에 있어." 이미 있는 것을 또 살 뻔했습니다.',
                '윤아가 손을 들어 멈추게 했습니다. 윤아: "잠깐 — 바나나는 집에 있어." 이미 있는 것을 또 살 뻔했습니다.',
              ],
              [
                '윤아: "그리고… 견과류 못 먹는 친구가 있잖아."',
                '윤아: "그리고… 견과류 못 먹는 친구가 있잖아." 이것은 돈보다 더 중요한 문제였습니다.',
                '윤아: "그리고… 견과류 못 먹는 친구가 있잖아." 이것은 돈보다 훨씬 더 중요한 문제였습니다.',
              ],
              [
                '아이미: "아, 그 정보는 저한테 없었어요!" 아이미는 우리 반을 모릅니다.',
                '아이미: "아, 그 정보는 저한테 없었어요!" 아이미는 우리 집과 우리 반 사정을 모릅니다.',
                '아이미: "아, 그 정보는 저한테 없었어요!" 아이미는 우리 집 사정도 우리 반 사정도 모릅니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '확인할 조건이 넷입니다. 재고, 가격, 예산, 알레르기입니다.',
                '확인해야 할 조건이 넷이었습니다. 집에 있는 재고, 가게 가격, 쓸 수 있는 예산, 알레르기입니다.',
                '확인해야 할 조건이 넷이었습니다. 집에 있는 재고, 가게 가격, 쓸 수 있는 예산, 그리고 알레르기입니다.',
              ],
              [
                '아이미의 목록을 다 버릴 필요는 없습니다. 좋은 출발점이었습니다.',
                '그렇다고 아이미의 목록을 다 버릴 필요는 없습니다. 여전히 좋은 출발점이었습니다.',
                '그렇다고 아이미가 만든 목록을 다 버릴 필요는 없습니다. 여전히 쓸모 있는 출발점이었습니다.',
              ],
              [
                '아이미: "무엇을 빼고, 무엇을 바꾸시겠어요?"',
