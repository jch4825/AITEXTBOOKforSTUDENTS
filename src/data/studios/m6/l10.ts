      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '실제 직업인인 마을 사서를 만나기 전에 물어볼 질문을 준비했어요.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '만나기 전에 아이미에게 물었습니다. 아이미: "사서는 하루 종일 책을 정리하는 분이에요! 아마도요." 진우: "\'아마도\'?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '실제 이야기에는 사람 돕기, 행사 기획, 협력이 있었어요. 아이미: "예상을 수정할게요!"',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "이제 너와 연결할 차례야. 이 일들 중 네 흥미와 강점은 어디에 닿아 있어?"',
