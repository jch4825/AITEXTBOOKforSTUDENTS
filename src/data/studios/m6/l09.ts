      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '가게에서 물건 찾기를 연습해요. 아이미: "말로도, 글로도, 그림으로도 돼요."',
            '가게에서 물건 찾기를 연습했습니다. 아이미: "말로 해도, 글로 써도, 그림을 보여 줘도 돼요. 편한 방법이 정답이에요."',
            '가게 연습이 시작됐습니다. 윤아는 필요한 물건을 찾지 못했습니다. 아이미: "말로도, 글로도, 그림으로도 돼요. 편한 방법이 정답이에요."',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '상대가 다른 물건을 가리켰어요. 윤아: "제가 찾는 것은 이 그림이에요."',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '점원이 다른 물건을 권했습니다. 윤아: "아니요, 괜찮습니다. 필요한 것만 살게요." 아이미: "완벽한 거절이었어요."',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "네 가지 표현을 당신의 방법으로 만들어 봐요. 도움이 필요할 때는요?"',
