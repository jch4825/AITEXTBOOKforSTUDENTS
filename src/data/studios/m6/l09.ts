      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              [
                '오늘은 가게에서 물건 찾기를 연습합니다. 윤아 차례입니다.',
                '오늘은 가게에서 물건 찾기를 연습합니다. 윤아가 먼저 해 보기로 했습니다.',
                '오늘은 가게에서 물건 찾기를 연습합니다. 윤아가 먼저 해 보기로 한 참이었습니다.',
              ],
              [
                '윤아는 필요한 물건을 찾지 못했습니다. 물어봐야 합니다.',
                '윤아는 진열대를 다 둘러보았지만 필요한 물건을 찾지 못했습니다. 누군가에게 물어봐야 합니다.',
                '윤아는 진열대를 다 둘러보았지만 필요한 물건을 찾지 못했습니다. 이제 누군가에게 물어봐야 합니다.',
              ],
              [
                '아이미: "말로도, 글로도, 그림으로도 돼요. 편한 방법이 정답이에요."',
                '아이미: "말로 해도, 글로 써도, 그림을 보여 줘도 돼요. 편한 방법이 정답이에요."',
                '아이미: "말로 해도 되고, 글로 써도 되고, 그림을 보여 줘도 돼요. 편한 방법이 정답이에요."',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '윤아는 그림 카드를 골랐습니다. 그리고 점원에게 보여 주었습니다.',
                '윤아는 말 대신 그림 카드를 골랐습니다. 그리고 점원에게 그 카드를 보여 주었습니다.',
                '윤아는 말 대신 그림 카드를 고르기로 했습니다. 그리고 점원에게 그 카드를 보여 주었습니다.',
              ],
              [
                '그런데 점원이 다른 물건을 가리켰습니다. 뜻이 어긋났습니다.',
                '그런데 점원이 윤아가 찾는 것과 다른 물건을 가리켰습니다. 뜻이 어긋난 것입니다.',
                '그런데 점원이 윤아가 찾는 것과는 다른 물건을 가리켰습니다. 뜻이 어긋난 것입니다.',
              ],
              [
                '윤아: "제가 찾는 것은 이 그림이에요." 오해는 실패가 아닙니다.',
                '윤아가 카드를 다시 보여 주었습니다. 윤아: "제가 찾는 것은 이 그림이에요." 오해는 실패가 아닙니다.',
                '윤아가 카드를 한 번 더 보여 주었습니다. 윤아: "제가 찾는 것은 이 그림이에요." 오해는 실패가 아닙니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '찾던 물건을 받았습니다. 그런데 점원이 다른 물건도 권했습니다.',
                '드디어 찾던 물건을 받았습니다. 그런데 점원이 옆의 다른 물건도 함께 권했습니다.',
                '드디어 찾던 물건을 받았습니다. 그런데 점원이 옆에 있는 다른 물건도 함께 권했습니다.',
              ],
              [
                '윤아는 그 물건이 필요하지 않았습니다. 예산도 정해져 있습니다.',
                '윤아에게 그 물건은 필요하지 않았습니다. 쓸 수 있는 예산도 이미 정해져 있었습니다.',
                '윤아에게 그 물건은 필요하지 않았습니다. 오늘 쓸 수 있는 예산도 이미 정해져 있었습니다.',
              ],
              [
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '윤아가 쓴 표현은 넷이었습니다. 인사, 도움 요청, 거절, 다시 묻기입니다.',
                '윤아가 오늘 쓴 표현은 넷이었습니다. 인사, 도움 요청, 거절, 그리고 다시 말해 달라는 부탁입니다.',
                '윤아가 오늘 쓴 표현은 넷이었습니다. 인사, 도움 요청, 거절, 그리고 다시 말해 달라는 부탁이었습니다.',
              ],
              [
                '네 가지 모두 말로도, 글로도, 그림으로도 할 수 있습니다.',
                '네 가지 모두 말로도, 글로도, 그림으로도 할 수 있습니다. 방법은 내가 고르면 됩니다.',
                '네 가지 모두 말로도, 글로도, 그림으로도 할 수 있습니다. 어떤 방법을 쓸지는 내가 고르면 됩니다.',
              ],
              [
                '아이미: "도움이 필요할 때, 뭐라고 하겠어요?"',
                '아이미: "이제 네 표현을 당신의 방법으로 만들어 봐요. 도움이 필요할 때, 뭐라고 하겠어요?"',
                '아이미: "이제 네 표현을 당신의 방법으로 만들어 봐요. 도움이 필요할 때 뭐라고 하겠어요? 말, 글, 그림 다 좋아요."',
              ],
            ],
