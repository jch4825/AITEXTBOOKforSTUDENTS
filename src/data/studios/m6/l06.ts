      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '함께 먹을 간식을 계획해요. 아이미: "과일 요거트 컵! 과일은 칼로 잘라 주세요!"',
            '함께 먹을 간식을 계획했습니다. 아이미: "과일 요거트 컵! 요거트, 키위, 바나나 — 과일은 칼로 잘라 주세요!"',
            '함께 먹을 간식을 계획했습니다. 아이미: "과일 요거트 컵! 요거트, 키위, 바나나 — 과일은 칼로 잘라 주세요!" 실제 조건은 아직 몰랐습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '그림 카드로 순서를 배열하던 중이에요. 윤아: "우리 칼 써도 되던가? 알레르기 확인은?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '조건 카드 네 장을 찾았어요. 알레르기 확인 필요, 키위 없음, 칼 사용 불가, 교사 준비 대체 재료.',
