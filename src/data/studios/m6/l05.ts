      ...
      scenes: [
        {
          ...
          copy: sceneCopy(
            ...
            '아이미: "오늘은 따뜻해요!" 진우: "좋아, 얇게 입자!" 윤아: "…어디가? 언제? 그 말엔 지역도 날짜도 없는데."',
            '아이미: "오늘은 따뜻해요!" 진우: "좋아, 얇게 입자!" 윤아: "…어디가? 언제? 그 말엔 지역도 날짜도 없는데." 지금 활동에 바로 쓸 수 없는 답이었습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "예보는 같아도 준비는 다를 수 있어. 너라면 무엇을 챙기겠어?"',
