      ...
      scenes: [
        {
          ...
          copy: sceneCopy(
            ...
            '아이미: "퀴즈 완성! 문제 바로 아래 정답과 해설까지 친절하게 넣었어요!" 진우: "정답이 먼저 보이면… 이거 푸는 건가, 읽는 건가?"',
            '아이미: "퀴즈 완성! 문제 바로 아래 정답과 해설까지 친절하게 넣었어요!" 진우: "정답이 먼저 보이면… 이거 푸는 건가, 읽는 건가?" 문제를 읽기도 전에 답이 보였습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아: "정답을 보고 맞힌 것도 내 실력일까?" 문제 보기, 먼저 답하기, 정답과 이유 확인하기, 다시 풀기 순서가 떠올랐습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '같은 문제를 정답 숨김과 정답 공개 두 방식으로 풀어 보았어요.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "재료는 다 드렸어요. 앞면과 뒷면에 무엇을 넣으시겠어요?"',
