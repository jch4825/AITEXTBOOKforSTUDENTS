      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '전시 설명문이 여덟 문장이었어요. 진우: "방문자들이 다 읽을까?"',
            '전시 설명문이 여덟 문장이었습니다. 장소, 시각, 체험 내용, 준비 시간이 적혀 있었습니다. 진우: "방문자들이 다 읽을까?"',
            '전시 설명문이 여덟 문장이었습니다. 장소, 시작 시각, 체험 내용, 준비 시간, 안전 약속, 문의 방법이 적혀 있었습니다. 진우: "다 읽을까?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "아이미한테 맡기기 전에 우리가 먼저 골라 두자. 나중에 비교하게."',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "세 문장 완성!" 윤아: "10분 전 도착 얘기가 어디 갔지?"',
