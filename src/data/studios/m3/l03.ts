      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '과학책에서 광합성을 읽던 중이에요. 진우: "이 설명이 너무 어려워."',
            '과학책에서 광합성을 읽던 중이었습니다. 진우: "광합성… 이산화탄소… 아이미야, 나 이 설명이 너무 어려워."',
            '과학책에서 광합성을 읽던 중이었습니다. 진우: "광합성… 이산화탄소… 이 설명이 너무 어려워." 낯선 말이 가득한 원문이었습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '아이미: "쉽게 바꿨어요! 식물이 햇빛을 먹고 밥을 만들어요!" 진우: "뭔가 허전한데?"',
