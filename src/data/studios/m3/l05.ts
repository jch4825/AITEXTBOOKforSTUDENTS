      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우가 이야기를 쓰고 있어요. 비 오는 학교에 작은 로봇이 혼자 남았어요. 진우: "다음이 안 떠올라."',
            '진우가 이야기를 쓰고 있었습니다. 비 오는 학교에 작은 로봇이 혼자 남은 장면까지 썼습니다. 진우: "여기까지 썼는데… 다음이 안 떠올라."',
            '진우가 이야기를 쓰고 있었습니다. 비 오는 학교에 작은 로봇이 혼자 남은 장면까지 썼고 결말은 아직 없었습니다. 진우: "다음이 안 떠올라."',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "네가 원하는 기분부터 정해. 무섭게? 따뜻하게?" 진우: "따뜻하게."',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미가 결말 셋을 제안했어요. 진우: "1안은 무서워서 싫어. 거절해도 되지?"',
            '아이미가 추격, 지도, 우산 세 결말을 제안했습니다. 진우: "1안은 무서워서 싫어. 거절해도 되지?" 윤아: "당연하지. 네 이야기잖아."',
