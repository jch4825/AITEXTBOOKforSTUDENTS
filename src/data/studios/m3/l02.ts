      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '전시 안내문을 읽다가 모르는 낱말을 만났어요. 윤아: "생태계? 무슨 뜻이지?"',
            '전시 안내문을 읽다가 모르는 낱말을 만났습니다. 윤아: "연못 생태계를 관찰해요… 생태계? 이게 무슨 뜻이지?"',
            '전시 안내문을 읽다가 모르는 낱말을 만났습니다. 윤아: "연못 생태계를 관찰해요… 이게 무슨 뜻이지?" 앞뒤 문장과 그림을 다시 살펴보았습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "물, 풀, 물고기가 같이 있네. 여러 생물이 함께 사는 곳 아닐까?"',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "두 설명에서 같이 나온 말을 찾아보자. 너라면 뭐라고 적겠어?"',
