      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '펭귄 과제를 하다가 물었어요. 윤아: "펭귄은 새야?" 아이미: "네! 새입니다!"',
            '펭귄 과제를 하다가 물었습니다. 윤아: "펭귄은 새야?" 아이미: "네! 새입니다!" 과제에는 까닭을 써야 했습니다.',
            '과학 과제로 펭귄을 조사하던 중이었습니다. 윤아: "아이미야, 펭귄은 새야?" 아이미: "네! 새입니다!" 짧은 질문엔 짧은 답만 돌아왔습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '세 질문의 답이 서로 달랐어요. "왜 새야?"라고 묻자 까닭이 나왔어요.',
