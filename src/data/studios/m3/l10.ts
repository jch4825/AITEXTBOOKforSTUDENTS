      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '단원에서 배운 것을 되짚는 날이에요. 진우: "생태계… 읽으면 아는데 말하려니 안 나와!"',
            '단원에서 배운 것을 되짚는 날이었습니다. 진우: "생태계… 배웠는데. 읽으면 아는데 말하려니까 안 나와!"',
            '생태계 낱말, 계산 검산, 세 문장 요약, 작은 로봇 이야기를 되짚는 날이었습니다. 진우: "읽으면 아는데 말하려니까 안 나와!"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "자료 덮고, 기억나는 만큼만 먼저 말해 봐." 진우가 짧게 말해 보았어요.',
            '윤아: "그게 정상이야. 자료 덮고, 기억나는 만큼만 먼저 말해 봐." 진우는 “생태계는 여러 생물이 함께 사는 곳”이라고 말했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '첫 회상과 낱말 카드를 비교했어요. 물과 햇빛 이야기가 빠져 있었어요.',
