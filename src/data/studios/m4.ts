...
const PREPARED_SAFETY_NOTE =
  '화면의 답과 메시지는 실제 연결이 아니라 수업용 안전 예시입니다. 비밀번호·인증 코드는 누구에게도 보내지 않고, 불편하거나 위험한 상황은 혼자 다시 확인하지 말고 믿을 만한 어른과 공식 도움 절차를 이용합니다.';
...
export const M4_STUDIOS: StudioDefinition[] = [
      ...
      scenes: [
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '확인은 답 전체를 맞다, 틀리다로만 나누는 일이 아닙니다. 문장마다 근거와 맞는지 살펴보는 과정입니다.',
  ...
  },
  {
      ...
      scenes: [
        {
          ...
          copy: sceneCopy(
            ...
            '내용이 그럴듯해도 누가 어디에 썼는지 모르면 믿어도 되는지 확인하기 어렵습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '출처 비교는 공식 자료인지 하나만 보는 일이 아닙니다. 누가 썼는지, 언제 썼는지, 지금 행사와 맞는지도 함께 봅니다.',
        ...
        },
        {
          ...
          alt: '쓴 사람 날짜 원래 글 공식 자료인지 지금 행사와 맞는지를 표시하는 비교표 장면을 위한 빈 이미지 자리',
          knowledgeStep: 2,
          copy: sceneCopy(
            '세 자료에 쓴 사람, 날짜, 원래 글 링크, 지금 행사와 맞는지를 표시하자 오늘 공식 공지가 가장 믿을 만한 자료가 되었습니다.',
            '누가 언제 어디에 썼는지 표시하니 믿을 자료가 보였어요.',
            '믿을 만한 자료인지는 한눈에 정해지지 않습니다. 지금 질문에 맞는 이유가 있고, 어디에서 나온 말인지 확인할 수 있어야 합니다.',
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'anonymous-capture', emoji: '📱', label: '친구가 보낸, 누가 쓴지 모르는 캡처를 골라요.' },
      ...
      scenes: [
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '정보는 줄고 부탁은 더 분명해졌어요.',
            '안전하게 고치려면 개인정보는 줄이고, 상대가 해야 할 일과 조건은 분명히 남깁니다.',
      ...
      scenes: [
        {
          ...
          copy: sceneCopy(
            ...
            '사진 가운데가 안전해 보여도 뒤쪽 배경이나 함께 찍힌 상황에 다른 사람의 정보가 있을 수 있습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '가렸다고 해서 무조건 보내도 되는 것은 아닙니다. 민감한 상황이거나 동의를 받지 못했다면 보내지 않기를 선택합니다.',
      ...
      scenes: [
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '요청을 고치는 일은 단어만 부드럽게 바꾸는 일이 아닙니다. 목적과 해야 할 조건을 함께 알아들을 수 있게 정리하는 일입니다.',
