      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "체험회는 오후 5시에 끝납니다!"',
            '아이미: "체험회는 오후 5시에 끝납니다! 확실해요!"',
            '아이미: "체험회는 오후 5시에 끝납니다! 확실해요!" 출처는 보여 주지 않았습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            '진우: "정말이야?"',
            '진우: "정말이야?" 아이미: "정말입니다! 아까보다 더 확실해요!"',
            '진우: "정말이야?" 아이미: "정말입니다! 아까보다 더 확실해요!" 윤아: "…더 확실해진 근거가 뭐야?" 아이미: "음… 두 번 말했으니까요?"',
            '재답변과 독립 확인은 서로 달라요.',
          ),
        },
        {
