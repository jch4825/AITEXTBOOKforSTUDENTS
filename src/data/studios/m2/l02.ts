      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              [
                '체험회 준비로 할 일이 세 가지였습니다. 안내문, 간식, 음악입니다.',
                '체험회 준비로 할 일이 세 가지 남았습니다. 안내문 쓰기, 간식 고르기, 음악 추천받기입니다. 진우는 마음이 급했습니다.',
                '체험회 준비로 할 일이 세 가지 남았습니다. 안내문 쓰기, 간식 고르기, 음악 추천받기입니다. 시간이 없어 진우는 마음이 급했습니다.',
              ],
              [
                '진우: "한 번에 부탁하면 빠르겠지?" 세 가지를 한 문장에 담았습니다.',
                '진우: "하나씩 하면 오래 걸리잖아. 한 번에 부탁하면 빠르겠지?" 진우는 세 가지를 한 문장에 담았습니다.',
                '진우: "하나씩 부탁하면 오래 걸리잖아. 한 번에 말하면 빠르겠지?" 진우는 세 가지 부탁을 한 문장에 몰아 담았습니다.',
              ],
              [
                '진우: "아이미야! 안내문 쓰고 간식 고르고 음악도 추천해 줘. 한 번에!"',
                '진우: "아이미야! 안내문 쓰고 간식 고르고 음악도 추천해 줘. 한 번에!" 아이미: "한 번에요? 알겠습니다!"',
                '진우: "아이미야! 안내문 쓰고 간식 고르고 음악도 추천해 줘. 한 번에!" 아이미: "한 번에요? 알겠습니다!" 마감은 말하지 않았습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '아이미: "완성! 안내문 중간에 팝콘과 폴카를 넣어 두었어요!"',
                '아이미가 결과를 내놓았습니다. 아이미: "완성! 안내문 중간에 팝콘과 신나는 폴카를 넣어 두었어요!"',
                '아이미가 곧 결과를 내놓았습니다. 아이미: "완성! 안내문 중간에 팝콘과 신나는 폴카를 넣어 두었어요!" 문서는 한 장이었습니다.',
              ],
              [
                '문서는 한 장이었습니다. 안내문과 간식과 음악이 뒤섞여 있었습니다.',
                '문서는 한 장뿐이었습니다. 안내문과 간식 목록과 음악 추천이 한 글 안에 뒤섞여 있었습니다.',
                '문서는 한 장뿐이었습니다. 안내문과 간식 목록과 음악 추천이 한 글 안에 뒤섞여 어디까지가 무엇인지 알기 어려웠습니다.',
              ],
              [
                '윤아: "잠깐, 신청 마감 시간은?" 가장 급한 것이 빠져 있었습니다.',
                '윤아: "잠깐, 신청 마감 시간은 어디 있어?" 가장 급했던 마감 시간이 통째로 빠져 있었습니다.',
                '윤아: "잠깐, 신청 마감 시간은 어디 있어?" 가장 급했던 마감 시간이 통째로 빠져 있었습니다. 오늘 안에 알려야 하는 정보였습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '윤아가 종이 세 장을 꺼냈습니다. 윤아: "한 장에 하나씩 적어 보자."',
                '윤아가 종이 세 장을 꺼냈습니다. 윤아: "섞인 걸 다시 떼어 내자. 한 장에 부탁 하나씩만 적어 보자."',
                '윤아가 종이 세 장을 꺼내 책상에 놓았습니다. 윤아: "섞인 걸 다시 떼어 내자. 한 장에 부탁 하나씩만 적어 보는 거야."',
              ],
              [
                '윤아: "가장 급한 게 뭐지?" 안내문 마감은 오늘이었습니다.',
                '윤아: "그럼 가장 급한 게 뭐지?" 안내문은 오늘 안에 붙여야 했습니다. 마감이 가장 빨랐습니다.',
                '윤아: "그럼 이 중에서 가장 급한 게 뭐지?" 안내문은 오늘 안에 붙여야 했습니다. 세 가지 중 마감이 가장 빨랐습니다.',
              ],
              [
                '윤아: "간식 수는 언제 알 수 있지?" 신청이 끝나야 알 수 있었습니다.',
                '윤아: "그럼 간식 수는 언제 알 수 있지?" 간식은 신청이 끝나야 몇 개가 필요한지 알 수 있었습니다.',
                '윤아: "그럼 간식은 몇 개가 필요한지 언제 알 수 있지?" 간식 수는 신청이 끝나야 알 수 있었습니다. 안내문이 먼저였습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '카드 세 장이 만들어졌습니다. 안내문, 간식, 음악입니다.',
                '카드 세 장이 만들어졌습니다. 안내문 카드, 간식 카드, 음악 카드입니다. 이제 섞이지 않았습니다.',
                '카드 세 장이 만들어졌습니다. 안내문 카드, 간식 카드, 음악 카드입니다. 세 가지가 더는 섞여 있지 않았습니다.',
              ],
              [
                '그런데 순서는 아직 정하지 못했습니다. 진우: "이번엔 안 섞이겠지?"',
                '그런데 어떤 카드부터 부탁할지는 아직 정하지 못했습니다. 진우: "이번엔 안 섞이겠지?"',
                '그런데 어떤 카드부터 부탁할지는 아직 정하지 못했습니다. 진우: "이번엔 안 섞이겠지? 그런데 뭘 먼저 주지?"',
              ],
              [
                '윤아: "무엇부터, 어떤 차례로 부탁할까?"',
                '윤아가 카드 세 장을 나란히 놓았습니다. 윤아: "그럼 무엇부터, 어떤 차례로 부탁할까?"',
                '윤아가 카드 세 장을 나란히 놓았습니다. 윤아: "그럼 무엇부터, 어떤 차례로 부탁할까? 마감이랑 순서를 같이 생각해 보자."',
              ],
            ],
