      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 준비로 할 일이 세 가지였어요. 진우: "안내문 쓰고 간식 고르고 음악도! 한 번에!"',
            '체험회 준비로 할 일이 세 가지였습니다. 진우: "아이미야! 안내문 쓰고 간식 고르고 음악도 추천해 줘. 한 번에!"',
            '체험회 준비로 할 일이 세 가지였습니다. 진우: "안내문 쓰고 간식 고르고 음악도 추천해 줘. 한 번에!" 목적과 마감이 다른 부탁이 한 문장에 담겼습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "완성! 안내문 중간에 팝콘과 폴카를 넣었어요!" 마감 시간은 빠졌어요.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "카드 세 장이 됐어. 무엇부터, 어떤 차례로 부탁할까?"',
