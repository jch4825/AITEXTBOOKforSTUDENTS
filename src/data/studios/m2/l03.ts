      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회에서 할 놀이를 정해야 해요. 윤아: "아무거나 추천해 줘!"',
            '체험회에서 할 놀이를 정해야 했습니다. 윤아: "아이미야, 체험회 놀이 아무거나 추천해 줘!" 아이미: "제일 유명한 걸로 골라 올게요!"',
            '체험회에서 할 놀이를 정해야 했습니다. 대상과 인원, 시간은 말하지 않았습니다. 윤아: "체험회 놀이 아무거나 추천해 줘!" 아이미: "제일 유명한 걸로요!"',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "추천 완료! 90분짜리 보드게임입니다!" 진우: "체험 시간은 20분인데?!"',
            '아이미: "추천 완료! 90분짜리 전략 보드게임입니다!" 진우: "체험 시간이 20분인데?!"',
            '아이미: "추천 완료! 90분짜리 전략 보드게임입니다!" 진우: "체험 시간이 20분인데?!" 여섯 명, 20분이라는 조건에 맞지 않았습니다.',
