      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회에 쓸 결과를 직접 만들 차례예요. 윤아: "이제 네 차례야."',
            '체험회에 쓸 결과를 직접 만들 차례였습니다. 윤아: "음악회 소동부터 5시 미스터리까지… 우리 많이 배웠어. 이제 네 차례야."',
            '홍보 문구, 준비 목록, 소개 대본 중 하나를 골라 직접 만들 차례였습니다. 윤아: "음악회 소동부터 5시 미스터리까지… 이제 네 차례야."',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "결과 나왔어요! 한 곳이 사실 카드와 다를 수도 있어요. 찾아보시겠어요?"',
