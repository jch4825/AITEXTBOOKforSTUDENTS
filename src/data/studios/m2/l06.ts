      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우: "준비표 완성! 다 아이미한테 맡기자!"',
            '진우: "체험회 준비, 전부 아이미한테 맡기자! 아이미야, 준비표 완성!"',
            '진우: "체험회 준비, 전부 아이미한테 맡기자! 아이미야, 준비표 완성!" 장소와 일정 자료는 아직 주지 않았습니다.',
