      ...
      scenes: [
        {
          ...
          copy: sceneCopy(
            '진우: "한 줄로 멋지게 써 줘!"',
            '진우: "한 줄로 멋지게 써 줘!" 아이미: "멋지게…요? 알겠습니다! 최선을 다해 볼게요!"',
            '진우: "한 줄로 멋지게 써 줘!" 아이미: "멋지게…요? 알겠습니다! 최선을 다해 볼게요!" 부탁할 때마다 결과의 길이와 모양이 달랐습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            '예시에 따라 결과가 달라졌어요.',
            '예시가 없을 때, 좋은 예시를 넣을 때, 날짜가 틀린 예시를 넣을 때 결과가 달랐습니다. 윤아는 틀린 날짜를 그대로 따라 한 결과를 보고 멈칫했습니다.',
