      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 안내를 동생과 부모님께 보내야 해요. 진우: "하나로 되겠지?"',
            '체험회 안내를 동생과 부모님께 보내야 했습니다. 진우: "동생한테도 보내고 부모님께도 보내야 해. 하나로 되겠지?"',
            '체험회 안내를 동생과 부모님께 보내야 했습니다. 진우: "하나로 되겠지?" 두 사람은 읽는 경험이 서로 달랐습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '동생: "무슨 말인지 모르겠어…" 부모님께는 준비 정보가 부족했어요.',
