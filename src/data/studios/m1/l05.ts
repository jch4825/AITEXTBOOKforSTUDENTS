      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '시끄러운 복도에서 아이미가 말을 받아 적었어요. 진우: "체험회에 놀러 오세요!"',
            '점심시간 복도는 친구들 소리로 가득했습니다. 아이미가 음성 인식으로 받아 적는 동안 진우가 외쳤습니다. "체험회에 놀러 오세요!"',
            '점심시간 복도는 여러 소리가 겹쳐 시끄러웠습니다. 아이미가 음성 인식 기능으로 방송을 받아 적는 동안 진우가 외쳤습니다. "체험회에 놀러 오세요!"',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '윤아: "화면에 \'채소회 오이 사세요!\'라고 적혔는데?" 아이미: "그렇게 들렸어요!"',
            '윤아: "잠깐, 화면에 \'채소회 오이 사세요!\'라고 적혔는데?" 아이미: "제 귀에는 분명 그렇게 들렸어요!"',
            '윤아: "잠깐, 화면에 \'채소회 오이 사세요!\'라고 적혔는데?" 아이미: "제 귀에는 분명 그렇게 들렸어요! 오이를 사야 하나요?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "조용한 곳에서, 마이크를 가까이, 천천히 말해 보면?" 하나씩 바꿔 보기로 했어요.',
