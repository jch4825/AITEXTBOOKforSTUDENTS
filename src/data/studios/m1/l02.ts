      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '동아리방에 선풍기와 자동문과 음악 앱이 있어요. 아이미: "저랑 뭐가 다른가요?"',
            '동아리방에서 선풍기와 자동문과 음악 앱을 나란히 놓고 살펴봤습니다. 아이미: "셋 다 움직이는데… 저랑 뭐가 다른가요?"',
            '동아리방에서 선풍기와 자동문과 음악 추천 앱을 나란히 놓고 살펴봤습니다. 아이미: "궁금한 게 있어요. 셋 다 움직이는데… 저랑 뭐가 다른가요?"',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우: "간단해! 스스로 움직이면 전부 AI지!" 윤아는 고개를 갸웃했어요.',
            '진우: "간단해! 스스로 움직이면 전부 AI지!" 윤아는 고개를 갸웃했습니다. "정말 그럴까?"',
            '진우: "간단해! 스스로 움직이면 전부 AI지!" 윤아는 고개를 갸웃했습니다. "정말 그렇게 간단할까? 셋이 받는 정보가 같을까?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "하나씩 보자. 선풍기는 뭘 받고 움직이지?" 버튼, 센서, 사용 기록이 달랐어요.',
            '윤아: "잠깐, 하나씩 보자. 선풍기는 뭘 받고 움직이지?" 하나씩 짚어 보니 버튼, 센서, 사용 기록이 서로 달랐습니다.',
            '윤아: "하나씩 보자. 선풍기는 뭘 받고 움직이지? 자동문은? 음악 앱은?" 짚어 보니 버튼, 센서, 사용 기록이 서로 다른 신호였습니다.',
