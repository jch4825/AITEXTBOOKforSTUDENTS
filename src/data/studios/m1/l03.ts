      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              ...
              [
                '윤아: "아이미야, 오늘 우리 학교 점심 급식 메뉴가 뭐야?" 아이미는 화면에 글자를 빠르게 띄우기 시작했습니다.',
                '윤아가 옆에 서 있는 아이미에게 물었습니다. 윤아: "아이미야, 오늘 우리 학교 점심 급식 메뉴가 뭐야?" 아이미는 화면에 글자를 빠르게 띄우며 답할 준비를 했습니다.',
                '윤아가 옆에 서 있는 아이미를 쳐다보며 물었습니다. 윤아: "아이미야, 오늘 우리 학교 점심 급식 메뉴가 뭐야?" 아이미는 가슴 모니터에 글자를 빠르게 띄우며 대답할 준비를 시작했습니다.',
              ],
              [
          ...
          copy: sceneBeats(
            [
              ...
              [
                ...
                '윤아가 게시판 식단표 사진을 스마트폰으로 찍어 와 아이미 가슴 화면 앞에 내밀었습니다. 윤아: "이것 봐, 진짜 식단표랑 완전히 다르잖아!" 아이미: "어머나… 제가 지어낸 말이 사실과 완전히 달랐나요?"',
              ],
            ],
          ...
          copy: sceneBeats(
            [
              ...
              [
                ...
                '아이미가 모니터 속 눈을 깜빡이며 여러분을 조심스럽게 바라보았습니다. 아이미: "화면에 남아 있는 제 대답 중에서, 진짜 사실이 맞는지 여러분이 먼저 꼼꼼하게 확인해야 할 문장은 무엇일까요?"',
              ],
            ],
