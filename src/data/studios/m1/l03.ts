      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '점심시간 전이에요. 윤아가 오늘 급식 메뉴를 물었어요. 아이미는 다음 단어를 이어 붙였어요.',
            '점심시간 전, 윤아가 “오늘 급식 메뉴가 뭐야?” 하고 물었습니다. 아이미는 ‘오늘 급식은’ 뒤에 어울릴 단어를 차례차례 이어 붙였습니다.',
            '점심시간 전, 윤아가 오늘 급식 메뉴를 물었습니다. 아이미는 식단표를 확인하는 대신 ‘오늘 급식은’ 뒤에 이어질 확률이 높은 단어를 계산해 이어 붙였습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "오늘 급식은 무지개 아이스크림 떡볶이야!" 모르는 일인데도 아주 당당했어요.',
            '아이미는 모르는 정보인데도 자신감 넘치는 목소리로 "오늘 급식은 무지개 아이스크림 떡볶이야!"라고 발표해 윤아를 황당하게 했습니다.',
            '아이미는 모르는 정보인데도 확신에 찬 목소리로 "오늘 급식은 무지개 아이스크림 떡볶이야!"라고 대답했습니다. 유창한 말 속에 엉뚱한 거짓말(환각)이 섞여 있었습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아가 학교 게시판의 진짜 식단표를 봤어요. 오늘 메뉴는 ‘제육볶음과 미역국’이었어요.',
            '윤아가 학교 게시판의 진짜 주간 식단표를 확인했습니다. 오늘 메뉴는 ‘제육볶음과 미역국’이라고 바르게 적혀 있었습니다.',
            '윤아가 영양사 선생님이 작성한 주간 식단표와 아이미의 대답을 나란히 놓고 대조했습니다. 오늘 메뉴는 ‘제육볶음과 미역국’이었습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "사실 다음 낱말을 이어 붙인 거였어요. 무엇부터 확인해야 할까요?"',
            '아이미: "헤헤, 사실 다음 낱말을 이어 붙인 거였어요. 그럼 제 대답 중에서 무엇부터 확인해야 할까요?"',
            '아이미: "헤헤, 사실 저는 식단표를 본 게 아니라 다음 낱말을 이어 붙인 거였어요. 제 대답 중에서 무엇부터 확인해 보시겠어요?"',
