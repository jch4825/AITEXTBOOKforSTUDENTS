      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              ...
              [
                '아이미가 화면 속 눈을 깜빡이며 당당하게 외쳤습니다. 아이미: "반갑습니다! 저는 고성능 연산 엔진 알고리즘 도구입니다!"',
                '로봇이 화면 속 푸른빛 눈을 깜빡이며 아주 당당하게 외쳤습니다. 아이미: "반갑습니다! 저는 고성능 연산 엔진과 복잡한 알고리즘이 결합된 인공지능 도구입니다!"',
                '로봇이 화면 속 푸른빛 눈을 씩씩하게 깜빡이며 아주 당당한 목소리로 외쳤습니다. 아이미: "반갑습니다! 저는 고성능 연산 엔진과 복잡한 알고리즘이 결합된 최신 인공지능 도구입니다!"',
              ],
            ],
