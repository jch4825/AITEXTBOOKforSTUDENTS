      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              [
                '목요일 방과 후, 진우와 윤아는 새로 문을 연 AI 동아리방에서 설레는 마음으로 교실 앞문을 바라보았습니다.',
                '목요일 방과 후, 진우와 윤아는 새로 문을 연 AI 동아리방에서 오늘 특별한 새 인공지능 도구가 찾아온다는 소식을 듣고 문만 바라보았습니다.',
                '목요일 방과 후, 진우와 윤아는 새로 문을 연 AI 동아리방에서 오늘 특별한 새 인공지능 도구가 찾아온다는 민준 선생님의 말씀을 듣고 기대에 차 문만 바라보았습니다.',
              ],
              [
                '교실 문이 스르륵 열리더니 작은 로봇이 걸어 들어왔습니다. 진우: "우아! 진짜 로봇이 우리 동아리에 왔어!"',
                '교실 앞문이 스르륵 열리더니 앙증맞은 작은 로봇이 걸어 들어왔습니다. 진우: "우아! 진짜 인공지능 로봇이 우리 동아리방에 스스로 찾아왔어!"',
                '교실 앞문이 스르륵 열리더니 앙증맞은 작은 바퀴 달린 로봇이 걸어 들어왔습니다. 진우: "우아! 진짜 인공지능 로봇이 우리 동아리방에 스스로 찾아왔어!" 윤아도 눈을 크게 떴습니다.',
              ],
              [
                '로봇이 화면을 깜빡이며 당당하게 외쳤습니다. 아이미: "반갑습니다! 저는 고성능 연산 엔진 알고리즘 도구입니다!"',
                '로봇이 가슴 화면을 깜빡이며 아주 당당하게 외쳤습니다. 아이미: "반갑습니다! 저는 고성능 연산 엔진과 복잡한 알고리즘이 결합된 인공지능 도구입니다!"',
                '로봇이 가슴 화면을 씩씩하게 깜빡이며 아주 당당한 목소리로 외쳤습니다. 아이미: "반갑습니다! 저는 고성능 연산 엔진과 복잡한 알고리즘이 결합된 최신 인공지능 도구입니다!"',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              ...
              [
                '연산 엔진이나 알고리즘은 어른들도 쓰기 어려운 말입니다. 딱딱한 기계어로는 아이미의 진짜 마음과 뜻이 전해지지 않았습니다.',
                '연산 엔진이나 알고리즘 같은 낱말은 어른들도 설명하기 어려운 말입니다. 교과서에나 나올 딱딱한 기계어로는 아이미가 어떤 친구인지 뜻이 전혀 전해지지 않았습니다.',
                '연산 엔진이나 알고리즘 같은 낱말은 어른들도 쉽게 설명하기 어려운 말입니다. 교과서에나 나올 딱딱한 기계 부품 용어로는 아이미가 어떤 친구인지, 무엇을 돕는지 전혀 전해지지 않았습니다.',
              ],
              [
          ...
          copy: sceneBeats(
            [
              ...
              [
                ...
                '아이미가 모니터 속 두 눈을 반짝이며 여러분을 향해 물었습니다. 아이미: "친구들에게 저를 직접 소개한다면, 여러분은 제가 사람들의 어떤 일을 도와주는 도구라고 쉽고 친절하게 설명하고 싶으신가요?"',
              ],
            ],
