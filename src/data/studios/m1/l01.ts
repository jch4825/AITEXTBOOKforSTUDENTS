      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              [
                '목요일 방과 후입니다. 진우와 윤아는 AI 동아리방에서 문을 바라보았습니다. 오늘 새 도구가 온다고 들었기 때문입니다.',
                '목요일 방과 후, 진우와 윤아는 AI 동아리방에서 문만 바라보고 있었습니다. 오늘 새 도구가 온다고 민준 선생님이 알려 주셨기 때문입니다.',
                '목요일 방과 후, 진우와 윤아는 AI 동아리방에서 문만 바라보고 있었습니다. 오늘 새 도구가 온다고 민준 선생님이 알려 주셨기 때문입니다. 어떤 도구인지는 아직 아무도 몰랐습니다.',
              ],
              [
                '문이 열렸습니다. 작은 로봇이 들어왔습니다. 진우: "우아, 진짜 로봇이잖아!" 로봇의 이름은 아이미입니다.',
                '문이 열리고 작은 로봇이 들어왔습니다. 진우: "우아, 진짜 로봇이잖아!" 로봇이 스스로 이름을 말했습니다. 아이미: "저는 아이미입니다."',
                '문이 열리고 작은 로봇이 들어왔습니다. 진우: "우아, 진짜 로봇이잖아!" 윤아는 아무 말 없이 로봇을 살펴보았습니다. 아이미: "처음 뵙겠습니다. 저는 아이미입니다."',
              ],
              [
                '아이미: "저는 연산 엔진 알고리즘 도구입니다!" 진우와 윤아는 서로를 보았습니다.',
                '아이미가 자기소개를 시작했습니다. 아이미: "저는 연산 엔진과 알고리즘이 결합된 인공지능입니다!" 진우와 윤아는 아무 말도 하지 못하고 서로를 보았습니다.',
                '아이미가 아주 당당하게 자기소개를 시작했습니다. 아이미: "저는 연산 엔진과 알고리즘이 결합된 인공지능입니다!" 진우와 윤아는 아무 말도 하지 못하고 서로를 마주 보았습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '진우: "아이미야, 방금 그 말… 나 하나도 못 알아들었어!" 아이미는 잠깐 조용해졌습니다.',
                '진우가 참지 못하고 손을 들었습니다. 진우: "아이미야, 방금 그 말… 나 하나도 못 알아들었어!" 아이미는 잠깐 조용해졌습니다.',
                '진우가 참지 못하고 손을 들었습니다. 진우: "아이미야, 잠깐만. 방금 그 말… 나 하나도 못 알아들었어!" 동아리방이 조용해졌고, 아이미도 잠시 말을 멈췄습니다.',
              ],
              [
                '"연산 엔진"과 "알고리즘"은 어려운 말입니다. 아이미의 설명에는 어려운 말이 많았습니다. 그래서 뜻이 전해지지 않았습니다.',
                '"연산 엔진"과 "알고리즘"은 어른들도 잘 쓰지 않는 어려운 말입니다. 아이미의 설명에는 어려운 말이 많았습니다. 그래서 뜻이 전해지지 않았습니다.',
                '"연산 엔진"과 "알고리즘"은 어른들도 잘 쓰지 않는 어려운 말입니다. 아이미는 자기가 배운 말을 그대로 썼습니다. 아이미의 설명에는 어려운 말이 많아서 뜻이 전해지지 않았습니다.',
              ],
              [
                '윤아: "아이미야, 쉬운 말로 다시 해 줄래?" 아이미: "…어떤 말이 쉬운 말인가요?"',
                '윤아가 조용히 물었습니다. 윤아: "아이미야, 쉬운 말로 다시 해 줄래?" 아이미: "…어떤 말이 쉬운 말인가요?" 아이미도 그 답은 알지 못했습니다.',
                '윤아가 조용히 물었습니다. 윤아: "아이미야, 쉬운 말로 다시 해 줄래?" 아이미: "…죄송해요. 어떤 말이 쉬운 말인지는 저도 몰라요." 아이미도 그 답만은 알지 못했습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '민준 선생님이 오셨습니다. 민준 선생님: "우리가 이미 쓰고 있는 것부터 찾아볼까요?"',
                '민준 선생님이 오셨습니다. 민준 선생님: "어려운 말 대신, 우리가 이미 쓰고 있는 것부터 찾아볼까요?" 선생님이 화면에 세 가지를 띄우셨습니다.',
                '지켜보시던 민준 선생님이 다가오셨습니다. 민준 선생님: "어려운 말 대신, 우리가 이미 쓰고 있는 것부터 찾아볼까요?" 선생님은 화면에 세 가지를 나란히 띄우셨습니다.',
              ],
              [
                '화면에는 번역 앱, 음악 추천, 사진에서 물건 찾기가 있었습니다. 진우: "이거 나도 매일 쓰는 건데!"',
                '화면에는 번역 앱, 음악 추천, 사진에서 물건 찾기가 있었습니다. 진우: "어? 이거 나도 매일 쓰는 건데!" 셋 다 아이미와는 상관없어 보였습니다.',
                '화면에는 번역 앱, 음악 추천, 사진에서 물건 찾기가 나란히 있었습니다. 진우: "어? 이거 전부 나도 매일 쓰는 건데!" 셋 다 아이미와는 상관없어 보였습니다.',
              ],
              [
                '윤아: "번역 앱, 음악 추천, 사진 찾기… 공통점이 뭘까?" 아무도 답하지 못했습니다.',
                '윤아가 세 가지를 하나씩 짚었습니다. 윤아: "번역 앱이랑 음악 추천이랑 사진 찾기… 이 셋의 공통점이 뭘까?" 아직 아무도 답하지 못했습니다.',
                '윤아가 화면 속 세 가지를 하나씩 짚어 보았습니다. 윤아: "번역 앱이랑 음악 추천이랑 사진 찾기… 이 셋의 공통점이 뭘까?" 진우도 아이미도 바로 답하지 못했습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '진우와 윤아는 공통점을 찾아냈습니다. 셋 다 말이나 글, 사진을 받아서 일을 해 줍니다.',
                '진우와 윤아는 마침내 공통점을 찾아냈습니다. 세 가지 모두 말이나 글, 사진을 받아서 일을 해 줍니다. 아이미가 하는 일도 똑같았습니다.',
                '진우와 윤아는 한참 만에 공통점을 찾아냈습니다. 세 가지 모두 말이나 글, 사진을 받아서 사람에게 필요한 일을 해 줍니다. 아이미가 하는 일도 이와 똑같았습니다.',
              ],
              [
                '민준 선생님이 빈 카드를 한 장씩 주셨습니다. 민준 선생님: "아이미를 소개하는 카드를 만들어 봅시다."',
                '민준 선생님이 빈 카드를 한 장씩 나누어 주셨습니다. 민준 선생님: "그럼 아이미를 친구에게 소개하는 카드를 만들어 봅시다." 진우는 카드를 들고 멈췄습니다.',
                '민준 선생님이 빈 카드를 한 장씩 나누어 주셨습니다. 민준 선생님: "그럼 아이미를 친구에게 소개하는 카드를 만들어 봅시다." 진우는 카드를 손에 든 채 한참 멈춰 있었습니다.',
              ],
              [
                '아이미: "저를 친구에게 뭐라고 소개하실 건가요?" 카드는 아직 비어 있었습니다.',
                '아이미가 진우 앞으로 다가왔습니다. 아이미: "여러분이라면 저를 친구에게 뭐라고 소개하실 건가요? 제가 하는 일도 함께요." 카드는 아직 비어 있었습니다.',
                '아이미가 진우 앞으로 다가왔습니다. 아이미: "여러분이라면 저를 친구에게 뭐라고 소개하실 건가요? 제가 무슨 일을 하는지도 함께요." 카드는 아직 비어 있었습니다.',
              ],
            ],
