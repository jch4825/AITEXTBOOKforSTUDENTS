      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '동아리방 문이 열렸습니다. 아이미: "반갑습니다!"',
            '동아리방 문이 열렸습니다. 아이미: "반갑습니다! 저는 연산 엔진 알고리즘 도구입니다!"',
            '동아리방 문이 열렸습니다. 신형 로봇 아이미가 당당하게 등장했습니다. 아이미: "반갑습니다! 저는 테라플롭스급 연산 엔진과 알고리즘이 결합된 인공지능입니다!"',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '아이미의 설명에는 어려운 말이 많았어요. 낯선 기술 용어가 쏟아지자 진우의 눈동자가 지진이라도 난 듯 흔들렸습니다. 진우: "아이미야, 방금 그 말… 나 하나도 못 알아들었어! 우리가 이해하기 쉽게 말해 줄 수 있어?"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "번역 앱이랑 음악 추천이랑 사진 찾기… 공통점이 뭘까?"',
            '윤아: "잠깐, 번역 앱이랑 음악 추천이랑 사진 찾기… 이것들의 공통점이 뭘까?" 진우는 고개를 갸웃했습니다.',
            '윤아: "잠깐, 번역 앱이랑 음악 추천이랑 사진 찾기… 이것들의 공통점이 뭘까?" 민준 선생님도 함께 화면 속 사례를 하나씩 짚어 보았습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "저를 친구에게 뭐라고 소개하실 건가요?"',
            '아이미: "여러분이라면 저를 친구에게 뭐라고 소개하실 건가요?" 진우는 카드를 손에 든 채 생각에 잠겼습니다.',
            '아이미: "여러분이라면 저를 친구에게 뭐라고 소개하실 건가요?" 진우는 빈 카드를 손에 든 채 무엇부터 적을지 고민했습니다.',
