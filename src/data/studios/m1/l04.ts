      ...
      scenes: [
        {
          ...
          copy: sceneCopy(
            '윤아: "이 사진 속 동물이 뭐게?"',
            '윤아: "아이미야, 이 사진 속 동물이 뭐게? 조금 가려져 있긴 해." 윤아는 얼굴 일부가 가려진 사진을 보여 주었습니다.',
            '윤아: "아이미야, 이 사진 속 동물이 뭐게? 조금 가려져 있긴 해." 귀와 얼굴 일부만 보이는 사진이었습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            '아이미: "간단해요! 고양이입니다!"',
            '아이미: "간단해요! 귀 모양을 보니 고양이입니다. 확률 87%!"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "가린 걸 줄이고 다시 보여 주면?"',
            '진우: "틀렸네!" 윤아: "잠깐, 가린 걸 줄이고 다시 보여 주면 어떻게 될까?" 다시 보여 주자 아이미는 "여우입니다!"라고 답을 바꿨습니다.',
            '진우가 성급히 "틀렸네!"라고 하려 하자 윤아가 멈췄습니다. "잠깐, 가린 걸 줄이고 다시 보여 주면 어떻게 될까?" 다시 보여 주자 아이미는 "여우입니다!"라고 답을 바꿨습니다.',
