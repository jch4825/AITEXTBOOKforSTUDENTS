...
export const M1_STUDIOS: StudioDefinition[] = [
  {
    ...
    moduleId: 'm1',
    title: '아이미와 처음 만난 날',
    subtitle: '생활 속 AI가 하는 일을 찾고, AI를 내 말로 소개해 봐요.',
    visualNovel: {
      title: '아이미의 어려운 자기소개',
      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            'AI 동아리 첫날, 진우가 아이미를 만났어요.',
            'AI 동아리 첫날, 진우 앞에 새 로봇 아이미가 나타났습니다.',
            'AI 동아리 첫날, 진우는 동아리방에서 새 로봇 아이미를 처음 만났습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '아이미는 자신을 여러 어려운 말로 소개했습니다. 진우는 뜻을 알기 어려웠습니다.',
            '아이미의 자기소개에는 낯선 기술 용어가 많았습니다. 진우는 설명의 핵심을 찾기 어려웠습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '민준 선생님이 번역, 추천, 사진 분류 사례를 보여 줬어요.',
            '민준 선생님은 번역, 음악 추천, 사진 분류처럼 생활 속에서 만나는 AI 기능을 보여 주었습니다.',
            '민준 선생님은 말과 사진을 입력받아 번역, 추천, 분류 결과를 만드는 생활 속 AI 기능을 비교해 주었습니다.',
            '사례를 살펴보면 어려운 설명의 공통점을 찾을 수 있어요.',
          ),
        },
        {
          id: 'my-definition',
          ...
          copy: sceneCopy(
            '진우는 AI를 자기 말로 소개했어요.',
            '진우는 입력, 자료, 결과라는 말을 골라 짧은 AI 소개를 만들었습니다.',
            '진우는 생활 사례에서 찾은 공통점을 바탕으로 AI를 사람이 만든 도구라고 설명했습니다.',
      ...
      knowledge: [
        {
          title: 'AI는 도구예요',
          core: 'AI는 사람이 목적을 정하고 만든 도구입니다.',
          detail: {
            full: '사람이 무엇을 도와줄지 정해 만들어요.',
            light: 'AI가 스스로 목적을 정하는 것이 아니라 사람이 목적과 사용 방법을 정합니다.',
            challenge: 'AI의 기능과 사용 범위는 사람이 정한 목적, 설계, 연결된 자료와 도구에 따라 달라집니다.',
          },
        },
        {
          title: '입력을 받아요',
          core: 'AI는 말, 글, 사진 같은 입력을 받습니다.',
          detail: {
            full: '들어온 자료를 살펴봐요.',
            light: '어떤 입력을 받았는지에 따라 AI가 만들 수 있는 결과가 달라집니다.',
            challenge: '입력의 종류와 상태는 AI가 참고할 수 있는 정보의 범위를 결정합니다.',
          },
          flow: { input: '말·글·사진', process: '자료에서 규칙 찾기', output: '답·추천·분류' },
        },
        {
          title: '결과는 확인해요',
          core: 'AI가 만든 결과는 사람이 확인하고 결정합니다.',
          detail: {
            full: '중요한 내용은 다시 살펴봐요.',
            light: 'AI 결과가 목적과 사실에 맞는지 사람이 살펴본 뒤 사용합니다.',
            challenge: '결과의 정확성, 안전성, 적절성을 검토하고 최종 사용 여부를 사람이 결정합니다.',
          },
        },
      ],
    },
    encounter: {
      title: '아이미의 자기소개',
      description: '아이미가 어려운 말로 자신을 소개했습니다. 진우는 생활 속 사례를 살펴보며 쉬운 설명을 만들려고 합니다.',
      facts: [
        '아이미는 사람이 만든 도구입니다.',
        'AI는 말, 글, 사진 같은 입력을 받을 수 있습니다.',
        'AI는 답, 추천, 분류 같은 결과를 만들 수 있습니다.',
      ],
    },
    firstAttempt: {
      prompt: '아이미를 처음 만난 친구에게 AI를 어떻게 소개하겠습니까?',
      choices: [
        { id: 'tool-with-input', emoji: 'TOOL', label: '자료와 입력을 받아 결과를 만드는 사람이 만든 도구라고 소개합니다.' },
        { id: 'magic-friend', emoji: 'MAGIC', label: '모든 것을 알고 스스로 결정하는 마법 친구라고 소개합니다.' },
        { id: 'just-machine', emoji: 'MACHINE', label: '전기로 움직이는 기계는 모두 AI라고 소개합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
      reasonPrompt: '그 소개에서 꼭 남기고 싶은 말은 무엇인가요?',
    },
    supportProfiles: STUDIO_SUPPORT_PROFILES,
    conditionChange: {
      description: '번역 앱은 말을 글로 받아 번역을 만들고, 추천 기능은 사용 기록을 받아 노래 목록을 만듭니다.',
      facts: [
        'AI가 받는 입력은 기능마다 다릅니다.',
        'AI가 만드는 결과도 기능마다 다릅니다.',
        '같은 AI라도 입력이 달라지면 결과가 달라질 수 있습니다.',
        '중요한 결과는 사람이 다시 확인합니다.',
      ],
    },
    aiContribution: {
      source: 'prepared',
      role: '아이미의 쉬운 자기소개',
      text: '저는 말, 글, 사진 같은 입력을 받아 답이나 추천을 만드는 사람이 만든 도구예요. 제 결과는 여러분이 확인해 주세요.',
      question: '아이미의 소개를 그대로 쓸까요, 내 말에 맞게 고칠까요?',
    },
    artifact: {
      kind: 'action-card',
      title: 'AI 정의 카드',
      prompt: '“AI는 …을 받아 …을 도와주는 사람이 만든 도구예요” 문장을 내 말로 완성해 봐요.',
    },
    transfer: {
      title: '새 안내 기기를 만났다면',
      description: '도서관의 새 안내 기기가 질문을 받아 책을 추천합니다. 이 기능을 친구에게 어떻게 소개하겠습니까?',
      choices: [
        { id: 'describe-input-output', emoji: 'MAP', label: '질문을 입력받아 책 추천 결과를 만드는 기능이라고 소개합니다.' },
        { id: 'call-all-knowing', emoji: 'STAR', label: '도서관의 모든 일을 완벽하게 아는 친구라고 소개합니다.' },
        { id: 'check-recommendation', emoji: 'CHECK', label: '추천한 책이 내 목적에 맞는지는 사람이 확인한다고 덧붙입니다.' },
      ],
    },
  },
  {
      ...
      scenes: [
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아는 입력, 기능, 결과, 사람 확인을 연결해 세 도구의 차이를 설명했습니다.',
            '윤아는 한 기기 안에도 버튼, 센서, AI 기능이 함께 있을 수 있다는 점을 기능 분석 지도로 정리했습니다.',
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'automatic-means-ai', emoji: '⚙️', label: '자동으로 움직이면 모두 AI 기능이라고 판단합니다.' },
        { id: 'app-only-by-name', emoji: '📱', label: '앱이라는 이름이 붙은 기능만 AI라고 판단합니다.' },
        { id: 'inspect-input-output', emoji: '🔎', label: '각 기능이 받는 입력과 바꾸는 결과를 살펴본 뒤 판단합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    encounter: {
      ...
      description: '아이미의 소개문은 자연스럽고 즐겁게 읽힙니다. 날짜와 장소가 맞는지는 아직 확인하지 않았습니다.',
      facts: [
        '소개문에는 체험회가 5월 15일 교실에서 열린다고 적혀 있습니다.',
        '문장의 말투와 문법은 자연스럽습니다.',
        '윤아에게는 학교 공식 공지가 있습니다.',
      ],
    },
    firstAttempt: {
      prompt: '자연스러운 소개문을 받은 지금 어떻게 하겠습니까?',
      choices: [
        { id: 'publish-smooth-copy', emoji: '✨', label: '문장이 자연스러우니 바로 게시합니다.' },
        { id: 'reject-everything', emoji: '🗑️', label: 'AI 글은 틀릴 수 있으니 모두 버립니다.' },
        { id: 'mark-checkable-claims', emoji: '🖍️', label: '확인할 주장에 표시하고 공식 자료와 비교합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    supportProfiles: STUDIO_SUPPORT_PROFILES,
    conditionChange: {
      description: '학교 공식 공지에는 체험회가 5월 10일 강당에서 열린다고 적혀 있습니다.',
      facts: [
        '공지는 학교가 발행한 최신 자료입니다.',
        '아이미 소개문과 공식 공지의 날짜가 다릅니다.',
        '아이미 소개문과 공식 공지의 장소도 다릅니다.',
        '행사의 즐거운 분위기를 설명한 문장은 사실 정보와 분리해 검토할 수 있습니다.',
      ],
    },
    aiContribution: {
      source: 'prepared',
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'accept-first', emoji: 'USE', label: '첫 답을 바로 정답으로 사용합니다.' },
        { id: 'change-one-condition', emoji: 'TEST', label: '사진 조건을 하나씩 바꾸어 다시 시험합니다.' },
        { id: 'check-original', emoji: 'ORIGINAL', label: '원본 사진과 비교할 준비를 합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'follow-first-sign', emoji: 'GO', label: 'AI가 처음 읽은 내용대로 바로 버립니다.' },
        { id: 'change-sign-angle', emoji: 'ANGLE', label: '반사를 줄이도록 각도를 바꾸어 다시 확인합니다.' },
        { id: 'ask-staff', emoji: 'HUMAN', label: '표지판 원본이나 담당자 안내와 비교합니다.' },
      ],
    },
  ...
  },
  {
    ...
    encounter: {
      title: '복도 방송이 다르게 적혔어요',
      description: '체육대회 방송의 “파란 모자”가 음성 인식 화면에는 “바른 모자”라고 적혔습니다.',
      facts: [
        '복도에는 친구들 말소리와 발소리가 함께 들립니다.',
        '방송의 중요한 준비물은 파란 모자입니다.',
        '민서는 음성, 글자, 그림 입력 방법을 사용할 수 있습니다.',
      ],
    },
    firstAttempt: {
      prompt: '방송과 다른 글자가 나타났을 때 무엇을 먼저 하겠습니까?',
      choices: [
        { id: 'trust-transcript', emoji: 'TEXT', label: '화면에 적힌 글자를 그대로 믿습니다.' },
        { id: 'listen-again', emoji: 'REPLAY', label: '조용한 곳에서 원래 방송을 다시 듣습니다.' },
        { id: 'choose-another-input', emoji: 'CHOICE', label: '다른 입력 방법도 함께 비교합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
      reasonPrompt: '그 방법이 민서에게 어떤 도움을 줄까요?',
    },
    supportProfiles: STUDIO_SUPPORT_PROFILES,
    conditionChange: {
      description: '조용한 교실에서는 “파란 모자”로 바르게 적혔지만 마이크를 멀리 두자 다시 글자가 달라졌습니다.',
      facts: [
        '조용한 곳에서는 방송과 같은 글자가 나타났습니다.',
        '마이크가 멀어지자 목소리가 작게 입력되었습니다.',
        '말하는 속도를 늦추자 단어 사이가 더 분명해졌습니다.',
        '민서는 어떤 상황에서는 글자나 그림 선택이 더 편하다고 말했습니다.',
      ],
    },
    aiContribution: {
      source: 'prepared',
    ...
    transfer: {
      ...
      choices: [
        { id: 'follow-gym-text', emoji: 'GO', label: '변환된 글자만 보고 바로 이동합니다.' },
        { id: 'replay-gym-audio', emoji: 'LISTEN', label: '안내를 다시 듣고 장소 표지와 비교합니다.' },
        { id: 'use-accessible-option', emoji: 'ACCESS', label: '글자·그림 안내나 사람의 도움을 선택합니다.' },
      ],
    },
  ...
  },
  {
    ...
    encounter: {
      title: '세모만 많이 본 분류기',
      description: '세모 카드가 대부분인 자료로 배운 AI가 동그라미와 네모도 자꾸 세모라고 답합니다.',
      facts: [
        '학습 자료에는 세모 카드가 가장 많습니다.',
        '카드의 색과 크기도 서로 비슷합니다.',
        '시험에는 처음 보는 색과 크기의 도형이 포함됩니다.',
      ],
    },
    firstAttempt: {
      prompt: 'AI가 자꾸 세모라고 답하는 까닭을 어떻게 알아보겠습니까?',
      choices: [
        { id: 'blame-random', emoji: 'LUCK', label: 'AI가 오늘 운이 나빴다고 생각합니다.' },
        { id: 'inspect-data', emoji: 'DATA', label: 'AI가 배운 자료의 종류와 수를 살펴봅니다.' },
        { id: 'change-test-only', emoji: 'TEST', label: '시험 카드를 쉬운 세모로만 바꿉니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'accept-recycle-result', emoji: 'USE', label: 'AI 결과를 그대로 사용합니다.' },
        { id: 'balance-recycle-data', emoji: 'DATA', label: '여러 모양과 재질의 표지 자료를 고르게 준비합니다.' },
        { id: 'compare-recycle-test', emoji: 'CHECK', label: '같은 시험 자료로 바꾸기 전후를 비교합니다.' },
      ],
    },
  },
  {
    ...
    encounter: {
      title: '체험회 안내가 너무 길어요',
      description: '아이미가 긴 체험회 안내를 요약하고 번역했지만 신청 마감과 장소 이름이 정확한지 알 수 없습니다.',
      facts: [
        '공식 안내문에는 날짜, 장소, 준비물, 마감 시간이 있습니다.',
        '요약에는 신청 마감 시간이 보이지 않습니다.',
        '번역문에는 장소 이름이 원문과 다르게 적혀 있습니다.',
      ],
    },
    firstAttempt: {
      prompt: '빠르게 만든 요약과 번역을 어떻게 사용하겠습니까?',
      choices: [
        { id: 'share-fast-result', emoji: 'SEND', label: '빠르게 만들었으니 바로 공유합니다.' },
        { id: 'compare-key-facts', emoji: 'CHECK', label: '핵심 항목을 원문과 나란히 비교합니다.' },
        { id: 'ignore-ai-help', emoji: 'STOP', label: '틀릴 수 있으니 AI 도움은 모두 버립니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    supportProfiles: STUDIO_SUPPORT_PROFILES,
    conditionChange: {
      description: '공식 안내문을 다시 보니 신청 마감은 행사 전날 오후 4시이고 장소 이름은 “상상마루”였습니다.',
      facts: [
        '요약에는 신청 마감 정보가 빠져 있었습니다.',
        '번역문의 장소 이름은 원문과 달랐습니다.',
        '날짜와 준비물 정보는 원문과 같았습니다.',
        '공식 안내의 링크와 수정한 부분을 함께 표시할 수 있습니다.',
      ],
    },
    aiContribution: {
      source: 'prepared',
    ...
    transfer: {
      ...
      choices: [
        { id: 'send-short-supply', emoji: 'SEND', label: '짧고 읽기 쉬우니 그대로 보냅니다.' },
        { id: 'check-supply-source', emoji: 'SOURCE', label: '원문에서 날짜와 준비물을 확인합니다.' },
        { id: 'repair-supply-summary', emoji: 'EDIT', label: '빠진 날짜를 넣고 확인한 안내를 공유합니다.' },
      ],
    },
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'assign-all-ai', emoji: 'AI', label: '빠르므로 모든 일을 AI에게 맡깁니다.' },
        { id: 'separate-roles', emoji: 'ROLES', label: 'AI, 사람, 공식 정보의 역할을 나눕니다.' },
        { id: 'refuse-all-tools', emoji: 'NONE', label: '위험할 수 있으니 어떤 도움도 사용하지 않습니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'share-password-ai', emoji: 'PASSWORD', label: '빠른 해결을 위해 비밀번호를 입력합니다.' },
        { id: 'official-account-help', emoji: 'OFFICIAL', label: '비밀번호를 입력하지 않고 공식 복구 절차를 확인합니다.' },
        { id: 'ask-trusted-adult', emoji: 'HUMAN', label: '신뢰할 수 있는 어른이나 담당자에게 도움을 요청합니다.' },
      ],
    },
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'choose-famous-tool', emoji: 'FAMOUS', label: '가장 유명한 도구 하나를 모든 일에 사용합니다.' },
        { id: 'match-input-output', emoji: 'MATCH', label: '일마다 입력과 필요한 결과를 먼저 비교합니다.' },
        { id: 'choose-fastest-tool', emoji: 'FAST', label: '결과가 가장 빨리 나오는 도구만 고릅니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'upload-private-photo', emoji: 'UPLOAD', label: '사람 얼굴이 나온 원본을 아무 도구에나 올립니다.' },
        { id: 'plan-photo-tools', emoji: 'PLAN', label: '이미지 설명과 음성 제작에 필요한 입력·출력을 나눕니다.' },
        { id: 'verify-photo-description', emoji: 'CHECK', label: '사진 원본과 사람이 장면 설명을 확인합니다.' },
      ],
    },
  ...
  },
  {
    ...
    encounter: {
      title: '체험회 배경음악 목록',
      description: '아이미가 체험회 배경음악 목록을 만들었습니다. 몇 곡은 행사 분위기와 맞지 않고, 한 곡은 공식 목록에서 찾을 수 없습니다.',
      facts: [
        '체험회는 대화를 방해하지 않는 조용한 분위기가 필요합니다.',
        '사용할 수 있는 곡은 학교의 공식 목록에서 확인해야 합니다.',
        '아이미의 첫 결과에는 조건과 맞지 않는 항목이 있습니다.',
      ],
    },
    firstAttempt: {
      prompt: '아이미의 첫 음악 목록을 어떻게 처리하겠습니까?',
      choices: [
        { id: 'use-all', emoji: 'USE', label: '아이미가 골랐으니 모든 곡을 그대로 사용합니다.' },
        { id: 'review-items', emoji: 'CHECK', label: '행사 조건과 공식 목록을 기준으로 곡마다 확인합니다.' },
        { id: 'reject-all', emoji: 'STOP', label: '확인하지 않고 AI 결과를 모두 거절합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'publish-now', emoji: 'SEND', label: '문장이 자연스러우니 바로 게시합니다.' },
        { id: 'modify-time', emoji: 'EDIT', label: '공식 공지에서 시간을 확인해 문구를 수정합니다.' },
        { id: 'reject-unsafe', emoji: 'REJECT', label: '개인정보를 요구하는 결과라면 사용을 거절합니다.' },
      ],
    },
