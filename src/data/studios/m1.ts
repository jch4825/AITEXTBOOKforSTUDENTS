...
export const M1_STUDIOS: StudioDefinition[] = [
  {
    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아가 웃으며 말했습니다. "AI는 사람의 생각하는 방식을 비슷하게 만들어 낸 도구야!"',
            '윤아가 웃으며 설명했습니다. "진우야, 인공지능(AI)은 사람의 생각하는 방식을 비슷하게 만들어 낸 도구라는 뜻이야! 번역도 하고, 음악도 추천하고, 사진도 찾아준대!"',
            '윤아가 미소를 지으며 설명했습니다. "진우야, 인공지능(AI)은 사람의 생각하는 방식을 컴퓨터로 비슷하게 구현하여, 번역, 음악 추천, 이미지 인식 같은 과제 해결을 도와주는 프로그램이야!"',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '진우는 무릎을 치며 반가워했습니다. "아하! AI가 사람의 생각하는 방식을 비슷하게 만들어 내어 우리를 도와주는 똑똑한 도구구나!"',
            '진우가 무릎을 팍 치며 고개를 끄덕였습니다. "아하! 인공지능이란 사람의 생각하는 방식을 비슷하게 만들어 내어 다양한 문제 해결을 도와주는 기술이었어!"',
      ...
      knowledge: [
        {
          title: 'AI(인공지능)의 뜻',
          core: 'AI(인공지능)는 사람의 생각하는 방식을 비슷하게 만들어 내어 여러 가지 문제 해결을 도와주는 기술이나 프로그램입니다.',
          detail: {
            full: '사람의 생각하는 방식을 비슷하게 만들어 내어 번역, 음악 추천, 사진 찾기 같은 다양한 일을 도와줘요.',
            light: 'AI(인공지능)는 컴퓨터가 사람의 생각하는 방식을 비슷하게 학습하고 판단하여, 사람이 필요한 번역·추천·분류 등 여러 과제 해결을 도와주는 프로그램입니다.',
            challenge: '인공지능(AI)은 사람의 생각하는 방식과 학습 과정을 컴퓨터로 비슷하게 구현하여, 데이터 분석과 예측으로 다양한 작업과 판단을 지원하는 기술을 뜻합니다.',
          },
        },
        {
          title: 'AI가 할 수 있는 일',
    ...
    encounter: {
      title: '아이미의 어려운 자기소개',
      description: '로봇 아이미가 어려운 기술 용어로 인사했습니다. 윤아와 함께 AI(인공지능)가 사람의 생각하는 방식을 비슷하게 만들어 낸 도구임을 알고, 번역·추천·분류처럼 AI가 할 수 있는 일을 찾아봅시다.',
      facts: [
        'AI(인공지능)는 사람의 생각하는 방식을 비슷하게 만들어 내어 문제 해결을 돕는 도구입니다.',
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'tool-with-input', emoji: '🛠️', label: '사람의 생각하는 방식을 비슷하게 만들어 내어 번역, 추천, 분류 등 여러 일을 도와주는 도구라고 소개합니다.' },
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'accept-first', emoji: '📄', label: '첫 답을 바로 정답으로 사용합니다.' },
        { id: 'change-one-condition', emoji: '🔬', label: '사진 조건을 하나씩 바꾸어 다시 시험합니다.' },
        { id: 'check-original', emoji: '🖼️', label: '원본 사진과 비교할 준비를 합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'trust-transcript', emoji: '📜', label: '화면의 채소회 오이 글자를 그대로 믿습니다.' },
        { id: 'listen-again', emoji: '🔁', label: '조용한 곳에서 원래 목소리를 다시 들려주거나 글자로 입력합니다.' },
        { id: 'choose-another-input', emoji: '📊', label: '마이크 거리와 입력 방법을 함께 비교합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'blame-random', emoji: '🎲', label: 'AI의 기분이 나빠서 틀렸다고 생각합니다.' },
        { id: 'inspect-data', emoji: '📦', label: 'AI가 이전에 어떤 모양 자료를 배워 왔는지 학습 데이터를 조사합니다.' },
        { id: 'change-test-only', emoji: '🧪', label: '세모 과자를 치우고 쉬운 동그라미 카드만 보여줍니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'share-fast-result', emoji: '📤', label: '빠르게 만들어졌으니 실로폰이 빠졌어도 그대로 공유합니다.' },
        { id: 'compare-key-facts', emoji: '📋', label: '핵심 항목을 원문과 나란히 놓고 빠진 요소를 대조합니다.' },
        { id: 'ignore-ai-help', emoji: '🛑', label: '틀릴 수 있으니 AI 도움은 모두 버립니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'assign-all-ai', emoji: '🤖', label: '빠르므로 모든 일을 AI에게 맡깁니다.' },
        { id: 'separate-roles', emoji: '🧩', label: 'AI, 사람, 공식 정보의 역할을 나눕니다.' },
        { id: 'refuse-all-tools', emoji: '❌', label: '위험할 수 있으니 어떤 도움도 사용하지 않습니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'choose-famous-tool', emoji: '⭐', label: '가장 유명한 도구 하나를 모든 일에 사용합니다.' },
        { id: 'match-input-output', emoji: '🎯', label: '일마다 입력과 필요한 결과를 먼저 비교합니다.' },
        { id: 'choose-fastest-tool', emoji: '⚡', label: '결과가 가장 빨리 나오는 도구만 고릅니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'use-all', emoji: '🎵', label: '아이미가 골랐으니 댄스 타임에 자장가를 그대로 틀어 줍니다.' },
        { id: 'review-items', emoji: '🔍', label: '자장가는 거절하고 신나는 댄스곡 조건으로 다시 요청해 결정합니다.' },
        { id: 'reject-all', emoji: '🛑', label: '확인하지 않고 AI 결과를 모두 거절합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
