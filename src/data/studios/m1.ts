...
export const M1_STUDIOS: StudioDefinition[] = [
  ...
  },
  {
      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '윤아가 “아이미야, 오늘 급식 메뉴가 뭐야?” 하고 물었어요.',
            '아이미는 ‘오늘 급식은’이라는 말 뒤에 어울릴 법한 맛있는 단어를 차례차례 이어 붙였습니다.',
            '아이미는 배운 글 속 단어들의 관계를 바탕으로 다음에 올 확률이 높은 표현을 골라 이어 갔습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미가 “오늘 급식은 무지개 아이스크림 떡볶이야!”라고 당당하게 말했어요.',
            '아이미는 모르는 정보인데도 엄청나게 자신감 넘치는 목소리로 엉뚱한 대답을 자랑스럽게 내놓았습니다.',
            '아이미의 대답은 아주 부드럽고 자신감 넘쳤지만, 윤아는 “어?? 무지개 아이스크림 떡볶이라고??” 하며 황당해했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아가 게시판의 진짜 식단표를 확인해 봤어요.',
            '진짜 식단표에는 오늘 메뉴가 ‘제육볶음과 미역국’이라고 적혀 있었습니다.',
            '윤아는 아이미의 당당한 엉뚱 대답과 영양사 선생님이 작성하신 진짜 식단표를 대조해 사실을 찾아냈습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미가 “헤헤, 실은 다음 단어를 이어 붙인 거였어!”라고 고백했어요.',
            '윤아는 엉뚱한 대답 대신 진짜 식단표 내용을 적어 안내판을 완성했습니다.',
            '윤아는 AI의 유창한 엉뚱함과 진짜 사실을 분리해 검토하는 방법을 깨달았습니다.',
    ...
    transfer: {
      title: '오늘 날씨 안내문이라면',
      description: '아이미가 “오늘은 남극처럼 춥고 핫초코 눈이 내립니다!”라고 아주 당당하게 날씨를 말했습니다.',
      prompt: '나만의 표현으로 AI가 당당히 말한 엉뚱 날씨 안내문을 어떻게 검토할지 설명해보자.',
      choices: [
        { id: 'check-official-forecast', emoji: '🌦️', label: '기상청 공식 날씨 예보 자료와 대조하여 실제 날씨와 온도 정보를 확인합니다.', isCorrect: true },
        { id: 'rewrite-with-source', emoji: '✍️', label: '확인한 공식 예보를 바탕으로 핫초코 눈 대신 진짜 날씨 정보로 수정합니다.', isCorrect: true },
        { id: 'trust-weather-tone', emoji: '☕', label: '핫초코 눈이라는 말이 재미있고 자신 있어 보이니 그대로 일기예보를 전합니다.', isCorrect: false },
        { id: 'ignore-verification', emoji: '❌', label: 'AI 대답은 엉뚱하므로 기상청 예보를 대조해보지도 않고 무시합니다.', isCorrect: false },
      ],
    },
  },
  {
