...
export const M1_STUDIOS: StudioDefinition[] = [
  {
    ...
    encounter: {
      title: '아이미의 어려운 자기소개',
      description: '로봇 아이미가 어려운 기술 용어로 인사했습니다. 윤아와 함께 AI(인공지능)가 사람이 만든 똑똑한 도구임을 알고, 번역·추천·분류처럼 AI가 할 수 있는 일을 찾아봅시다.',
      facts: [
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'publish-smooth-copy', emoji: '✨', label: '문장이 자연스러우니 남극 유치원이라도 그대로 게시합니다.' },
        { id: 'reject-everything', emoji: '🗑️', label: 'AI 글은 틀릴 수 있으니 모두 버립니다.' },
        { id: 'mark-checkable-claims', emoji: '🖍️', label: '확인할 주장에 표시하고 학교 공식 공지 문서와 비교합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'trust-transcript', emoji: 'TEXT', label: '화면의 채소회 오이 글자를 그대로 믿습니다.' },
        { id: 'listen-again', emoji: 'REPLAY', label: '조용한 곳에서 원래 목소리를 다시 들려주거나 글자로 입력합니다.' },
        { id: 'choose-another-input', emoji: 'CHOICE', label: '마이크 거리와 입력 방법을 함께 비교합니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'blame-random', emoji: 'LUCK', label: 'AI의 기분이 나빠서 틀렸다고 생각합니다.' },
        { id: 'inspect-data', emoji: 'DATA', label: 'AI가 이전에 어떤 모양 자료를 배워 왔는지 학습 데이터를 조사합니다.' },
        { id: 'change-test-only', emoji: 'TEST', label: '세모 과자를 치우고 쉬운 동그라미 카드만 보여줍니다.' },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'share-fast-result', emoji: 'SEND', label: '빠르게 만들어졌으니 실로폰이 빠졌어도 그대로 공유합니다.' },
        { id: 'compare-key-facts', emoji: 'CHECK', label: '핵심 항목을 원문과 나란히 놓고 빠진 요소를 대조합니다.' },
  ...
  },
  {
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'use-all', emoji: 'USE', label: '아이미가 골랐으니 댄스 타임에 자장가를 그대로 틀어 줍니다.' },
        { id: 'review-items', emoji: 'CHECK', label: '자장가는 거절하고 신나는 댄스곡 조건으로 다시 요청해 결정합니다.' },
