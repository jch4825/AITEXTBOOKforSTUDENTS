...
export const M1_STUDIOS: StudioDefinition[] = [
    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미가 “다음 단어를 이어 붙인 거였어!” 하고 고백하자 윤아가 진짜 식단표로 바로잡았어요.',
            '아이미가 “헤헤, 실은 다음 단어를 이어 붙인 거였어!” 하고 고백하자, 윤아는 엉뚱한 대답 대신 진짜 식단표 내용을 적어 안내판을 바르게 완성했습니다.',
            '아이미가 다음 단어를 예측해 만든 문장임을 인정하자, 윤아는 AI의 자연스러운 엉뚱함과 객관적 사실을 분리해 진짜 식단표에 맞게 안내판을 수정했습니다.',
            'AI 대답을 무조건 믿지 않고 진짜 자료와 비교하면 바른 정보를 얻을 수 있어요.',
          ),
        },
      ],
      knowledge: [
      ...
      scenes: [
        {
          ...
          alt: '진우가 시끄러운 복도에서 학교 방송을 듣는 장면',
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우가 복도 방송을 들었어요.',
            '진우는 친구들 말소리가 큰 복도에서 체육대회 방송을 들었습니다.',
            '진우는 여러 소리가 겹치는 복도에서 체육대회 준비물 방송을 음성 인식 기능으로 기록했습니다.',
        ...
        },
        {
          ...
          alt: '진우가 조용한 곳과 가까운 거리에서 음성 인식을 다시 시험하는 장면',
          knowledgeStep: 1,
          copy: sceneCopy(
            '진우가 조용한 곳에서 다시 들었어요.',
            '진우는 소음, 마이크 거리, 말하는 속도를 하나씩 바꾸어 다시 시험했습니다.',
            '진우는 배경 소음, 마이크와의 거리, 말하는 속도를 한 번에 하나씩 바꾸고 변환 결과를 표에 기록했습니다.',
        ...
        },
        {
          ...
          alt: '진우가 음성, 글자, 그림 입력 방법 카드를 비교하는 장면',
          knowledgeStep: 2,
          copy: sceneCopy(
            '진우가 편한 입력 방법을 골랐어요.',
  ...
  },
  {
    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          label: '장면 2 · 네 답을 만든 아이미',
          imageSrc: '/lessons/story/m1/m1-l8-scene-02.webp',
          alt: '아이미가 친구 마음, 약, 학교 체험회, 상자 사진 요청에 각각 답을 만든 장면',
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미는 네 요청의 답 초안을 만들었어요. 하지만 바로 보내지 않고, “답을 만들 수 있는 일과 내가 결정해도 되는 일은 같을까?”를 살피는 점검 규칙을 켰어요.',
            '아이미는 친구 마음을 짐작하고, 약과 행사에 답하고, 상자 사진을 분류했습니다. 하지만 바로 답을 보내지 않고, 답을 만들 수 있는 일과 아이미에게 맡겨도 되는 결정을 가르는 점검 규칙을 실행했습니다.',
            '아이미는 네 요청에 답 초안을 생성한 뒤 판단 점검 규칙을 실행했습니다. 답 생성 능력이 사실을 보증하거나 건강·마음에 관한 최종 결정 권한을 주는 것은 아니기 때문입니다.',
            '답을 만들 수 있다는 것과 최종 결정을 맡아도 된다는 것은 달라요.',
          ),
        },
        {
          id: 'check-help-boundaries',
          label: '장면 3 · 네 답을 다시 점검하기',
          imageSrc: '/lessons/story/m1/m1-l8-scene-03.webp',
          alt: '아이미가 공식 근거, 위험, 최신 정보, 사람의 마음과 책임을 기준으로 답을 점검하는 장면',
          knowledgeStep: 1,
          copy: sceneCopy(
            '아이미는 점검 규칙에 따라 네 답을 다시 살펴봤어요. 공식 근거가 있는지, 잘못되면 위험한지, 최신 정보인지, 사람의 마음과 책임이 걸렸는지 확인했어요.',
            '아이미는 점검 규칙에 따라 공식 기록으로 확인할 수 있는지, 잘못된 답이 사람에게 피해를 주는지, 정보가 최신인지, 건강·마음·책임이 걸린 결정인지 차례로 확인했습니다.',
            '아이미의 판단 점검 규칙은 근거의 확인 가능성, 오류의 위험, 정보의 최신성, 사람의 건강·마음·책임에 미치는 영향을 살핍니다. 이 기준은 사실 확인, AI의 1차 판단, 사람의 최종 판단을 가르는 데 쓰입니다.',
            '근거, 위험, 최신 정보, 사람에게 미치는 영향을 살펴봐요.',
          ),
        },
        {
          id: 'route-to-right-helper',
          label: '장면 4 · 세 갈래로 역할 연결하기',
          imageSrc: '/lessons/story/m1/m1-l8-scene-04.webp',
          alt: '아이미가 요청을 AI 도움, 의료 전문가, 학교 공식 자료의 세 갈래로 연결한 장면',
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미는 세 갈래로 연결했어요. 행사 시간은 학교 자료로 확인하고, 상자 분류는 아이미가 먼저 한 뒤 사람이 다시 봐요. 약과 친구 마음은 사람이 결정해요.',
            '아이미는 체험회 시간을 학교 공식 자료에서 확인하게 했습니다. 상자 사진은 아이미가 먼저 분류하고 사람이 검토하게 했습니다. 약 복용은 보호자나 전문가가, 친구 마음은 친구와 직접 대화해 판단하게 했습니다.',
            '아이미는 체험회 시간을 공식 자료로 보내 사실을 확인하고, 상자 사진 분류는 AI의 1차 판단 뒤 사람이 검토하도록 연결했습니다. 약 복용과 친구 마음은 상황을 아는 사람과 전문가가 최종 판단하고 책임지도록 구분했습니다.',
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'fact-from-record', emoji: '📌', label: '공식 공지의 행사 시간과 상자에 표시된 무게는 근거로 확인하는 사실입니다.', isCorrect: true },
        { id: 'ai-first-pass', emoji: '🤖', label: '안내문의 핵심 고르기와 자료 분류는 AI가 먼저 판단하고 사람이 검토할 수 있습니다.', isCorrect: true },
        { id: 'human-final', emoji: '🧑', label: '약 복용, 친구와의 대화, 안전한 운반의 최종 결정은 사람이 합니다.', isCorrect: true },
        { id: 'ai-final-for-all', emoji: '⚠️', label: 'AI가 답할 수 있으면 사실 확인과 중요한 최종 결정도 모두 맡겨도 됩니다.', isCorrect: false },
      ],
      modes: [...STUDIO_EXPRESSION_MODES],
    ...
    transfer: {
      ...
      choices: [
        { id: 'forecast-fact', emoji: '📌', label: '공식 일기예보의 비 올 확률은 근거로 확인하는 사실입니다.', isCorrect: true },
        { id: 'ai-weather-suggestion', emoji: '🤖', label: '준비물과 대체 활동 추천은 AI의 1차 판단으로 받고 사람이 검토합니다.', isCorrect: true },
        { id: 'teacher-event-decision', emoji: '🧑‍🏫', label: '체험회 진행 여부는 안전과 현장 상황을 아는 사람이 최종 결정합니다.', isCorrect: true },
        { id: 'ai-cancels-event', emoji: '⚠️', label: 'AI가 비를 예상했으므로 AI가 체험회 취소를 최종 결정합니다.', isCorrect: false },
      ],
    },
