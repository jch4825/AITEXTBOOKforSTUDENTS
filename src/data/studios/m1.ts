      ...
      scenes: [
        {
          ...
          label: '장면 1 · 서로 다른 네 가지 카드',
          imageSrc: '/lessons/story/m1/m1-l8-scene-01.webp',
          alt: '친구 마음 약 행사 정보 상자에 관한 네 가지 카드가 놓인 장면',
          knowledgeStep: 0,
          copy: sceneCopy(
            '하트, 약, 행사, 상자 카드가 놓였어요.',
            '친구 마음, 약 먹기, 행사 시간, 상자 안전에 관한 네 카드가 한꺼번에 놓였습니다.',
            '학생들은 기록으로 확인할 정보, AI가 먼저 나누어 볼 일, 사람이 직접 결정할 일이 네 카드 안에 섞여 있다는 것을 발견했습니다.',
            '어떤 것은 사실이고, 어떤 것은 AI나 사람이 판단해야 하는 일이에요.',
          ),
        },
        {
          id: 'one-answer-for-all',
          label: '장면 2 · 모두 판단하려는 AI',
          imageSrc: '/lessons/story/m1/m1-l8-scene-02.webp',
          alt: '아이미가 친구 마음 약 행사 상자 카드에 모두 답하려는 장면',
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미가 네 카드에 모두 답했어요.',
            '아이미는 행사 시간뿐 아니라 약, 친구 마음, 상자 안전까지 모두 정하려 했습니다.',
            '아이미는 공식 기록으로 확인할 사실과, 낮은 위험의 1차 판단, 건강·마음·안전이 걸린 최종 결정을 구분하지 않고 모두 답으로 만들었습니다.',
            'AI가 답할 수 있어도 그 답이 사실이거나 맡겨도 되는 결정이라는 뜻은 아니에요.',
          ),
        },
        {
          id: 'check-help-boundaries',
          label: '장면 3 · 세 범주를 찾는 기준',
          imageSrc: '/lessons/story/m1/m1-l8-scene-03.webp',
          alt: '공식 근거 위험 최신성 사람의 마음 기준으로 카드를 살펴보는 장면',
          knowledgeStep: 1,
          copy: sceneCopy(
            '학생들이 네 가지 기준을 살펴봤어요.',
            '공식 근거, 답이 잘못되었을 때의 위험, 다시 고칠 수 있는지, 누가 책임지는지를 확인했습니다.',
            '학생들은 기록으로 참·거짓을 확인할 수 있는지, AI가 먼저 분류해도 피해가 작고 바로 고칠 수 있는지, 건강·안전·마음·책임이 걸린 결정인지를 차례로 살폈습니다.',
            '이 기준을 쓰면 사실 확인, AI의 1차 판단, 사람의 최종 판단을 구분할 수 있어요.',
          ),
        },
        {
          id: 'route-to-right-helper',
          label: '장면 4 · 알맞은 판단 주체',
          imageSrc: '/lessons/story/m1/m1-l8-scene-04.webp',
          alt: '사실 확인 AI의 1차 판단 사람의 최종 판단으로 역할을 나눈 장면',
          knowledgeStep: 2,
          copy: sceneCopy(
            '세 가지 역할로 나누었어요.',
            '행사 시간은 공식 자료로 확인하고, 안내문 요약은 AI가 먼저 돕고, 약과 친구 마음과 안전은 사람이 결정했습니다.',
            '학생들은 행사 시간과 표시된 무게를 사실로 확인하고, 분류·요약은 AI의 1차 판단으로 활용하며, 약 복용·친구와의 대화·상자 운반의 최종 결정은 사람이 맡도록 구분했습니다.',
