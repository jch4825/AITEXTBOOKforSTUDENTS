...
export const M1_STUDIOS: StudioDefinition[] = [
  ...
  },
  {
      ...
      scenes: [
        {
          ...
          alt: '준우가 시끄러운 복도에서 학교 방송을 듣는 장면',
          knowledgeStep: 0,
          copy: sceneCopy(
            '준우가 복도 방송을 들었어요.',
            '준우는 친구들 말소리가 큰 복도에서 체육대회 방송을 들었습니다.',
            '준우는 여러 소리가 겹치는 복도에서 체육대회 준비물 방송을 음성 인식 기능으로 기록했습니다.',
        ...
        },
        {
          ...
          alt: '준우가 조용한 곳과 가까운 거리에서 음성 인식을 다시 시험하는 장면',
          knowledgeStep: 1,
          copy: sceneCopy(
            '준우가 조용한 곳에서 다시 들었어요.',
            '준우는 소음, 마이크 거리, 말하는 속도를 하나씩 바꾸어 다시 시험했습니다.',
            '준우는 배경 소음, 마이크와의 거리, 말하는 속도를 한 번에 하나씩 바꾸고 변환 결과를 표에 기록했습니다.',
        ...
        },
        {
          ...
          alt: '준우가 음성, 글자, 그림 입력 방법 카드를 비교하는 장면',
          knowledgeStep: 2,
          copy: sceneCopy(
            '준우가 편한 입력 방법을 골랐어요.',
            '준우는 상황에 따라 말하기, 글자 입력, 그림 선택 중 편한 방법을 골랐습니다.',
            '준우는 정확성, 편안함, 주변 환경을 기준으로 음성, 키보드, 그림·AAC 입력 방법을 비교해 자신에게 맞는 방법을 정했습니다.',
    ...
    aiContribution: {
      ...
      question: '아이미의 제안 중 준우에게 맞는 방법은 무엇일까요?',
    },
    artifact: {
      kind: 'choice-board',
