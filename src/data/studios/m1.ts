...
export const M1_STUDIOS: StudioDefinition[] = [
  {
    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아가 웃으며 말했습니다. "AI는 사람처럼 생각하고 배워서 우리를 도와주는 기술이야!"',
            '윤아가 웃으며 설명했습니다. "진우야, 인공지능(AI)은 사람처럼 생각하고 학습하여 여러 문제를 도와주는 기술이라는 뜻이야! 번역도 하고, 음악도 추천하고, 사진도 찾아준대!"',
            '윤아가 미소를 지으며 설명했습니다. "진우야, 인공지능(AI)은 사람의 학습과 판단 능력을 컴퓨터로 구현하여, 번역, 음악 추천, 이미지 인식 같은 과제 해결을 도와주는 프로그램이야!"',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '진우는 무릎을 치며 반가워했습니다. "아하! AI가 사람처럼 생각하고 배워서 우리를 도와주는 똑똑한 기술이구나!"',
            '진우가 무릎을 팍 치며 고개를 끄덕였습니다. "아하! 인공지능이란 사람처럼 생각하고 학습하여 다양한 문제 해결을 도와주는 기술이었어!"',
      ...
      knowledge: [
        {
          title: 'AI(인공지능)의 뜻',
          core: 'AI(인공지능)는 사람처럼 생각하고 학습하여 여러 가지 문제 해결을 도와주는 기술이나 프로그램입니다.',
          detail: {
            full: '사람처럼 생각하고 배워서 번역, 음악 추천, 사진 찾기 같은 다양한 일을 도와줘요.',
            light: 'AI(인공지능)는 컴퓨터가 사람처럼 학습하고 판단하여, 사람이 필요한 번역·추천·분류 등 여러 과제 해결을 도와주는 프로그램입니다.',
            challenge: '인공지능(AI)은 사람의 지능적인 문제 해결 능력과 학습 과정을 본떠, 데이터 분석과 예측으로 다양한 작업과 의사결정을 지원하는 기술을 뜻합니다.',
          },
        },
        {
          title: 'AI가 할 수 있는 일',
    ...
    encounter: {
      title: '아이미의 어려운 자기소개',
      description: '로봇 아이미가 어려운 기술 용어로 인사했습니다. 윤아와 함께 AI(인공지능)가 사람처럼 생각하고 학습하여 문제 해결을 돕는 기술임을 알고, 번역·추천·분류처럼 AI가 할 수 있는 일을 찾아봅시다.',
      facts: [
        'AI(인공지능)는 사람처럼 생각하고 학습하여 문제 해결을 돕는 기술입니다.',
    ...
    firstAttempt: {
      ...
      choices: [
        { id: 'tool-with-input', emoji: '🛠️', label: '사람처럼 생각하고 학습하여 번역, 추천, 분류 등 여러 일을 도와주는 기술이라고 소개합니다.' },
