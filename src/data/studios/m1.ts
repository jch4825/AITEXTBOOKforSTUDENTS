...
export const M1_STUDIOS: StudioDefinition[] = [
  {
    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아가 웃으며 말했습니다. "AI는 사람이 만든 똑똑한 도구야!"',
            '윤아가 웃으며 설명했습니다. "진우야, 인공지능(AI)은 사람이 만든 똑똑한 도구라는 뜻이야! 번역도 하고, 음악도 추천하고, 사진도 찾아준대!"',
            '윤아가 미소를 지으며 설명했습니다. "진우야, 인공지능(AI)은 사람이 명확한 목적을 가지고 개발한 지능형 도구라는 의미야! 외국어 번역과 음악 추천, 이미지 인식 같은 기능을 수행하거든."',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '진우는 무릎을 치며 반가워했습니다. "아하! AI가 사람이 만든 똑똑한 도움 도구라는 뜻이구나!"',
            '진우가 무릎을 팍 치며 고개를 끄덕였습니다. "아하! 인공지능이란 사람이 목적을 위해 만든 똑똑한 기술 도구를 뜻하는 거였어!"',
      ...
      knowledge: [
        {
          ...
          detail: {
            full: '사람이 무엇을 도와줄지 정해 만든 똑똑한 도구예요.',
            light: 'AI(인공지능)가 스스로 목적을 정하는 것이 아니라 사람이 목적과 사용 방법을 정합니다.',
    ...
    encounter: {
      title: '아이미의 자기소개',
      description: '아이미가 자신을 인공지능(AI)이라고 소개했습니다. 진우는 AI의 뜻과 할 수 있는 일을 알아보고 쉬운 설명을 만듭니다.',
      facts: [
        'AI(인공지능)는 사람이 만든 똑똑한 도구입니다.',
        'AI는 말, 글, 사진 같은 입력을 받아 일을 처리할 수 있습니다.',
        'AI는 번역, 추천, 분류 같은 다양한 결과를 만들어 도와줍니다.',
      ],
    },
    firstAttempt: {
      prompt: '아이미를 처음 만난 친구에게 AI(인공지능)를 어떻게 소개하겠습니까?',
      choices: [
        { id: 'tool-with-input', emoji: 'TOOL', label: '사람이 만든 똑똑한 도구이며 번역, 추천, 분류 등 여러 일을 할 수 있다고 소개합니다.' },
    ...
    transfer: {
      ...
      choices: [
        { id: 'describe-input-output', emoji: 'MAP', label: '질문을 입력받아 관련 책을 찾아 추천하는 인공지능(AI) 기능이라고 소개합니다.' },
