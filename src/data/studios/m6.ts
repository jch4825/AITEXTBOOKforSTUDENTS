    ...
    visualNovel: {
      ...
      scenes: [
        ...
        },
        {
          ...
          alt: '몸 그림 느낌 시작 시점 도움 필요 카드와 그림 카드 선택지가 놓인 장면을 위한 빈 이미지 자리',
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우는 몸 그림에서 배를 가리키고 “쥐어짜는 느낌”, “조금 전부터”, “앉고 도움받고 싶어요” 카드를 골랐습니다.',
            '몸 위치와 느낌, 시작 시간을 카드로 골랐어요.',
            '말, 그림 카드는 같은 가치의 건강 의사소통 수단이며 학생이 가장 빠르고 편한 방식을 선택합니다.',
          ),
        },
        {
  ...
  },
  {
      ...
      scenes: [
        {
          ...
          alt: '윤아가 가게 연습 장면에서 물건 위치를 말 글 그림 카드 중 하나로 묻는 장면을 위한 빈 이미지 자리',
          knowledgeStep: 0,
          copy: sceneCopy(
            '가게 연습에서 윤아는 필요한 물건을 찾지 못했습니다. 말, 글 카드, 그림 카드 가운데 편한 방법을 골라 위치를 물었습니다.',
            '편한 방법으로 물건 위치를 물었어요.',
            '의사소통 목표와 표현 양식은 분리할 수 있습니다. 말, 글, 그림 카드는 모두 유효한 요청 수단입니다.',
          ),
        },
        {
        ...
        },
        {
          ...
          alt: '정류장 안내가 어려워 학생이 천천히 다시 말해 달라는 그림 카드를 사용하는 장면을 위한 빈 이미지 자리',
          knowledgeStep: 2,
          copy: sceneCopy(
            '정류장 연습에서는 안내가 너무 빨랐습니다. 진우는 “천천히 다시 말해 주세요” 그림 카드를 보여주고 이해한 내용을 확인했습니다.',
    ...
    firstAttempt: {
      ...
      choices: [
        ...
        { id: 'use-own-expression', emoji: '💬', label: '말·글·그림 카드 중 편한 방법으로 도움·거절·재설명을 표현해요.' },
