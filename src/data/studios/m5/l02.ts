      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 부스를 맡게 됐어요. 진우: "`부스를 설치해`… 이 한마디가 이렇게 클 줄이야."',
            '체험회 부스를 맡게 됐습니다. 진우: "`부스를 설치해`… 이 한마디가 이렇게 클 줄이야. 어디서 시작하지?"',
            '체험회 부스를 맡게 됐습니다. 진우: "`부스를 설치해`… 이 한마디가 이렇게 클 줄이야. 어디서 시작하지?" 큰 목표 앞에서 막막했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '윤아: "완성된 모습부터 보자." 안내판, 책상, 전원, 자료 배치가 보였어요.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "목록 완성! …어? 왜 안내판이 두 번 있죠? 전원 확인은 없네요?"',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "이 목록, 그대로 쓸 순 없겠어. 무엇을 빼고 무엇을 더할까?"',
