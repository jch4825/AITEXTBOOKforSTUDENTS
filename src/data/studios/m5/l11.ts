      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 하루 전, 간식 계획을 세웠어요. 진우: "내일이다! 계획도 완벽해!"',
            '체험회 하루 전, 그림 카드로 간식 계획을 세웠습니다. 진우: "내일이다! 간식 계획도 완벽해!"',
            '체험회 하루 전, 그림 카드로 간식 계획을 세웠습니다. 실제 조리는 아니었습니다. 진우: "내일이다! 간식 계획도 완벽해!"',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '윤아: "필요한 도구가 없어. 그리고 알레르기 확인을 아직 안 했어."',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '진우: "여기까지 왔는데 멈춰야 해?" 아이미: "알레르기가 없다고 추정해 드릴 수는 없어요. 어른이 확인해야 해요."',
