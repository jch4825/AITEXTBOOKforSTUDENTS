      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 준비 중에 요청이 몰렸어요. 아이미: "전원선 정리, 포스터 수정, 간식 배치!"',
            '체험회 준비 중에 요청이 한꺼번에 몰렸습니다. 아이미: "요청 셋 도착! 전원선 정리, 포스터 수정, 간식 배치!" 진우: "동시에?!"',
            '체험회 준비 중에 세 가지 일이 한꺼번에 몰려왔습니다. 아이미: "전원선 정리, 포스터 수정, 간식 배치!" 진우: "동시에?!"',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '진우: "난 포스터가 제일 자신 있는데… 어? 통로에 전원선이 있으면 걸리지 않을까?"',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '전원선에는 안전 배지, 포스터에는 마감 배지, 간식에는 도움 배지를 붙였어요.',
