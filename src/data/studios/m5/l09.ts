      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우: "프린터가… 안 돼. 내일모레가 체험회인데 안내문을 못 뽑아!"',
            '진우: "프린터가… 안 돼. 내일모레가 체험회인데 안내문을 못 뽑아!" 처음 방법만 붙잡으면 시간 안에 준비하기 어려웠습니다.',
            '진우: "프린터가… 안 돼. 내일모레가 체험회인데 안내문을 못 뽑아!" 처음 방법만 붙잡으면 시간 안에 준비하기 어려웠습니다. D-2의 긴장감이었습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '윤아: "목표는 \'출력\'이 아니라 \'안내\'야. 안내할 다른 길이 뭐가 있을까?"',
