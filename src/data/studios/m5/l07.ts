      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '아이미: "연결하고, 전원 켜고, 화면 고르고, 소리 확인하세요! 이상입니다!"',
            '아이미: "연결하고, 전원 켜고, 화면 고르고, 소리 확인하세요! 이상입니다!" 윤아: "잠깐잠깐. 두 번째까지는 기억나는데… 그다음이 뭐였지?"',
            '아이미: "연결하고, 전원 켜고, 화면 고르고, 소리 확인하세요! 이상입니다!" 윤아: "잠깐잠깐. 두 번째까지는 기억나는데… 그다음이 뭐였지?" 한꺼번에 들으니 중간이 헷갈렸습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아: "행동마다 짝을 붙이자. \'전원 누르기\'의 짝은 \'초록 표시 확인\'." 실제 기기 대신 모의 설치판을 사용했습니다. 행동과 확인의 짝을 찾은 순간이었습니다.',
