      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 하루 전, 안내 화면을 점검했어요. 진우: "눌렀는데 처음 메뉴로 돌아왔대!"',
            '체험회 하루 전, 안내 화면을 점검했습니다. 진우: "안내 카드대로 눌렀는데 처음 메뉴로 돌아왔대. 내일이 행사인데!"',
            '체험회 하루 전, 안내 화면을 점검했습니다. 진우: "안내 카드대로 눌렀는데 처음 메뉴로 돌아왔대!" 방문객 탓으로 돌리지 않기로 했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '윤아: "처음 상태로 돌려서 카드 순서 그대로 다시 눌러 보자." 세 번째 단추에서 또 그랬어요.',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '정상 경로 카드와 비교했어요. 세 번째와 네 번째 단추 순서가 바뀌어 있었어요.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "오류 위치를 찾았어요. 어떻게 고치고 무엇으로 확인하시겠어요?"',
