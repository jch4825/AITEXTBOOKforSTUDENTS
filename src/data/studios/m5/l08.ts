      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 안내문을 아이미에게 맡겼어요. 아이미: "완성! 제목도 장소도 넣었어요!"',
            '체험회 안내문을 아이미에게 맡겼습니다. 아이미: "안내문 완성! 제목도 장소도 멋지게 넣었어요!" 진우: "오, 바로 붙이자!"',
            '체험회 안내문을 아이미에게 맡겼습니다. 아이미: "안내문 완성! 제목도 장소도 멋지게 넣었어요!" 진우: "진짜 멋있다. 바로 붙이자!"',
        ...
        },
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '윤아: "처음에 뭘 부탁했더라?" 제목, 장소, 10시 시작 세 조건이 있었어요.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '진우: "아이미한테 완성 맞냐고 물어볼까?" 윤아: "아니, 조건표에 대고 우리가 직접 표시하자."',
            '진우: "아이미한테 완성 맞냐고 물어볼까?" 윤아: "아니, 조건표에 대고 직접 표시하자. 다른 도구로 한 번 더 확인하는 거야."',
