      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 포스터를 배치하던 중이에요. 진우: "이 글자가 잘 안 보여. 막혔다."',
            '체험회 포스터를 배치하던 중이었습니다. 진우: "내 방법으로 먼저 놓아 봤어. …그런데 이 글자가 잘 안 보여. 막혔다."',
            '체험회 포스터를 배치하던 중이었습니다. 제목과 그림은 자리를 잡았습니다. 진우: "내 방법으로 놓아 봤는데 이 글자가 잘 안 보여. 막혔다."',
        ...
        },
        {
          ...
          knowledgeStep: 1,
          copy: sceneCopy(
            '아이미: "도움에는 크기가 있어요. 작은 단서, 질문, 부분 예시, 완성 답 중 어느 것부터요?"',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아: "완성 답을 보면 빨라. 대신 네 첫 생각이 어디서 바뀌었는지는 몰라." 도움의 크기마다 남는 몫이 달랐습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "당신 차례예요. 지금 막힌 곳에는 어느 크기의 도움이 필요한가요?"',
