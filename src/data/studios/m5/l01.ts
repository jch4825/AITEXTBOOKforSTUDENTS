      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '체험회 전날, 설치 공간이 텅 비었어요. 진우: "책상도 안내판도 안 왔어!"',
            '체험회 전날, 설치 공간은 텅 비어 있었습니다. 진우: "…없어. 책상도 안내판도 안 왔어. 행사를 못 해!"',
            '체험회 전날, 설치 공간은 텅 비어 있었습니다. 진우: "…없어. 책상도 안내판도 안 왔어. 행사를 못 해!" 막막함이 앞섰습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아: "잠깐. \'못 해\'가 아니라 — 지금 뭐가 있고, 언제까지 뭐가 필요한 거야?" 막막함이 쪼개지기 시작했습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "제가 아는 것은 오후 3시 설치. 모르는 것은 배송 시간. 이건 사람이 확인해야 해요."',
