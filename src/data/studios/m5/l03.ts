      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '모의 설치판에서 부스를 꾸며 봤어요. 진우: "장식 완료! …어? 전원선 자리가 없어."',
            '모의 설치판에서 부스를 꾸며 보았습니다. 진우: "예쁜 것부터! 장식 완료! …어? 전원선 놓을 자리가 없어."',
            '모의 설치판에서 부스를 꾸며 보았습니다. 실제 전기는 다루지 않았습니다. 진우: "장식 완료! …어? 전원선 놓을 자리가 없어."',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아: "순서를 외우지 말고 이유를 찾자. 책상은 왜 장식보다 먼저야?" 전원 확인 뒤 책상, 책상 뒤 장식. 장식과 자료는 순서를 바꿔도 됐습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '아이미: "제 추천대로 하면 책상을 너무 일찍 고정해서 안전 확인이 어렵네요."',
            '아이미: "제 추천대로 하면… 어라, 책상을 너무 일찍 고정해서 안전 확인이 어렵네요. 제 추천이 틀릴 수도 있군요!"',
            '아이미: "제 추천대로 하면 책상을 너무 일찍 고정해서 안전 확인이 어렵네요. 제 추천이 틀릴 수도 있군요!" 모의 실행이 문제를 드러냈습니다.',
