      ...
      scenes: [
        {
          ...
          copy: sceneBeats(
            [
              [
                '체험회 당일 아침입니다. 진우는 자기 부스를 찾아가야 합니다.',
                '체험회 당일 아침입니다. 진우는 자기가 맡은 부스를 찾아가야 합니다. 길을 몰랐습니다.',
                '체험회 당일 아침입니다. 진우는 자기가 맡은 부스를 찾아가야 합니다. 그런데 길을 몰랐습니다.',
              ],
              [
                '진우: "아이미야, 도서관 앞 부스 알려 줘!" 아이미: "안내 완료!"',
                '진우가 아이미에게 물었습니다. 진우: "아이미야, 도서관 앞 부스 알려 줘!" 아이미: "안내 완료!"',
                '진우가 아이미에게 길을 물었습니다. 진우: "아이미야, 도서관 앞 부스 알려 줘!" 아이미: "안내 완료!"',
              ],
              [
                '아이미: "마을 도서관까지 15분입니다!" 진우: "…우리 학교 도서관인데?"',
                '아이미: "마을 도서관까지 걸어서 15분입니다!" 진우: "…우리 학교 도서관인데?" 완전히 다른 곳이었습니다.',
                '아이미: "마을 도서관까지 걸어서 15분입니다!" 진우: "…우리 학교 도서관인데?" 완전히 다른 장소였습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '진우: "내가 말을 잘못했나…" 진우는 자기 탓을 하려 했습니다.',
                '진우: "내가 말을 잘못했나…" 진우는 또 자기 탓을 하려 했습니다. 윤아가 고개를 저었습니다.',
                '진우: "내가 말을 잘못했나…" 진우는 또 자기 탓을 하려 했습니다. 그러자 윤아가 고개를 저었습니다.',
              ],
              [
                '윤아: "요청에 \'어느 건물\'이 없었을 뿐이야."',
                '윤아: "네 탓도 아이미 탓도 아니야. 요청에 \'어느 건물\'인지가 없었을 뿐이야."',
                '윤아: "네 탓도 아이미 탓도 아니야. 요청에 \'어느 건물\'인지가 들어 있지 않았을 뿐이야."',
              ],
              [
                '아이미는 가까운 공공 도서관을 추정했습니다. 진짜 목표는 학교 안이었습니다.',
                '아이미는 가장 가까운 공공 도서관을 추정한 것입니다. 진짜 목표는 학교 안 2층이었습니다.',
                '아이미는 가장 가까운 공공 도서관을 추정했던 것입니다. 진짜 목표는 학교 건물 안 2층이었습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '아이미: "학교 이름을 알려 주시면 정확해질 텐데요."',
                '아이미가 방법을 제안했습니다. 아이미: "학교 이름을 알려 주시면 정확해질 텐데요."',
                '아이미가 해결 방법을 제안했습니다. 아이미: "학교 이름을 알려 주시면 정확해질 텐데요."',
              ],
              [
                '윤아: "잠깐, 이름 없이도 돼." 학교 이름은 내 위치를 알려 줍니다.',
                '윤아: "잠깐, 이름 없이도 돼." 학교 이름은 내가 어디 있는지 알려 주는 정보이기도 합니다.',
                '윤아: "잠깐, 학교 이름 없이도 돼." 학교 이름은 내가 어디 있는지 알려 주는 정보이기도 합니다.',
              ],
              [
                '윤아: "\'지금 건물 안, 2층, 초록 표지 앞\' — 이 정도면?"',
                '윤아: "\'지금 건물 안, 2층, 초록 표지 앞\' — 이 정도면?" 필요한 단서만 남았습니다.',
                '윤아: "\'지금 건물 안, 2층, 초록 표지 앞\' — 이 정도면 어때?" 필요한 단서만 남았습니다.',
              ],
            ],
        ...
        },
        {
          ...
          copy: sceneBeats(
            [
              [
                '두 가지를 알았습니다. 빠진 단서와 넣지 않아도 될 정보입니다.',
                '이제 두 가지를 알게 되었습니다. 요청에 빠져 있던 단서와, 넣지 않아도 될 정보입니다.',
                '이제 두 가지를 알게 되었습니다. 요청에 빠져 있던 단서와, 굳이 넣지 않아도 될 정보입니다.',
              ],
              [
                '체험회는 곧 시작됩니다. 다시 물어볼 시간은 한 번뿐입니다.',
                '체험회는 곧 시작됩니다. 길에서 헤맬 시간이 없어 다시 물을 기회는 한 번뿐입니다.',
                '체험회는 곧 시작됩니다. 길에서 헤맬 시간이 없어 다시 물어볼 기회는 한 번뿐이었습니다.',
              ],
              [
