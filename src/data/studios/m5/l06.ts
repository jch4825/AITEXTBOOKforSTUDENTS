      ...
      scenes: [
        {
          ...
          knowledgeStep: 0,
          copy: sceneCopy(
            '진우: "도서관 앞 부스 알려 줘!" 아이미: "마을 도서관까지 걸어서 15분입니다!"',
            '진우: "도서관 앞 부스 알려 줘!" 아이미: "안내 완료! 마을 도서관까지 걸어서 15분입니다!" 진우: "…우리 학교 도서관인데?"',
            '진우: "도서관 앞 부스 알려 줘!" 아이미: "안내 완료! 마을 도서관까지 걸어서 15분입니다!" 진우: "…우리 학교 도서관인데?" 전혀 다른 장소였습니다.',
        ...
        },
        {
          ...
          copy: sceneCopy(
            ...
            '윤아: "네 탓도 아이미 탓도 아니야. 요청에 \'어느 건물\'이 없었을 뿐이야." 아이미는 가장 가까운 공공 도서관을 추정했습니다. 학교 안 2층 초록 표지 앞이 진짜 목표였습니다.',
        ...
        },
        {
          ...
          knowledgeStep: 2,
          copy: sceneCopy(
            '윤아: "잠깐, 이름 없이도 돼. \'지금 건물 안, 2층, 초록 표지 앞\' — 이 정도면?"',
