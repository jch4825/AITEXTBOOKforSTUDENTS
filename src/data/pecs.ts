...
export const PECS_LABELS: Record<string, string> = {
  ...
  example_request: '예시를 보여줍니다', role_setting: '역할을 정합니다', split_steps: '작게 나눕니다',
  ...
  random_choice: '아무거나 고릅니다', long_time: '오래 걸립니다',
  tidy_room: '자동 정리 로봇',
  electric_fan: '선풍기',
  automatic_door: '자동문',
  music_app: '음악 추천 앱',
...
// 모듈별 관련 단어 (수업 개편 반영 — 각 모듈에 등장하는 핵심 명사/개념만 노출)
