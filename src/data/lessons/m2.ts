...
export const M2_LESSONS: LessonContent[] = [
  // ─────────────────────────── l1 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '잘 물어봐야 잘 답해줘',
    objective: '프롬프트에 들어갈 세 가지 요소를 알아봐요.',
    standards: [
  ...
  // ─────────────────────────── l2 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '짧게 물어보기',
    objective: '여러 부탁을 한 문장씩 나누어 물어봐요.',
  ...
  // ─────────────────────────── l4 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '예시를 하나 보여줘요',
    objective: '원하는 답 모양을 예시로 보여주며 부탁해 봐요.',
    standards: ['[6국어01-04] 묻는 말의 의미를 이해하여 적절한 질문과 대답을 한다.'],
  ...
  // ─────────────────────────── l5 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '역할을 정해줘요',
    objective: 'AI에게 역할을 주고 원하는 말투로 답을 들어 봐요.',
  ...
  // ─────────────────────────── l6 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '단계를 나눠 물어보기',
    objective: '큰 질문을 작은 단계로 쪼개서 하나씩 물어봐요.',
    standards: [
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            ...
            {
              title: '4장: 예고: 첫 생각 저장',
              goal: 'AI 답이 마음과 다를 때 처음 생각한 방법을 기록해 보세요.',
  ...
  // ─────────────────────────── l7 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '다시 물어봐도 돼요',
    objective: 'AI의 답을 확인하고 부족한 부분을 다시 부탁해 봐요.',
    standards: ['[9국어01-04] 대화 예절을 지키며 상대방의 말에 적절한 질문과 대답으로 대화를 이어 간다.'],
  ...
  // ─────────────────────────── l8 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '답을 짧게 해달라고 부탁',
    objective: '"세 줄로", "표로"처럼 형식을 정해 부탁해 봐요.',
    standards: ['[6국어01-04] 묻는 말의 의미를 이해하여 적절한 질문과 대답을 한다.'],
  ...
  // ─────────────────────────── l9 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '답이 이상하면?',
    objective: 'AI 답이 이상하면 "진짜야?" 하고 되물어 봐요.',
  ...
  // ─────────────────────────── l10 ───────────────────────────
  {
    ...
    kind: 'experience',
    title: '진짜 AI랑 놀아보기',
    objective: '배운 방법대로 프롬프트를 만들어 AI와 대화해 봐요.',
    standards: [
      '[9정통01-04] 필요한 정보를 수집하고, 타인과 정보를 주고받는다.',
  ...
  // ─────────────────────────── l11 ───────────────────────────
  {
    ...
    kind: 'activity',
    title: '다 배웠어요! (마무리 퀴즈)',
    objective: '단원 2에서 배운 좋은 질문 방법들을 다시 알아봐요.',
    standards: ['[6국어01-04] 묻는 말의 의미를 이해하여 적절한 질문과 대답을 한다.'],
        ...
        data: {
          ...
          chapters: [
            ...
            },
            {
              ...
              goal: '첫 생각과 달라진 조건을 비교하고, 다시 부탁하는 방법을 만들어 보세요.',
