...
export const M5_LESSONS: LessonContent[] = [
  ...
  // ─────────────────────────── l12 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '나는 문제 해결사! (마무리)',
    objective: '모듈 5에서 배운 문제 해결 단계를 정리하여 말할 수 있다.',
    standards: ['[12정통02-03] 생활 속 다양한 문제 해결 상황을 인식하고, 문제 해결 절차를 구성한다.'],
    bodyEasy: '배운 문제 해결 방법을 확인해봐요.',
    bodyNormal:
      '모듈 5에서 배운 것 — 알아차리기, 작게 나누기, 순서 세우기, 힌트 받기, 확인하기 — 를 정리해봐요.',
    wrapUpEasy: '모듈 5를 다 배웠어요! 나는 문제 해결사예요.',
    wrapUpNormal: '모듈 5를 마쳤어요! 문제를 알아차리고, 작게 나누고, 순서대로 하고, 확인하는 힘이 생겼어요.',
    steps: [
      { kind: 'text', data: {} },
      {
        kind: 'sequence',
