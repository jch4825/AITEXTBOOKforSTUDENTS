...
export const M4_LESSONS: LessonContent[] = [
  ...
  // ─────────────────────────── l11 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '우리의 안전 약속 (마무리)',
    objective: '모듈 4에서 배운 안전 수칙을 정리하여 말할 수 있다.',
    standards: ['[12정통03-01] 디지털 윤리를 이해하고, 디지털 공간에서 타인을 존중하고 배려하는 태도를 기른다.'],
    bodyEasy: '배운 안전 약속을 확인해봐요.',
    bodyNormal:
      '모듈 4에서 배운 안전 약속 — 확인하기, 개인정보 지키기, 고운 말, 시간 지키기, 어른에게 알리기 — 를 확인해봐요.',
    wrapUpEasy: '모듈 4를 다 배웠어요! 안전 약속을 지켜요.',
    wrapUpNormal: '모듈 4를 마쳤어요! 확인하기, 개인정보 지키기, 고운 말 쓰기, 시간 지키기, 어른에게 알리기 — 다섯 가지 안전 약속을 기억해요.',
    steps: [
      { kind: 'text', data: {} },
      {
        kind: 'matching',
