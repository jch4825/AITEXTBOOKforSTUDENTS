...
export const M1_LESSONS: LessonContent[] = [
  {
    ...
    bodyEasy: 'AI(인공지능)는 사람처럼 생각하고 배워서 여러 가지 일을 도와주는 기술이에요. 말, 글, 사진을 받아 번역, 추천, 분류처럼 필요한 결과를 만들어 줘요.',
    bodyNormal: 'AI(인공지능)는 컴퓨터가 사람처럼 학습하고 판단하여 다양한 문제 해결을 돕는 기술입니다. 말, 글, 사진 같은 입력을 받아 번역, 음악 추천, 사진 속 동물 찾기처럼 할 수 있는 일을 수행하여 결과를 만듭니다.',
