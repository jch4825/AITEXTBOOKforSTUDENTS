...
export const M1_LESSONS: LessonContent[] = [
  ...
  },
  {
    ...
    standards: [AI_STANDARD],
    bodyEasy: '버튼 누르기, 센서로 알아채기, 사용 기록 기억하기처럼 기계가 움직이는 여러 가지 방법을 살펴봐요.',
    bodyNormal: '자동으로 움직이는 기계가 모두 인공지능인 것은 아닙니다. 버튼 누르기, 센서로 알아채기, 이전 사용 기록 기억하기처럼 기계가 받아들이는 정보와 작동하는 방법을 꼼꼼히 살펴보아야 합니다.',
    wrapUpEasy: '기계가 어떤 정보를 받아 어떻게 움직이는지 살펴보면 인공지능 기능을 쉽게 찾을 수 있어요.',
    wrapUpNormal: '기계의 겉모습이나 이름만 보지 않고, 들어오는 정보(입력)와 나오는 동작(결과)을 살펴보면 단순 자동 기능과 인공지능 기능을 바르게 구별할 수 있습니다.',
    steps: [
  ...
  },
  {
    ...
    standards: [AI_STANDARD],
    bodyEasy: '인공지능은 잘 모르는 내용도 다음에 올 낱말을 그럴듯하게 이어 붙여 대답해요. 엉뚱한 대답도 자신 있게 말할 수 있으니 진짜 사실인지 꼭 확인해야 해요.',
    bodyNormal: '생성형 인공지능은 배운 글의 흐름을 바탕으로 다음에 올 낱말을 하나씩 이어 붙여 답을 만듭니다. 사실이 아닌 내용도 자신감 넘치는 말투로 그럴듯하게 꾸며낼 수 있으므로, 진짜 식단표나 공식 안내문과 비교하여 사실 여부를 꼭 확인해야 합니다.',
    wrapUpEasy: '인공지능이 자신 있게 말해도 엉뚱한 거짓말일 수 있어요. 원래 식단표나 공식 안내문에서 사실을 꼭 확인해요.',
    wrapUpNormal: '생성형 인공지능은 다음 낱말을 확률로 이어 대답하므로, 그럴듯하지만 사실이 아닌 엉뚱한 대답을 진짜 사실과 구분하여 꼼꼼히 확인해야 합니다.',
    steps: [
  ...
  },
  {
    ...
    standards: [AI_STANDARD],
    bodyEasy: '소리를 알아듣는 인공지능은 말소리를 듣고 글자로 바꾸어 주어요. 주변이 시끄럽거나 마이크가 멀면 엉뚱한 글자로 적을 수 있어요.',
    bodyNormal: '음성 인식은 사람이 말하는 소리를 듣고 글자로 바꾸어 주는 기능입니다. 주변 소음이나 마이크와의 거리, 말소리의 크기에 따라 같은 말도 다르게 알아들을 수 있습니다.',
    wrapUpEasy: '말을 잘 알아듣지 못할 때는 조용한 곳에서 다시 말하거나, 글자나 그림 카드로 내 생각을 전할 수 있어요.',
    wrapUpNormal: '인공지능이 말을 잘못 알아들을 때는 말한 사람을 탓하지 않고, 주변 소음과 마이크 상태를 살피며 글자나 그림 같은 다른 방법을 함께 사용합니다.',
    steps: [
  ...
  },
  {
    ...
    standards: [AI_STANDARD],
    bodyEasy: '인공지능은 많은 자료를 보고 공부하여 규칙을 배워요. 한 가지 자료만 공부하면 다른 모양을 보았을 때 틀리기 쉬워요.',
    bodyNormal: '인공지능은 사람이 모아 준 배움 자료에서 공통된 특징을 찾아냅니다. 배운 자료의 수가 적거나 한쪽으로 치우쳐 있으면 새로운 물건이나 상황을 만났을 때 잘못된 답을 낼 수 있습니다.',
    wrapUpEasy: '여러 가지 모양과 색깔의 자료를 골고루 가르쳐 주면 인공지능이 더 정확하게 알아볼 수 있어요.',
    wrapUpNormal: '배운 자료가 얼마나 많은지, 다양한 모양과 색깔이 골고루 섞였는지에 따라 인공지능의 결과가 크게 달라집니다. 따라서 자료가 한쪽으로 치우치지 않았는지 사람이 꼼꼼하게 검토해야 합니다.',
    steps: [
  ...
  },
  {
    ...
    standards: [AI_STANDARD],
    bodyEasy: '인공지능은 긴 글을 짧게 요약하거나 다른 나라 말로 빠르게 바꾸어 줄 수 있어요. 하지만 중요한 내용이 빠지지 않았는지 사람이 꼭 확인해야 해요.',
    bodyNormal: '인공지능은 긴 글을 요약하거나 번역하는 일을 아주 빠르게 도와줍니다. 하지만 빠르게 만들었다고 해서 내용이 모두 정확한 것은 아니므로, 원래 글과 꼼꼼히 비교하여 빠진 내용이 없는지 살펴보아야 합니다.',
    wrapUpEasy: '인공지능이 빠르게 만든 결과도 원래 글과 나란히 놓고 꼼꼼히 확인해요.',
    wrapUpNormal: '인공지능이 만든 요약이나 번역 글은 원래 글에 적힌 날짜, 시간, 장소, 준비물 같은 중요한 내용과 꼼꼼히 비교한 뒤에 사용해야 합니다.',
    steps: [
  ...
  },
  {
    ...
    standards: [AI_STANDARD],
    bodyEasy: '사실은 근거로 확인해요. AI가 먼저 나눈 결과는 사람이 다시 보고, 건강·안전·마음처럼 중요한 결정은 사람이 해요.',
    bodyNormal: '사실 확인은 기록과 공식 자료로 참·거짓을 살피는 일입니다. 분류·요약·추천처럼 실수해도 위험이 적은 일은 AI의 1차 판단을 활용할 수 있지만 사람이 결과를 검토합니다. 건강·안전·마음·권리와 책임이 걸린 최종 판단은 상황을 아는 사람이 직접 합니다.',
    wrapUpEasy: '사실은 확인하고, AI 판단은 다시 보고, 중요한 결정은 사람이 해요.',
    wrapUpNormal: '사실은 근거로 확인하고, AI의 판단은 사람이 검토하며, 중요한 최종 결정은 사람이 책임집니다.',
    steps: [
      { kind: 'text', data: { dictionaryTerms: ['사실', '판단', '근거'], imagePlaceholder: true } },
      {
        kind: 'card-pick',
        data: {
          question: '“학교 공식 게시판에 체험회는 오후 2시라고 적혀 있다”는 무엇인가요?',
          choices: [
            { label: '근거로 확인하는 사실', isCorrect: true, icon: 'book' },
            { label: 'AI가 최종 결정할 일', isCorrect: false, icon: 'chatbot' },
            { label: '사람의 마음에 따라 달라지는 판단', isCorrect: false, icon: 'angry_face' },
          ],
        },
      },
      {
        ...
        data: {
          title: '사실과 판단 구분표',
          intro: '각 사례를 사실 확인, AI의 1차 판단, 사람의 최종 판단으로 나눠요.',
          chapters: [
            {
              title: '1장 세 범주로 구분하기',
              goal: '여섯 가지 사례를 세 범주로 나눠요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'm1_l8_judgment_map',
                  prompt: '각 내용을 어떤 범주에 놓아야 할까요?',
                  bins: [
                    { label: '사실 확인', emoji: '📌' },
                    { label: 'AI의 1차 판단', emoji: '🤖' },
                    { label: '사람의 최종 판단', emoji: '🧑' },
                  ],
                  cards: [
                    { label: '공식 공지에 적힌 행사 시간', emoji: '1', bin: 0 },
                    { label: '상자에 표시된 무게 8kg', emoji: '2', bin: 0 },
                    { label: '긴 안내문에서 핵심 문장 고르기', emoji: '3', bin: 1 },
                    { label: '사진 속 상자를 크기별로 분류하기', emoji: '4', bin: 1 },
                    { label: '지금 이 약을 먹을지 결정하기', emoji: '5', bin: 2 },
                    { label: '속상한 친구를 어떻게 도울지 결정하기', emoji: '6', bin: 2 },
                  ],
                },
                {
                  kind: 'branch-chat',
                  id: 'm1_l8_reason',
                  intro: '약병에는 “하루 두 번”이라고 적혀 있어요. 이 문장과 실제 복용 결정을 구분해요.',
                  turns: [
                    {
                      aimi: '약병에 적힌 문장을 읽었으니 이 학생이 지금 약을 먹어도 된다고 제가 결정해도 될까요?',
                      choices: [
                        { label: '표시된 문장은 사실로 확인하지만, 실제 복용은 보호자나 전문가와 결정할게.', reply: '맞아요. 적힌 정보와 사람에게 적용하는 최종 판단은 다릅니다.', good: true },
                        { label: '문장이 적혀 있으니 누구나 지금 먹어도 된다고 결정해도 돼.', reply: '사실을 읽는 것과 개인의 건강 결정을 내리는 것은 다릅니다.' },
                      ],
                    },
                  ],
                },
              ...
              blocks: [
                {
                  ...
                  title: '사실과 판단 구분표',
                  rows: [
                    { label: '사실·AI 판단·사람 판단 분류', from: 'm1_l8_judgment_map' },
                    { label: '사실과 최종 결정의 차이', from: 'm1_l8_reason' },
                  ],
                },
              ],
            },
          ],
          reward: { printable: 'worksheet', badgeLabel: '판단 구분 도장' },
        },
      },
    ],
  },
  {
    ...
    bodyNormal: 'AI 도구는 이름보다 입력, 출력, 근거, 개인정보 조건을 보고 선택합니다. 하나의 인공지능 서비스 안에 여러 가지 기능이 함께 들어 있을 수 있으므로 작업 목적에 맞는 기능과 사람의 확인 방법을 함께 정합니다.',
    wrapUpEasy: '원하는 결과와 필요한 입력을 보고 도구를 고른 뒤 사람이 확인해요.',
    wrapUpNormal: '작업 목적에 알맞은 입력을 넣고, 결과가 나오면 진짜 근거와 개인정보를 사람이 꼼꼼하게 확인해야 합니다.',
    steps: [
  ...
  },
  {
    ...
    bodyNormal: 'AI 결과는 작업 목적, 확인된 자료, 안전 조건과 비교한 뒤 그대로 쓸지, 고쳐서 쓸지, 쓰지 않을지 결정합니다. AI가 제안해도 마지막 결정과 책임은 사람에게 있습니다.',
    wrapUpEasy: 'AI가 만든 결과는 사람이 확인한 뒤 그대로 쓸지, 고쳐 쓸지, 쓰지 않을지 스스로 결정해요.',
