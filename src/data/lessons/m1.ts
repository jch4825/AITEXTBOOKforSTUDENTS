...
export const M1_LESSONS: LessonContent[] = [
  {
    ...
    bodyEasy: 'AI(인공지능)는 사람이 만든 똑똑한 도구예요. 말, 글, 사진을 받아 번역, 추천, 분류처럼 할 수 있는 일을 도와줘요.',
    bodyNormal: 'AI(인공지능)는 사람이 목적을 가지고 만든 지능 도구입니다. 말, 글, 사진 같은 입력을 받아 번역, 음악 추천, 사진 속 동물 찾기처럼 할 수 있는 일을 수행하여 결과를 만듭니다.',
    wrapUpEasy: 'AI(인공지능)는 사람이 만든 똑똑한 도구이며, 번역·추천·분류 같은 다양한 일을 도와줘요.',
    wrapUpNormal: 'AI(인공지능)는 사람이 만든 도구로, 입력(말·글·사진)을 바탕으로 할 수 있는 다양한 일(번역, 추천, 분류)의 결과를 만듭니다.',
    steps: [
