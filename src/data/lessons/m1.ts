...
export const M1_LESSONS: LessonContent[] = [
  ...
  },
  {
    ...
    wrapUpNormal: '배움 자료의 양과 다양성은 인공지능의 결과에 큰 영향을 미치므로, 자료가 골고루 모였는지 사람이 꼼꼼하게 검토해야 합니다.',
    steps: [
  ...
  },
  {
    ...
    bodyNormal: '사실 확인은 기록과 공식 자료로 참·거짓을 살피는 일입니다. 분류·요약·추천처럼 낮은 위험의 일은 AI의 1차 판단을 활용할 수 있지만 사람이 결과를 검토합니다. 건강·안전·마음·권리와 책임이 걸린 최종 판단은 상황을 아는 사람이 직접 합니다.',
