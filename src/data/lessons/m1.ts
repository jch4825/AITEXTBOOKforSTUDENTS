...
export const M1_LESSONS: LessonContent[] = [
  {
    ...
    bodyEasy: 'AI(인공지능)는 사람의 생각하는 방식을 비슷하게 만들어 낸 도구예요. 말, 글, 사진을 받아 번역, 추천, 분류처럼 필요한 결과를 만들어 줘요.',
    bodyNormal: 'AI(인공지능)는 사람의 생각하는 방식을 비슷하게 만들어 내어 다양한 문제 해결을 돕는 기술입니다. 말, 글, 사진 같은 입력을 받아 번역, 음악 추천, 사진 속 동물 찾기처럼 할 수 있는 일을 수행하여 결과를 만듭니다.',
    wrapUpEasy: 'AI(인공지능)는 사람의 생각하는 방식을 비슷하게 만들어 낸 도구이며, 번역·추천·분류 같은 다양한 일을 도와줘요.',
    wrapUpNormal: 'AI(인공지능)는 컴퓨터가 사람의 생각하는 방식을 비슷하게 학습하고 판단하는 기술로, 입력(말·글·사진)을 바탕으로 번역, 추천, 분류 등의 결과를 만듭니다.',
    steps: [
