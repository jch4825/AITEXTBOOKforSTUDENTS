...
export const M1_LESSONS: LessonContent[] = [
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 우리 주변의 AI',
              goal: '집과 학교에서 본 AI를 모두 골라 보세요.',
              blocks: [
                {
                  kind: 'multi-pick',
                  id: 'seen_ai',
                  prompt: '집이나 학교에서 본 인공지능(AI)을 모두 골라 보세요.',
                  items: [
            ...
            },
            {
              ...
              goal: '가장 사용해 보고 싶은 AI를 하나만 골라 보세요.',
              blocks: [
                {
                  kind: 'single-pick',
                  id: 'want_ai',
                  prompt: '가장 써 보고 싶은 인공지능(AI)을 하나만 골라 보세요.',
                  items: [
  ...
  // ─────────────────────────── l2 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '기계랑 AI는 뭐가 달라?',
    objective: '기계와 AI가 어떻게 다른지 알아봐요.',
    standards: [
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 기계일까, AI일까?',
              goal: '그냥 기계와 인공지능(AI)을 구분해 보세요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'sort_mach',
                  prompt: '그냥 기계와 인공지능(AI)을 알맞은 바구니에 나눠 담아 보세요.',
                  bins: [
                    { label: '그냥 기계', emoji: '⚙️' },
                    { label: '인공지능', emoji: '🤖' }
                  ],
            ...
            {
              title: '2장: 상상하기',
              goal: 'AI로 만들고 싶은 우리 집 물건을 골라 보세요.',
              blocks: [
                {
                  kind: 'single-pick',
                  id: 'invent_choice',
                  prompt: '우리 집 물건 중에서 AI로 만들고 싶은 것을 하나만 골라 보세요.',
                  items: [
                    { emoji: '🍎', label: '말하는 냉장고' },
            ...
            },
            {
              ...
              blocks: [
                ...
                },
                {
                  kind: 'draw',
                  id: 'draw_invent',
                  prompt: '내가 상상한 똑똑한 AI 기계를 그려 보세요.'
                }
              ]
            }
          ],
  ...
  // ─────────────────────────── l3 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: 'AI는 어떻게 답해줄까?',
    objective: 'AI가 어떻게 답을 만드는지 알아봐요.',
    standards: [
          ...
          chapters: [
            {
              ...
              goal: '아이미와 함께 문장을 완성해 보세요.',
              blocks: [
                {
                  kind: 'branch-chat',
                  id: 'aimi_sentence',
                  intro: '생성형 AI 아이미와 함께 어울리는 말을 골라 문장을 완성해 보세요.',
                  turns: [
                    {
                      aimi: '안녕! 나는 배워서 답하는 생성형 AI야. 내 아침 이야기의 첫 문장을 골라 줘. "나는 아침마다 맛있는..."',
                      choices: [
                        { label: '우유를 마셔요.', reply: '좋아요! "나는 아침마다 맛있는 우유를 마셔요."로 이어 볼게요.', good: true },
                        { label: '돌을 먹어요.', reply: '어라? 컴퓨터가 돌을 먹는다고요? 이상하지만 일단 "나는 아침마다 맛있는 돌을 먹어요."로 해 볼게요.' }
                      ]
                    },
                    {
                      aimi: '그다음은 어떤 말로 이어 볼까요? "우유를 마시면 키가 쑥쑥..."',
                      choices: [
                        { label: '자라나요.', reply: '멋져요! "우유를 마시면 키가 쑥쑥 자라나요." 문장 완성!', good: true },
                        { label: '하늘을 날아요.', reply: '앗! 우유를 마신다고 하늘을 날 수는 없어요. AI가 자신 있게 말해도 틀린 답(환각)이 될 수 있네요!' }
                      ]
                    }
                  ]
                }
            ...
            },
            {
              ...
              goal: 'AI가 자신 있게 말했지만 틀린 대답을 골라 보세요.',
              blocks: [
                {
                  kind: 'single-pick',
                  id: 'hallucination_check',
                  prompt: '문장 중에서 그럴듯해 보이지만 사실이 아닌 틀린 대답(환각)은 무엇일까요?',
                  items: [
  ...
  // ─────────────────────────── l4 ───────────────────────────
  {
    ...
    objective: 'AI가 사진 속 물건을 알아보는 모습을 알아봐요.',
    standards: ['[9정통02-04] 인공지능에 대해 관심을 기울이고, 생활 속 인공지능의 다양한 사례를 탐색한다.'],
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 사진 분류하기',
              goal: 'AI가 알아보기 쉬운 사진과 헷갈리는 사진을 나눠 보세요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'sort_images',
                  prompt: 'AI가 보기 편한 사진과 알아보기 힘든 헷갈리는 사진을 바구니에 나눠 담아 보세요.',
                  bins: [
                    { label: '알아보기 쉬워요', emoji: '☀️' },
                    { label: '헷갈려요', emoji: '🌫️' }
                  ],
                  cards: [
            ...
            },
            {
              ...
              goal: '잘못 알아보는 아이미를 바르게 고쳐 줘 보세요.',
              blocks: [
                {
                  kind: 'branch-chat',
                  id: 'correct_aimi',
                  intro: '아이미가 사과 가방 사진을 보고 "맛있는 사과"라고 해요. 아이미에게 알려줘 볼까요?',
                  turns: [
                    {
                      aimi: '빨갛고 둥근 사과네요! 참 맛있어 보여요.',
                      choices: [
                        { label: '그건 사과가 아니라 사과 가방이야.', reply: '앗, 그렇군요! 빨간 원형이라 사과인 줄 알았어요. 알려 주셔서 감사해요!', good: true },
                        { label: '와! 한 입 깨물어 먹어야지.', reply: '어라? 사과 가방을 먹으면 이가 아플 텐데요! AI가 틀릴 수 있어요.' }
                      ]
                    }
                  ]
                }
            ...
            {
              title: '3장: 다짐하기',
              goal: '내 눈으로 한 번 더 확인하기로 약속해 보세요.',
              blocks: [
                {
                  kind: 'summary',
                  id: 'summary4',
  ...
  // ─────────────────────────── l5 ───────────────────────────
  {
    ...
    objective: 'AI가 우리 목소리를 어떻게 알아듣는지 알아봐요.',
    standards: [
      '[9정통01-02] 다양한 정보통신 기기의 종류를 알고, 기본 기능을 익힌다.',
      '[9정통02-04] 인공지능에 대해 관심을 기울이고, 생활 속 인공지능의 다양한 사례를 탐색한다.',
    ],
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 소음 속의 대화',
              goal: '시끄러운 곳에서 AI와 대화하는 대처법을 골라 보세요.',
              blocks: [
                {
                  kind: 'branch-chat',
                  id: 'noise_chat',
                  prompt: '주변 소음 속에서 올바르게 대처해 보세요.',
                  intro: '주변이 시끄러워 내 목소리를 알아듣지 못하는 아이미와 대화해 보세요.',
                  turns: [
                    {
                      aimi: '(주변 소음: 와글와글) 소리가 웅웅대서 잘 들리지 않아요. 뭐라고 하셨나요?',
                      choices: [
                        { label: '조용한 곳으로 옮겨 또박또박 말해요.', reply: '아! 이제 잘 들려요. 음성 인식 성공!', good: true },
                        { label: '핸드폰에 대고 더 크게 소리를 질러요.', reply: '앗, 큰 소리가 마이크에 찢어지게 들려 오해하기 더 어려워졌어요!' }
                      ]
                    }
                  ]
                }
            ...
            {
              title: '2장: 어려운 상황 찾기',
              goal: 'AI가 말을 알아듣기 어려운 상황을 찾아 보세요.',
              blocks: [
                {
                  kind: 'multi-pick',
                  id: 'hard_speech',
                  prompt: '인공지능(AI)이 내 목소리를 알아듣기 어려운 상황을 모두 골라 보세요.',
                  items: [
  ...
  // ─────────────────────────── l6 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: 'AI는 어떻게 배울까?',
    objective: 'AI가 자료를 보고 배우는 과정을 알아봐요.',
    standards: ['[9정통02-04] 인공지능에 대해 관심을 기울이고, 생활 속 인공지능의 다양한 사례를 탐색한다.'],
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 배움의 종류 분류',
              goal: '골고루 배운 자료와 한쪽만 치우치게 배운 자료를 구분해 보세요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'sort_data',
                  prompt: '인공지능(AI)이 똑똑해지려면 골고루 배워야 해요. 자료의 균형을 나눠 보세요.',
                  bins: [
                    { label: '골고루 배워요', emoji: '🌈' },
                    { label: '한쪽만 배워요', emoji: '🌓' }
                  ],
            ...
            {
              title: '2장: 치우친 학습의 결과',
              goal: '한쪽만 배운 AI가 겪을 일을 예측해 보세요.',
              blocks: [
                {
                  kind: 'single-pick',
                  id: 'bias_predict',
                  prompt: '하얀 강아지만 공부한 AI에게 까만 강아지 사진을 보여주면 어떻게 될까요?',
                  items: [
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 잘하는 것 고르기',
              goal: 'AI가 잘해서 우리를 도와주는 일을 모두 골라 보세요.',
              blocks: [
                {
                  kind: 'multi-pick',
                  id: 'good_at',
                  prompt: '인공지능(AI)이 사람을 도와 아주 잘할 수 있는 일을 모두 골라 보세요.',
                  items: [
            ...
            {
              title: '2장: 잘함과 못함 분류',
              goal: 'AI가 잘하는 일과 할 수 없는 일을 나눠 보세요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'sort_ability',
                  prompt: 'AI가 스스로 해결할 수 있는 일과 사람이 대신해줘야 하는 일을 바구니에 담아 보세요.',
                  bins: [
                    { label: 'AI가 잘해요', emoji: '🌟' },
                    { label: 'AI가 못해요', emoji: '❌' }
                  ],
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 가능과 불가능',
              goal: 'AI가 할 수 있는 것과 없는 것을 탐정처럼 밝혀내 보세요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'sort_detect',
                  prompt: '인공지능(AI)이 해낼 수 있는 일과 절대 혼자선 못하는 일을 구분해 보세요.',
                  bins: [
                    { label: '할 수 있어요', emoji: '🙆' },
                    { label: '할 수 없어요', emoji: '🙅' }
                  ],
            ...
            {
              title: '2장: 생각의 비밀 탐색',
              goal: 'AI와 마음을 주제로 대화해 보세요.',
              blocks: [
                {
                  kind: 'branch-chat',
                  id: 'mind_detect',
                  intro: '마음이 무엇인지 아이미와 깊이 대화해 볼까요?',
                  turns: [
                    {
                      aimi: '저는 몸과 마음이 없어서 진짜 배고픔이나 기쁨을 느끼지는 못한답니다.',
                      choices: [
                        { label: '맛있는 걸 먹는 기쁨은 모르는구나.', reply: '네, 맞아요. 진짜로 음식을 먹고 행복을 느낄 수 있는 건 사람뿐이에요!', good: true },
                        { label: '전기가 없으면 배고파지는 거야?', reply: '충전선은 전기 전원일 뿐이에요. 배가 고픈 진짜 기분과는 달라요!' }
                      ]
                    }
                  ]
                }
  ...
  // ─────────────────────────── l9 ───────────────────────────
  {
    ...
    kind: 'concept',
    title: '여러 가지 AI 친구들',
    objective: '챗봇과 이미지 생성 AI가 무엇인지 알아봐요.',
    standards: [
      '[9정통01-02] 다양한 정보통신 기기의 종류를 알고, 기본 기능을 익힌다.',
      '[9정통02-04] 인공지능에 대해 관심을 기울이고, 생활 속 인공지능의 다양한 사례를 탐색한다.',
    ],
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 일감 나눠주기',
              goal: '어떤 일을 어떤 AI에게 부탁해야 할지 나눠 보세요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'sort_friend',
                  prompt: '하려는 대화에 따라 글로 답하는 챗봇과 그림을 그려주는 AI에게 알맞게 부탁을 나눠 보세요.',
                  bins: [
                    { label: '챗봇 AI', emoji: '💬' },
                  ...
                  cards: [
                    ...
                    { label: '재미있는 짧은 동화 써줘', emoji: '📖', bin: 0 }
                  ]
                }
              ]
            },
            {
              ...
              goal: '나에게 꼭 맞는 AI 친구를 상상하고 그려 보세요.',
              blocks: [
                {
                  kind: 'single-pick',
                  id: 'friend_choice',
                  prompt: '나와 가장 친하게 지내고 싶은 AI 친구를 하나만 골라 보세요.',
                  items: [
                ...
                },
                {
                  kind: 'draw',
                  id: 'draw_friend',
                  prompt: '내가 상상한 멋진 AI 친구의 생김새를 자유롭게 그려 보세요.'
                }
              ]
            },
            {
              title: '3장: 카드 완성하기',
              goal: '내가 만든 AI 친구 카드를 최종 확인하세요.',
              blocks: [
                {
                  kind: 'summary',
                  id: 'summary9',
  ...
  // ─────────────────────────── l10 ───────────────────────────
  {
    ...
    kind: 'experience',
    title: 'AI랑 놀아본 사람?',
    objective: 'AI에게 프롬프트로 물어보고 답을 확인해 봐요.',
    standards: [
      ...
      },
      {
        ...
        data: {
          ...
          chapters: [
            {
              title: '1장: 프롬프트 조립소',
              goal: '조각을 맞춰 멋진 질문을 완성해 보세요.',
              blocks: [
                {
                  kind: 'drag-build',
                  id: 'first_prompt',
                  prompt: '원하는 답을 얻기 위해 "무엇을", "어떻게" 조각을 골라 프롬프트를 조립해 보세요.',
                  slots: [
                    { label: '무엇을 할까요?' },
                    { label: '어떤 모양으로 할까요?' }
                  ],
                  ...
                  response: {
                    good: '좋아요! 동화책 주인공으로 어울리는 이름 "솔이", "하늘이", "초록이" 세 개를 추천해요.',
                    weak: '음... 어떤 재밌는 주인공을 원하시는지 조금 더 자세히 적어 볼까요?'
                  }
                }
              ]
            },
            {
              title: '2장: 구체적인 질문의 힘',
              goal: '대답을 확인한 후 아이미와 의견을 나눠 보세요.',
              blocks: [
                {
                  kind: 'branch-chat',
                  id: 'feedback_prompt',
                  intro: '답을 확인한 다음, 더 깔끔한 대답을 얻으려면 어떻게 질문할지 대화해 보세요.',
                  turns: [
                    {
                      aimi: '질문이 정확하면 저도 꼭 마음에 드는 답을 찾아드릴 수 있어요.',
                      choices: [
                        { label: '구체적으로 형식을 말하니까 대답이 깔끔하네!', reply: '맞아요! 구체적으로 목적과 개수를 적을수록 대답이 명확해져요.', good: true },
                        { label: '그냥 대충 짧게 대화하고 싶어.', reply: '그러면 저도 틀린 말을 하거나 이상한 답을 할 확률이 높아져요!' }
                      ]
                    }
                  ]
                }
  ...
  // ─────────────────────────── l11 ───────────────────────────
  {
    ...
    kind: 'activity',
    title: '다 배웠어요! (마무리 퀴즈)',
    objective: '이번 단원에서 배운 낱말들을 다시 알아봐요.',
    standards: ['[9정통02-04] 인공지능에 대해 관심을 기울이고, 생활 속 인공지능의 다양한 사례를 탐색한다.'],
          ...
          chapters: [
            {
              ...
              goal: '단원 1에서 배운 것 중 할 수 있는 것을 골라 보세요.',
              blocks: [
                {
                  kind: 'multi-pick',
                  id: 'self_check',
                  prompt: '단원 1을 마치면서 내 힘으로 할 수 있게 된 일들을 모두 골라 보세요.',
                  items: [
            ...
            {
              title: '2장: 최종 확인 퀴즈',
              goal: '배운 개념들을 OX 퀴즈처럼 분류해 보세요.',
              blocks: [
                {
                  kind: 'drag-sort',
                  id: 'final_quiz',
                  prompt: '단원 1의 참과 거짓을 탐정처럼 분류 바구니에 바르게 나눠 담아 보세요.',
                  bins: [
                    { label: '맞아요', emoji: '⭕' },
                    { label: '틀려요', emoji: '❌' }
                  ],
