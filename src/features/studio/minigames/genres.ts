...
export const GENRE_ASSIGNMENTS: GenreAssignment[] = [
  ...
  { lessonId: 'm1-l7', genre: 12, genreName: '틀린 그림 찾기', badge: '요약 다른 곳 찾기', component: 'SummaryDiffGame' },
  { lessonId: 'm1-l8', genre: 17, genreName: '소코반 상자 밀기', badge: '부탁 상자 밀기', component: 'JudgmentCratePushGame' },
  ...
  { lessonId: 'm2-l2', genre: 49, genreName: '손님 안내', badge: '한 창구 안내소', component: 'OneCounterQueueGame' },
  { lessonId: 'm2-l3', genre: 27, genreName: '조준 슈팅', badge: '좁혀서 조준하기', component: 'PreciseAimGame' },
  { lessonId: 'm2-l4', genre: 20, genreName: '노노그램', badge: '예시 그림 채우기', component: 'ExampleGridGame' },
  { lessonId: 'm2-l5', genre: 31, genreName: '스티어링', badge: '말투 도로 운전', component: 'ToneRoadDriveGame' },
  { lessonId: 'm2-l6', genre: 9, genreName: '와이어 갈고리', badge: '단계 갈고리 타기', component: 'StepHookSwingGame' },
  ...
  { lessonId: 'm2-l9', genre: 43, genreName: '사천성', badge: '주장과 근거 잇기', component: 'EvidenceLinkGame' },
  { lessonId: 'm2-l10', genre: 29, genreName: '핀볼', badge: '대화 핀볼', component: 'ConversationPinballGame' },

  // ── M3 · 공부 도우미 ─────────────────────────────────────────
  { lessonId: 'm3-l1', genre: 2, genreName: '수직 상승 플랫포머', badge: '질문 발판 오르기', component: 'QuestionClimbGame' },
