...
export const MINI_GAME_REGISTRY: Record<string, ReturnType<typeof lazy>> = {
  ...
  'm1-l10': lazy(() => import('./m1/SongDrumCheckGame')),
  ...
  'm3-l2': lazy(() => import('./m3/MeaningShiftGame')),
  ...
  'm3-l8': lazy(() => import('./m3/SamePictureMemoryGame')),
  'm3-l9': lazy(() => import('./m3/GuessMoleGame')),
  'm3-l10': lazy(() => import('./m3/RecallSnakeGame')),
  'm4-l1': lazy(() => import('./m4/ClaimShooterGame')),
  'm4-l2': lazy(() => import('./m4/SourceTowerGame')),
  ...
  'm4-l7': lazy(() => import('./m4/PoliteWordCrossGame')),
  'm4-l8': lazy(() => import('./m4/StopTimingGame')),
  'm4-l9': lazy(() => import('./m4/ChatMazeGame')),
  'm4-l10': lazy(() => import('./m4/AdFenceGame')),
  'm5-l1': lazy(() => import('./m5/GoalGapFenceGame')),
  'm5-l2': lazy(() => import('./m5/TaskSliceGame')),
  'm5-l3': lazy(() => import('./m5/StepOrderPathGame')),
  'm5-l4': lazy(() => import('./m5/PriorityStairsGame')),
  'm5-l5': lazy(() => import('./m5/HintScratchGame')),
  'm5-l6': lazy(() => import('./m5/ClueCarryDodgeGame')),
  'm5-l7': lazy(() => import('./m5/StepFlipGame')),
  'm5-l8': lazy(() => import('./m5/ResultCheckDiffGame')),
  'm5-l9': lazy(() => import('./m5/ThreeWayDriveGame')),
  ...
  'm6-l10': lazy(() => import('./m6/JobCompareCardGame')),
