  ...
  const contextFacts = state.stage === 'transfer'
    ...
    : isCompleteStage
      ? state.supportLevel === 'full'
        ? [
            '진우는 학교에서 나를 도와주는 인공지능 로봇 아이미를 만났습니다.',
            '진우는 아이미에게 토스터에 대해 쉽고 간단한 말로 다시 물어보았습니다.'
          ]
        : state.supportLevel === 'challenge'
          ? [
              '진우는 학교 등교 후 학업과 생활을 돕는 인공지능의 역할을 인지하고, 그것이 사람처럼 학습하는 프로그램임을 배웠습니다.',
              '진우는 인공지능이 설명하는 복잡한 기술 용어의 문제점을 파악하고, 자신이 원하는 정보를 얻기 위해 질문을 더 쉽게 수정하여 답변을 유도했습니다.'
            ]
          : [
