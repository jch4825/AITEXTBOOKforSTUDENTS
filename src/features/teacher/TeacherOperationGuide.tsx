      ...
      <div className="mt-6 space-y-7 text-sm leading-relaxed">
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>필요하면 데이터 관리에서 암호화 백업을 만들고 기록 중지·초기화를, 학생 기록에서 개별 삭제를, 화면 위 ‘과정기록 삭제’ 버튼으로 기록 전체 삭제를 할 수 있습니다.</li>
            <li>기본 이미지·소리·AI 의견은 준비된 예시라 권한 없이 진행할 수 있습니다. Gemini를 연결한 경우에만 학생이 선택한 실시간 질문·음성·사진이 Google 서버로 전송됩니다.</li>
