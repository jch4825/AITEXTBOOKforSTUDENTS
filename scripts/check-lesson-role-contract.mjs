...
if (studioIds.length !== 39) throw new Error('studio lesson count must be 39 after the module 3 remodel');
...
console.log('lesson role contract: 39 studio, 23 support, 6 module-close');
