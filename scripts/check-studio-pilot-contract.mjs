...
for (const componentPath of [expressionPath, decisionPath]) {
...
if (!fs.existsSync(closeComponentPath)) throw new Error(`M5 learning connection is missing: ${closeComponentPath}`);
for (const token of ['getModulePortfolioDefinition', '<ModuleCloseLessonView']) {
