...
const lessonContracts = [
  ['m4-l1', '자신 있는 AI 답도 확인하기', '자신 있게 답한 아이미의 시간을 오늘의 공식 시간표와 비교해, 맞는 부분과 고칠 부분을 나눠요.'],
  ['m4-l2', '더 믿을 만한 자료 고르기', '같은 소식을 말하는 세 자료의 출처와 날짜를 비교해, 더 믿을 만한 자료를 이유와 함께 골라요.'],
  ['m4-l3', '개인정보 단서 가리기', '아이미에게 보낼 글에서 나를 알아볼 수 있는 정보를 찾아 가리고, 필요한 조건만 남겨 안전한 부탁으로 고쳐요.'],
  ['m4-l4', '비밀번호와 인증 코드는 보내지 않기', '비밀번호·인증 코드를 묻는 요청을 알아채면 거절하고, 믿을 만한 어른과 공식 절차를 확인해요.'],
  ['m4-l5', '사진을 보내기 전 살펴보기', '사진을 보내기 전 얼굴·이름·위치·다른 사람을 확인하고, 그대로 보내기·가리기·보내지 않기 중에서 골라요.'],
  ['m4-l6', '불편한 내용을 만났을 때 멈추기', '불편한 화면의 위험 신호를 아이미와 함께 이름 붙이고, 거리를 둔 뒤 믿을 만한 사람에게 알리는 연습을 해요.'],
  ['m4-l7', '분명하고 존중 있게 부탁하기', '같은 부탁을 거친 말과 존중하는 말로 아이미에게 해 보고, 사람에게도 쓸 분명한 표현을 골라요.'],
  ['m4-l8', '멈출 시간을 함께 정하기', '나의 사용 기록을 보고 멈춤 신호와 다음 행동을 정해, 아이미와 함께 나만의 멈춤 계획을 만들어요.'],
  ['m4-l9', '이상한 요청을 어른에게 알리기', '아이미가 보여 주는 대화에서 사진·비밀번호·선물·만남 요구 신호를 알아채고, 누구에게 어떻게 알릴지 연습해요.'],
  ['m4-l10', '추천 속 광고 단서 찾기', '아이미가 모은 추천 게시물에서 광고 표시·구매 링크·과장을 찾아 표시하고, 내 필요·예산과 비교해요.'],
