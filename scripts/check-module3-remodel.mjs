...
const lessonContracts = [
  ['m3-l1', '궁금한 것을 깊게 묻기', '같은 주제를 세 가지 질문으로 바꿔 아이미에게 묻고, 과제에 가장 도움이 되는 답을 이유와 함께 골라요.'],
  ['m3-l2', '모르는 낱말 확인하기', '모르는 낱말의 뜻을 먼저 짐작하고, 아이미의 설명과 학생 사전을 비교해 내 말로 뜻을 적어요.'],
  ['m3-l3', '쉽지만 정확하게 다시 설명하기', '아이미의 쉬운 설명에서 빠진 사실을 찾고, 꼭 남을 내용을 정해 다시 설명해 달라고 해요.'],
  ['m3-l4', '낱말을 문장에서 써 보기', '낱말의 뜻·반대말과 아이미의 예문을 장면과 비교하고, 그 낱말이 어울리는 내 문장을 만들어요.'],
  ['m3-l5', 'AI와 이야기를 함께 만들기', '내 이야기의 결말을 먼저 정하고, 아이미의 세 가지 제안을 골라 고쳐 내 결말을 완성해요.'],
  ['m3-l6', '계산은 다른 도구로 확인하기', '간식 합계를 먼저 예상하고 계산기로 확인해, 아이미 풀이에서 틀린 줄을 찾아 고쳐요.'],
  ['m3-l7', '긴 글의 핵심을 남기기', '긴 글에서 꼭 남길 내용을 내가 먼저 고르고, 아이미의 세 문장 요약에서 빠진 것을 찾아 채워요.'],
  ['m3-l8', '정답을 나중에 보는 퀴즈', '먼저 풀고 나중에 정답을 보는 양면 퀴즈 카드를, 아이미가 만든 문제를 고쳐서 완성해요.'],
  ['m3-l9', '그림에서 사실과 추측 나누기', '그림에서 직접 보이는 사실과 아이미가 덧붙인 추측을 나누고, 근거 있는 설명으로 고쳐요.'],
  ['m3-l10', '오늘 배운 것을 내 말로 복습하기', '자료를 덮고 배운 것을 먼저 떠올린 뒤, 아이미의 요약과 비교해 내 말로 다시 설명해요.'],
