...
assert(!studios.includes('/lessons/m3-l'), 'module 3 story images must stay blank until new assets exist');
...
assert(
  ...
  'm3-l11: closing story must reserve exactly three image slots',
);
assert(
