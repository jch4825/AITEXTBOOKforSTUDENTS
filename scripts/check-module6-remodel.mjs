...
const lessonContracts = [
  ['m6-l1', '조건에 맞는 장보기', '아이미의 장보기 목록을 재고·가격·예산·알레르기와 비교해, 빼거나 바꿔서 안전한 목록으로 고쳐요.'],
  ['m6-l2', '돈은 계산기로 확인하기', '아이미가 계산한 금액을 믿기 전에, 가격표를 보고 계산기로 합계와 거스름돈을 확인해요.'],
  ['m6-l3', '지도와 현장 표지로 길 확인하기', '연습 지도에서 출발점과 목적지를 찾고, 아이미의 길 안내를 지도·표지와 대조해 안전한 길을 골라요.'],
  ['m6-l4', '교통 정보와 방향 확인하기', '버스 번호·방향·정류장을 오늘 공지와 확인하고, 헷갈리면 타기 전에 안전하게 도움을 요청해요.'],
  ['m6-l5', '공식 예보로 옷 준비하기', '공식 예보의 기온·비·바람을 확인하고, 아이미의 한마디 대신 활동과 내 감각에 맞는 준비물을 골라요.'],
  ['m6-l6', '조건에 맞게 음식 계획 바꾸기', '재료·알레르기·도구·도움 조건을 확인해, 아이미의 요리 초안을 안전한 순서로 고쳐 조립해요.'],
  ['m6-l7', '나에게 맞는 하루 계획', '아이미의 빽빽한 일정에 쉬는 시간과 도움 시간을 넣어 고치고, 출발이 늦어지면 계획을 다시 맞춰요.'],
  ['m6-l8', '아픈 상태를 사람에게 알리기', '몸이 불편할 때 말·그림 카드로 상태를 표현하는 연습을 아이미와 하고, 믿을 만한 어른에게 먼저 알려요.'],
  ['m6-l9', '인사·도움·거절을 내 방식으로 표현하기', '인사·도움 요청·거절·다시 말해 달라는 표현을, 말·글·그림 카드 중 편한 방법으로 아이미와 연습해요.'],
  ['m6-l10', '직업을 실제 사람과 함께 알아보기', '아이미가 예상한 직업의 모습과 실제 직업인의 이야기를 비교하고, 나의 흥미·강점·필요한 도움을 적어요.'],
  ['m6-l11', '상대에 맞는 자기소개 만들기', '내가 먼저 쓴 자기소개에 아이미의 제안을 골라 반영해, 교실용과 온라인용 두 버전을 완성해요.'],
