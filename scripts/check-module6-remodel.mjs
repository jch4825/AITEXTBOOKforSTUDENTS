...
const lessonContracts = [
  ...
  ['m6-l8', '아픈 상태를 사람에게 알리기', '오늘은 몸의 불편함을 말·그림 카드로 표현하고 믿을 만한 어른에게 먼저 알려 봐요.'],
  ['m6-l9', '인사·도움·거절을 내 방식으로 표현하기', '오늘은 인사·도움 요청·거절·다시 말해 달라는 표현을 말·글·그림 카드 중 편한 방법으로 연습해 봐요.'],
