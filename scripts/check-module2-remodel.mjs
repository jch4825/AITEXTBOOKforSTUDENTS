...
const lessonContracts = [
  ['m2-l1', '빠진 정보를 찾아 채워요', '아이미가 엉뚱하게 알아들은 부탁에서 빠진 정보를 찾아, 개인정보 없이 채워 다시 부탁해요.'],
  ['m2-l2', '한 번에 한 가지씩 부탁해요', '한 문장에 섞인 여러 부탁을 하나씩 나누고, 마감이 빠른 것부터 아이미에게 차례로 부탁해요.'],
  ['m2-l3', '무엇이 필요한지 구체적으로 말해요', '`그거`, `아무거나` 대신 이름·종류·개수를 넣어 부탁하고, 아이미의 답이 어떻게 달라지는지 비교해요.'],
  ['m2-l4', '알맞은 예시를 보여 주며 부탁해요', '원하는 답의 예시를 하나 만들어 아이미에게 보여 주고, 예시를 주기 전과 후의 답을 비교해요.'],
  ['m2-l5', '읽을 사람과 알맞은 말투를 정해요', '답을 읽을 사람과 말투를 아이미에게 알려 주고, 사실(시간·장소·준비물)이 맞는지는 따로 확인해요.'],
  ['m2-l6', '단계를 나누어 차례대로 부탁해요', '큰 부탁을 작은 단계로 나누고, 앞 단계에서 받은 아이미의 답을 다음 부탁에 이어 써요.'],
  ['m2-l7', '부족한 부분을 고쳐서 다시 부탁해요', '아이미의 첫 답에서 부족한 곳을 찾고, 지킬 사실을 정해서 구체적으로 다시 부탁해요.'],
  ['m2-l8', '원하는 모양을 정해서 부탁해요', '할 일에 맞는 형식(표·번호 목록·한 문장)을 골라 아이미에게 부탁하고, 답이 형식과 내용을 지켰는지 확인해요.'],
  ['m2-l9', '인공지능의 답을 직접 확인해요', '아이미 답의 주장 하나를 골라, 아이미에게 다시 묻는 대신 최신 학교 공지와 비교해 확인해요.'],
  ['m2-l10', '인공지능과 제대로 대화 완성하기', '내가 정한 목적으로 아이미에게 부탁하고, 답을 고쳐 묻고, 근거를 확인해 마지막 사용을 결정해요.'],
  ['m2-l11', '나만의 프롬프트 노트', '오늘은 실제 목적 하나를 정하고 요청·수정·확인·최종 판단이 담긴 프롬프트 노트를 완성해 봐요.'],
];
...
assert(portfolio.includes("title: '나만의 프롬프트 노트'"), 'm2-l11: portfolio title is not canonical');
for (const lessonId of experienceLessonIds) {
