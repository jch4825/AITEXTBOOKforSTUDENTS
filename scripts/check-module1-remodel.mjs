...
const lessonContracts = [
  ['m1-l1', '아이미와 처음 만난 날', '어려운 말로 인사한 아이미 대신, AI(인공지능)의 뜻과 AI가 돕는 일 두 가지를 나만의 표현으로 소개해요.'],
  ['m1-l2', '기계와 인공지능은 어떻게 다를까요?', '버튼 선풍기·센서 자동문·추천 앱이 받는 정보를 비교해, AI 기능이 쓰인 것을 이유와 함께 골라요.'],
  ['m1-l3', '인공지능은 어떻게 답을 만들까요?', '다음 낱말 잇기 놀이로 아이미가 답을 만드는 방법을 겪어 보고, 아이미의 답에서 꼭 확인할 문장을 골라요.'],
  ['m1-l4', '사진을 알아보는 인공지능', '사진의 가림·밝기를 바꾸며 아이미의 답이 달라지는 모습을 실험하고, 답이 달라진 까닭을 골라요.'],
  ['m1-l5', '소리를 알아듣는 인공지능', '시끄러운 곳에서 아이미가 잘못 받아 적은 말을, 조건을 바꾸거나 다른 입력 방법을 골라 바르게 전해요.'],
  ['m1-l6', '인공지능은 많은 자료로 배워요', '세모 카드만 잔뜩 배운 AI가 왜 자꾸 틀리는지 배움 상자를 확인하고, 자료를 골고루 바꿔 결과를 비교해요.'],
  ['m1-l7', '인공지능이 빠르고 쉽게 도와주는 일', '아이미가 1초 만에 만든 요약·번역을 원문과 나란히 놓고, 빠지거나 달라진 부분을 찾아 고쳐요.'],
  ['m1-l8', '사실 확인과 최종 결정은 누가 할까요?', '아이미가 받은 네 가지 부탁을 사실 확인·AI의 1차 판단·사람의 최종 판단으로 나누고, 왜 그렇게 나눴는지 말해요.'],
  ['m1-l9', '알맞은 인공지능 도구 고르기', '하려는 일과 넣을 수 있는 정보를 아이미에게 말하고, 일마다 알맞은 AI 도구를 이유와 함께 골라요.'],
  ['m1-l10', '인공지능이 만든 결과 확인하고 사용하기', '개인정보 없이 아이미에게 음악을 부탁하고, 받은 결과를 확인해 쓰기·고치기·안 쓰기 중에서 골라요.'],
  ['m1-l11', '나만의 인공지능 사용 설명서', '오늘은 새 AI 상황에서 입력·결과·확인할 점을 찾아 나만의 AI 사용 설명서를 완성해 봐요.'],
];
...
assert(portfolio.includes("title: '나만의 인공지능 사용 설명서'"), 'm1-l11: portfolio title is not canonical');
for (const lessonId of experienceLessonIds) {
