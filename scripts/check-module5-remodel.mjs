...
const lessonContracts = [
  ['m5-l1', '해결해야 할 문제를 정확하게 찾기', '물품이 안 온 상황에서 지금 모습과 원하는 모습을 나눠 적고, 아이미와 함께 진짜 문제를 한 문장으로 만들어요.'],
  ['m5-l2', '큰 문제를 작은 단계로 나누기', '`부스 설치`라는 큰 일을 작은 과제로 나누고, 아이미의 목록에서 빠진 과제와 필요 없는 과제를 찾아 고쳐요.'],
  ['m5-l3', '차례차례 알맞은 순서 정하기', '아이미가 추천한 설치 순서를 모의 실행으로 시험하고, 먼저 해야 하는 이유가 있는 순서로 다시 조립해요.'],
  ['m5-l4', '중요한 기준에 따라 먼저 할 일 정하기', '한꺼번에 온 세 가지 일에 안전·마감·도움 기준을 붙이고, 아이미와 함께 먼저 할 일을 정해 이유를 말해요.'],
  ['m5-l5', '정답 대신 필요한 만큼만 힌트 얻기', '막힌 문제에서 완성 답 대신, 아이미에게 필요한 만큼의 힌트만 골라 받아 내 방법을 고쳐요.'],
  ['m5-l6', '잘못 알아들었을 때 자세히 다시 설명하기', '아이미가 다르게 알아들은 까닭을 찾고, 개인정보 없이 필요한 단서만 더해 다시 요청해요.'],
  ['m5-l7', '한 단계씩 차례대로 실행하고 확인하기', '아이미에게 한 단계씩 부탁하고, 끝났다는 표시를 확인한 다음에 다음 단계로 넘어가요.'],
  ['m5-l8', '처음 세운 목표와 결과를 꼼꼼히 비교하기', '아이미가 완성했다는 결과를 처음 조건표와 나란히 대조하고, 빠진 것을 찾아 채워요.'],
  ['m5-l9', '다른 방법을 찾아보고 장단점 비교하기', '처음 방법이 막혔을 때 아이미와 다른 방법을 두 가지 넘게 만들고, 시간·안전·도움 기준으로 비교해 골라요.'],
  ['m5-l10', '잘못된 부분을 찾아 고치고 다시 해보기', '안내 순서를 같은 조건으로 다시 시험해 오류 지점을 찾고, 고친 뒤 처음부터 확인해요.'],
  ['m5-l11', '상황이 바뀌었을 때 안전하게 계획 바꾸기', '도구가 없고 안전 정보가 확인되지 않았을 때, 계획을 멈추고 어른과 확인해 안전한 새 계획으로 고쳐요.'],
  ['m5-l12', '나만의 문제 해결 지도', '오늘은 새 생활 문제 하나를 골라 현재·목표·작은 과제·순서·대안·확인을 한 장에 완성해 봐요.'],
];
